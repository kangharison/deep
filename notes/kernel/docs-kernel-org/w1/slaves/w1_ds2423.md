...
> 출처(원문): https://docs.kernel.org/w1/slaves/w1_ds2423.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# Kernel driver w1\_ds2423
...
> |  |  |
> | --- | --- |
> | W1\_THERM\_DS2423 | 0x1D |

Author: Mika Laitio <[lamikr@pilppa.org](mailto:lamikr%40pilppa.org)>

## Description

Support is provided through the sysfs w1\_slave file. Each opening and
read sequence of w1\_slave file initiates the read of counters and ram
