...
> 출처(원문): https://docs.kernel.org/w1/slaves/w1_ds2438.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# Kernel driver w1\_ds2438
...
Opening and reading this file initiates the CONVERT\_T (temperature conversion)
...
Opening and reading this file initiates the CONVERT\_V (voltage conversion)
command of the chip.
