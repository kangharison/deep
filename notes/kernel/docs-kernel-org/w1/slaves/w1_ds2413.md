...
> 출처(원문): https://docs.kernel.org/w1/slaves/w1_ds2413.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# Kernel driver w1\_ds2413
...
the chip PIO\_ACCESS\_READ command (refer the datasheet for details):
...
Similarly the byte format is the same as for the PIO\_ACCESS\_WRITE command:
