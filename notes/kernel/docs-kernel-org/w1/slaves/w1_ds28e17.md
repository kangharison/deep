...
> 출처(원문): https://docs.kernel.org/w1/slaves/w1_ds28e17.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# Kernel driver w1\_ds28e17
...
:   This sets up the default I2C speed a DS28E17 get configured for as soon
    ...
    as soon the “w1\_ds28e17” driver notices a freshly connected, or
...
:   This sets up the default stretch value used for freshly connected
    ...
    needed timeout cannot be pre-calculated correctly. As the w1\_ds28e17
    ...
    Leave it at 1 unless you get ETIMEDOUT errors and a “w1\_slave\_driver
