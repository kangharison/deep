...
> 출처(원문): https://docs.kernel.org/w1/masters/omap-hdq.html
...
The driver (drivers/w1/masters/omap\_hdq.c) supports the HDQ mode of the
...
driver(drivers/w1/slaves/w1\_bq27000.c) sets the ID to 1.
...
to the bus using SEARCH\_ROM procedure. 1-wire mode can be selected by
