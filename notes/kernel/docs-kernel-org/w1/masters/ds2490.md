...
> 출처(원문): https://docs.kernel.org/w1/masters/ds2490.html
...
* The number of USB bus transactions could be reduced if w1\_reset\_send
...
* The registered w1\_bus\_master functions don’t define error
...
* The ds2490 specification doesn’t cover short bulk in reads in
  ...
  not happen.
* Running x86\_64 2.6.24 UHCI under qemu 0.9.0 under x86\_64 2.6.22-rc6
