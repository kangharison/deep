...
> 출처(원문): https://docs.kernel.org/sound/soc/codec-to-codec.html
...
Note the “c2c\_params” callback which lets the dapm know that this
...
A dai\_link in a “simple-audio-card” will automatically be detected as
codec to codec when all DAIs on the link belong to codec components.
The dai\_link will be initialized with the subset of stream parameters
