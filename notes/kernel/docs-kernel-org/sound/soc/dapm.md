...
> 출처(원문): https://docs.kernel.org/sound/soc/dapm.html
...
can be registered programmatically by calling [`snd_soc_dapm_new_controls()`](../kernel-api/alsa-driver-api.html#c.snd_soc_dapm_new_controls "snd_soc_dapm_new_controls")
and [`snd_soc_dapm_add_routes()`](../kernel-api/alsa-driver-api.html#c.snd_soc_dapm_add_routes "snd_soc_dapm_add_routes").
...
Finally, [`snd_soc_dapm_new_widgets()`](../kernel-api/alsa-driver-api.html#c.snd_soc_dapm_new_widgets "snd_soc_dapm_new_widgets") must be called after all widgets and
