...
> 출처(원문): https://docs.kernel.org/sound/hd-audio/notes.html
...
chip. Then, see [HD-Audio Codec-Specific Models](models.html) file,
...
The hd-audio driver reads the file via [`request_firmware()`](../../driver-api/firmware/request_firmware.html#c.request_firmware "request_firmware"). Thus,
