...
> 출처(원문): https://docs.kernel.org/sound/cards/emu-mixer.html
...
This document is based on [Sound Blaster Audigy mixer / default DSP code](audigy-mixer.html).
...
device (see [Low latency, multichannel audio with JACK and the emu10k1/emu10k2](emu10k1-jack.html)) additionally supports 24-bit capture.
...
These controls are described in [Sound Blaster Audigy mixer / default DSP code](audigy-mixer.html).

## MANUALS/PATENTS

See [Sound Blaster Live mixer / default DSP code](sb-live-mixer.html).
