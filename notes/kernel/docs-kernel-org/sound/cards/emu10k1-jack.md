...
> 출처(원문): https://docs.kernel.org/sound/cards/emu10k1-jack.html
...
[Sound Blaster Live mixer / default DSP code](sb-live-mixer.html) (or [Sound Blaster Audigy mixer / default DSP code](audigy-mixer.html)).
