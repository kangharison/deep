...
> 출처(원문): https://docs.kernel.org/sound/designs/jack-controls.html
...
In order to keep compatibility, [`snd_jack_new()`](../kernel-api/alsa-driver-api.html#c.snd_jack_new "snd_jack_new") has been modified by
adding two params:
