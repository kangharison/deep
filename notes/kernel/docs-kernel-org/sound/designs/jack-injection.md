...
> 출처(원문): https://docs.kernel.org/sound/designs/jack-injection.html
...
headphone and mic\_in, the ALSA ASoC driver will build 2 `jack_kctl`
...
If users enable the SND\_JACK\_INJECTION\_DEBUG in the kernel, the audio
