...
> 출처(원문): https://docs.kernel.org/sound/designs/seq-oss.html
...
| --- | --- |
| NOTEON | SEQ\_NOTEON, MIDI\_NOTEON |
| NOTE | SEQ\_NOTEOFF, MIDI\_NOTEOFF |
| KEYPRESS | MIDI\_KEY\_PRESSURE |
| CHANPRESS | SEQ\_AFTERTOUCH, MIDI\_CHN\_PRESSURE |
| PGMCHANGE | SEQ\_PGMCHANGE, MIDI\_PGM\_CHANGE |
| PITCHBEND | SEQ\_CONTROLLER(CTRL\_PITCH\_BENDER), MIDI\_PITCH\_BEND |
| CONTROLLER | MIDI\_CTL\_CHANGE, SEQ\_BALANCE (with CTL\_PAN) |
| CONTROL14 | SEQ\_CONTROLLER |
| REGPARAM | SEQ\_CONTROLLER(CTRL\_PITCH\_BENDER\_RANGE) |
| SYSEX | SEQ\_SYSEX |
