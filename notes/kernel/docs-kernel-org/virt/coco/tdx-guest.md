...
> 출처(원문): https://docs.kernel.org/virt/coco/tdx-guest.html
...
:   Upon successful execution, TDREPORT data is copied to
    tdx\_report\_req.tdreport and return 0. Return -EINVAL for invalid
    operands, -EIO on TDCALL failure or standard error number on other
    common failures.

The TDX\_CMD\_GET\_REPORT0 IOCTL can be used by the attestation software to get
