...
> 출처(원문): https://docs.kernel.org/virt/uml/user_mode_linux_howto_v2.html
...
### [How is UML Different from a VM using Virtualization package X?](#id2)
...
### [Why Would I Want User Mode Linux?](#id3)
...
### [Network configuration privileges](#id9)
...
### [Configuring vector transports](#id10)
...
Privileges required: raw socket transport requires CAP\_NET\_RAW
capability.

#### [GRE socket transport](#id16)
...
endpoint at host dst\_host. `GRE` supports the following additional
options:
...
#### [l2tpv3 socket transport](#id17)

\_Warning\_. L2TPv3 has a “bug”. It is the “bug” known as “has more
...
connect the UML instance to a L2TPv3 endpoint at host $dst\_host using
...
This will configure a BESS transport using the unix\_src Unix domain
socket address as source and unix\_dst socket address as destination.
...
* `ubdX[s,d,c,t]=` virtual disk specification. This is not really
  ...
  in [Creating an image](#creating-an-image)).
...
#### [Important Optional Arguments](#id23)
...
> conX=channel\_type:options[,channel\_type:options]
...
### [The UML Management Console](#id26)
...
That file is the socket that uml\_mconsole will use to communicate with
...
> # uml\_mconsole /home/jdike/.uml/debian/mconsole
...
## [Advanced UML Topics](#id38)

### [Sharing Filesystems between Virtual Machines](#id39)

Don’t attempt to share filesystems simply by booting two UMLs from the
same file. That’s the same thing as booting two physical machines
from a shared disk. It will result in filesystem corruption.

#### [Using layered block devices](#id40)
...
#### [Cows can moo - uml\_moo : Merging a COW file with its backing file](#id43)

Depending on how you use UML and COW devices, it may be advisable to
merge the changes in the COW file into the backing file every once in
a while.

The utility that does this is uml\_moo. Its usage is:
...
#### [hostfs as the root filesystem](#id46)

It’s possible to boot from a directory hierarchy on the host using
hostfs rather than using the standard filesystem in a file.
To start, you need that hierarchy. The easiest way is to loop mount
an existing root\_fs file:
...
## [Contributing to UML and Developing with UML](#id49)
...
* UML interrupt controller uses epoll - this is UML waiting for IO
  ...
  > epoll\_wait(4, [{EPOLLIN, {u32=3721159424, u64=3721159424}}], 64, 0) = 1
...
### [Developing Device Drivers](#id52)
...
### [Using UML as a Test Platform](#id53)
