...
> 출처(원문): https://docs.kernel.org/virt/kvm/arm/pkvm.html
...
Please reach out to the developers at [kvmarm@lists.linux.dev](mailto:kvmarm%40lists.linux.dev) if you have
any questions.
...
See [KVM/arm64-specific hypercalls exposed to guests](hypercalls.html) for more details.
