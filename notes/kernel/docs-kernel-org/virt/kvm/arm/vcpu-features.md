...
> 출처(원문): https://docs.kernel.org/virt/kvm/arm/vcpu-features.html
...
*opt-in* and may change/extend UAPI. See [4.82 KVM\_ARM\_VCPU\_INIT](../api.html#kvm-arm-vcpu-init) for complete
...
See the [ioctl documentation](../api.html#kvm-arm-get-reg-writable-masks) for more
details.
