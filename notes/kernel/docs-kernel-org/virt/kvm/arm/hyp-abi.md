...
> 출처(원문): https://docs.kernel.org/virt/kvm/arm/hyp-abi.html
...
* ```
  ...
  Set HVBAR/VBAR\_EL2 to ‘vectors’ to enable a hypervisor. ‘vectors’
...
* ```
  ...
  Turn HYP/EL2 MMU off, and reset HVBAR/VBAR\_EL2 to the initials
...
success, and HVC\_STUB\_ERR on error. A stub hypercall is allowed to
