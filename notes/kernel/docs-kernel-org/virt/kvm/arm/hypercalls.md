...
> 출처(원문): https://docs.kernel.org/virt/kvm/arm/hypercalls.html
...
See [PTP\_KVM support for arm/arm64](ptp_kvm.html)
...
| Return Values: | (int64) | R0 | `SUCCESS (0)` |
| `INVALID_PARAMETER (-3)` |
| (uint64) | R1 | MIDR\_EL1 of the selected implementation |
| (uint64) | R2 | REVIDR\_EL1 of the selected implementation |
| (uint64) | R3 | AIDR\_EL1 of the selected implementation |
