...
> 출처(원문): https://docs.kernel.org/virt/kvm/s390/s390-diag.html
...
:   Handled by either userspace or KVM (ioeventfd case).
    ...
    kvm\_io\_bus cookie). If general register 4 does not contain a valid
    identifier, it is ignored.

    After completion of the DIAGNOSE call, general register 2 may contain
    a 64bit identifier (in the kvm\_io\_bus cookie case), or a negative
