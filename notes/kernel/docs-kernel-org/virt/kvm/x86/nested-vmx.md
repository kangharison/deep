...
> 출처(원문): https://docs.kernel.org/virt/kvm/x86/nested-vmx.html
...
As mandated by the spec, other than the two fields revision\_id and abort,
...
VMCS12\_REVISION (from vmx.c) should be changed if `struct vmcs12` or its inner
