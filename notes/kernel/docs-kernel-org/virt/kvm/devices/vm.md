...
> 출처(원문): https://docs.kernel.org/virt/kvm/devices/vm.html
...
The virtual machine “device” also accepts the ioctls KVM\_SET\_DEVICE\_ATTR,
KVM\_GET\_DEVICE\_ATTR, and KVM\_HAS\_DEVICE\_ATTR. The interface uses the same
...
the limit to KVM\_S390\_NO\_MEM\_LIMIT (U64\_MAX).
...
retrieved by means of KVM\_S390\_VM\_CPU\_MACHINE as hint for reasonable configuration
...
See [2.3. ATTRIBUTE: KVM\_S390\_VM\_CPU\_MACHINE\_FEAT (r/o)](#kvm-s390-vm-cpu-machine-feat) for
...
A subfunction block is only valid if KVM\_S390\_VM\_CPU\_MACHINE contains the
...
See [2.5. ATTRIBUTE: KVM\_S390\_VM\_CPU\_MACHINE\_SUBFUNC (r/o)](#kvm-s390-vm-cpu-machine-subfunc) for a
...
### 4.1. ATTRIBUTE: KVM\_S390\_VM\_CRYPTO\_ENABLE\_AES\_KW (w/o)
...
### 4.2. ATTRIBUTE: KVM\_S390\_VM\_CRYPTO\_ENABLE\_DEA\_KW (w/o)
...
### 4.3. ATTRIBUTE: KVM\_S390\_VM\_CRYPTO\_DISABLE\_AES\_KW (w/o)
...
### 4.4. ATTRIBUTE: KVM\_S390\_VM\_CRYPTO\_DISABLE\_DEA\_KW (w/o)
...
## 6. GROUP: KVM\_ARM\_VM\_SMCCC\_CTRL

Architectures:
:   arm64

### 6.1. ATTRIBUTE: KVM\_ARM\_VM\_SMCCC\_FILTER (w/o)
...
> | Start | End (inclusive) |
> | --- | --- |
> | 0x8000\_0000 | 0x8000\_FFFF |
> | 0xC000\_0000 | 0xC000\_FFFF |
