...
> 출처(원문): https://docs.kernel.org/virt/hyperv/clocks.html
...
clocksource and clockevents via the standard arm\_arch\_timer.c
...
calibration and sets tsc\_reliable. Hyper-V provides virtualized
...
“hyperv\_clocksource\_tsc\_page”).
...
`vmbus_isr()` as described in the [VMBus](vmbus.html)
...
allocates an x86 interrupt vector (HYPERV\_STIMER0\_VECTOR) across all CPUs
...
drivers/clocksource/hyperv\_timer.c.
