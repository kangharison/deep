...
> 출처(원문): https://docs.kernel.org/rust/quick-start.html
...
and fast LLVM toolchains from [Getting LLVM](../kbuild/llvm.html#getting-llvm) with versions
...
Please see [Building Linux with Clang/LLVM](../kbuild/llvm.html) for more information and further ways
