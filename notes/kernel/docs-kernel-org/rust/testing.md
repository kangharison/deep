...
> 출처(원문): https://docs.kernel.org/rust/testing.html
...
[KUnit - Linux Kernel Unit Testing](../dev-tools/kunit/index.html) for the general KUnit documentation
and [KUnit Architecture](../dev-tools/kunit/architecture.html) for the details of kernel
...
Refer to [Linux Kernel Selftests](../dev-tools/kselftest.html) for the general Kselftest
documentation.
