...
> 출처(원문): https://docs.kernel.org/input/devices/appletouch.html
...
This driver is derived from Johannes Berg’s appletrackpad driver [[1]](#f1),
...
the synaptics driver (tested with 0.14.2, available from [[2]](#f2)), and configure
