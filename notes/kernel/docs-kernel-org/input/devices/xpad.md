...
> 출처(원문): https://docs.kernel.org/input/devices/xpad.html
...
can be found on the net ([[1]](#id5), [[2]](#id6), [[3]](#id7)).
...
IDs see the xpad\_device[] array[[4]](#id8).
...
‘git log --follow [xpad - Linux USB driver for Xbox compatible controllers](#)’
