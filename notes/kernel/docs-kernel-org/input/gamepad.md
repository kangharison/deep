...
> 출처(원문): https://docs.kernel.org/input/gamepad.html
...
* Grip buttons:
  ...
  For these controllers, BTN\_GRIPR and BTN\_GRIPR2 should be used for the top
  and bottom (if present) right grip button(s), and BTN\_GRIPL and BTN\_GRIPL2
...
* Profile:
  ...
  is switched, its newly selected value is emitted as an ABS\_PROFILE event.
