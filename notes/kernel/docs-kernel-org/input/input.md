...
> 출처(원문): https://docs.kernel.org/input/input.html
...
See [Event interface](#event-interface) for notes on API.
...
[Programming Interface](joydev/joystick-api.html#joystick-api) for details.
...
the hiddev interface was designed. See [Care and feeding of your Human Interface Devices](../hid/hiddev.html)
...
available in the joystick package (see [Introduction](joydev/joystick.html#joystick-doc)).
...
Type is for example EV\_REL for relative movement, EV\_KEY for a keypress or
release. More types are defined in include/uapi/linux/input-event-codes.h.

`code` is event code, for example REL\_X or KEY\_BACKSPACE, again a complete
...
See [Input event codes](event-codes.html#input-event-codes) for more information about various event codes.
