...
> 출처(원문): https://docs.kernel.org/scsi/hptiop.html
...
>   requests allocated in host memory, write (0x80000000|(bus\_addr>>5))
...
>   outbound queue.
>
>   For requests allocated in host memory, (0x80000000|(bus\_addr>>5))
>   is posted to the outbound queue. If IOP\_REQUEST\_FLAG\_OUTPUT\_CONTEXT
...
>   the request with or-ed IOPMU\_QUEUE\_MASK\_HOST\_BITS will be put into a
