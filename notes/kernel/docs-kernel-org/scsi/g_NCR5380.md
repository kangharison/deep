...
> 출처(원문): https://docs.kernel.org/scsi/g_NCR5380.html
...
/proc/scsi/g\_NCR5380/x where x is the scsi card number as detected at boot
...
> |  |  |
> | --- | --- |
> | ncr\_irq=xx | the interrupt |
> | ncr\_addr=xx | the port or base address (for port or memory mapped, resp.) |
> | ncr\_5380=1 | to set up for a NCR5380 board |
> | ncr\_53c400=1 | to set up for a NCR53C400 board |
> | ncr\_53c400a=1 | to set up for a NCR53C400A board |
> | dtc\_3181e=1 | to set up for a Domex Technology Corp 3181E board |
> | hp\_c2502=1 | to set up for a Hewlett Packard C2502 board |
