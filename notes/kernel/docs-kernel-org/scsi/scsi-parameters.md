...
> 출처(원문): https://docs.kernel.org/scsi/scsi-parameters.html
...
See [The kernel’s command-line parameters](../admin-guide/kernel-parameters.html) for general information on
