...
> 출처(원문): https://docs.kernel.org/scsi/scsi-generic.html
...
:   * sg version 1 (original) from 1992 to early 1999 (lk 2.2.5) .
      It is based in the sg\_header interface structure.
    * sg version 2 from lk 2.2.6 in the 2.2 series. It is based on
      an extended version of the sg\_header interface structure.
    * sg version 3 found in the lk 2.4 series (and the lk 2.5 series).
      It adds the sg\_io\_hdr interface structure.
...
> |  |  |
> | --- | --- |
> | sg3\_utils | for the sg version 3 driver found in lk 2.4 |
> | sg\_utils | for the sg version 2 (and original) driver found in lk 2.2 and earlier |

Both packages will work in the lk 2.4 series. However, sg3\_utils offers more
...
> * lk 2.4.10 : sg version 3.1.20 [[1]](#id2)
...
> * lk 2.2.10 : sg version 2.1.34 [SG\_GET\_VERSION\_NUM ioctl first appeared]
