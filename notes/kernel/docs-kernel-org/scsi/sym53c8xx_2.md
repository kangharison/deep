...
> 출처(원문): https://docs.kernel.org/scsi/sym53c8xx_2.html
...
under Linux is contained in 2 files named sym\_glue.h and sym\_glue.c.
...
| 1010\_66 [[1]](#id2) | Y | Y | FAST80 | 160 MB/s | Y | Y |
...
parameters to modprobe, as described in [The kernel’s command-line parameters](../admin-guide/kernel-parameters.html)
...
> > * cmd\_per\_lun=0 (or cmd\_per\_lun=1) tagged command queuing disabled
> > * cmd\_per\_lun=#tags (#tags > 1) tagged command queuing enabled
>
...
cmd\_per\_lun to reflect its different purposes. The sample above would
be specified as:
