...
> 출처(원문): https://docs.kernel.org/scsi/aha152x.html
...
| SCSI\_ID | scsi id of controller | (0-7; default 7) |
...
| EXT\_TRANS: | enable extended translation (see NOTES) | (0/1: default 0 [off]) |
...
* DSETUP0=”{ IOPORT, IRQ, SCSI\_ID, RECONNECT, PARITY, SYNCHRONOUS, DELAY, EXT\_TRANS }”
  :   override for the first controller
* DSETUP1=”{ IOPORT, IRQ, SCSI\_ID, RECONNECT, PARITY, SYNCHRONOUS, DELAY, EXT\_TRANS }”
...
* for disks>1GB:
  ...
  + take current geometry from the partition table
    (using scsicam\_bios\_param and accept only ‘valid’ geometries,
