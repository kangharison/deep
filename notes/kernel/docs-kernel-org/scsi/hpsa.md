...
> 출처(원문): https://docs.kernel.org/scsi/hpsa.html
...
boot parameter “hpsa\_allow\_any=1” is specified, however these are not tested
nor supported by HP with this driver. For older Smart Arrays, the cciss
driver should still be used.

The “hpsa\_simple\_mode=1” boot parameter may be used to prevent the driver from
...
>
> The “firmware\_revision” attribute contains the firmware version of the Smart Array.
> For example:
>
> ```
...
> ```
>
> The transport\_mode indicates whether the controller is in “performant”
> or “simple” mode. This is controlled by the “hpsa\_simple\_mode” module
> parameter.
>
> The “resettable” read-only attribute indicates whether a particular
> controller is able to honor the “reset\_devices” kernel parameter. If the
...
> unable to honor the reset\_devices kernel parameter as a dump device.
...
>     agents, etc. See cciss\_vol\_status at <http://cciss.sf.net> for some examples.
