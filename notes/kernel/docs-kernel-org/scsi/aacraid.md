...
> 출처(원문): https://docs.kernel.org/scsi/aacraid.html
...
Matt Domsch <[matt\_domsch@dell.com](mailto:matt_domsch%40dell.com)>
...
* fixed 64bit and 64G memory model, changed confusing naming convention
  where fibs that go to the hardware are consistently called hw\_fibs and
  not just fibs like the name of the driver tracking structure

Mark Salyzyn <[Mark\_Salyzyn@adaptec.com](mailto:Mark_Salyzyn%40adaptec.com)>

* Fixed panic issues and added some new product ids for upcoming hbas.
* Performance tuning, card failover and bug mitigations.

Achim Leubner <[Achim\_Leubner@adaptec.com](mailto:Achim_Leubner%40adaptec.com)>
