...
> 출처(원문): https://docs.kernel.org/scsi/megaraid.html
...
* Matt Domsch, ([Matt\_Domsch@dell.com](mailto:Matt_Domsch%40dell.com)), 02.25.2004 LKML

## Design

The Common Management Module is implemented in megaraid\_mm.[ch] files. This
...
uioc\_t. The management module converts the older ioctl packets from the older
applications into uioc\_t. After driver handles the uioc\_t, the common module
...
Common module dedicates one uioc\_t packet to each controller registered. This
