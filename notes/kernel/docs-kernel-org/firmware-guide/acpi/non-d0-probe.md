...
> 출처(원문): https://docs.kernel.org/firmware-guide/acpi/non-d0-probe.html
...
I2C\_DRV\_ACPI\_WAIVE\_D0\_PROBE flag in [`struct i2c_driver`](../../driver-api/i2c.html#c.i2c_driver "i2c_driver").flags field and the
