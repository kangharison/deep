...
> 출처(원문): https://docs.kernel.org/firmware-guide/acpi/intel-pmc-mux.html
...
(drivers/platform/x86/intel\_scu\_ipc.c). The driver registers with the USB Type-C
...
Device modes. The driver is located here: drivers/usb/typec/mux/intel\_pmc\_mux.c.
