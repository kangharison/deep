...
> 출처(원문): https://docs.kernel.org/firmware-guide/acpi/osi.html
...
\_OSI(“Linux-OEM-my\_interface\_name”)
where ‘OEM’ is needed if this is an OEM-specific hook,
and ‘my\_interface\_name’ describes the hook, which could be a
...
were to agree on a string of the form such as “Windows-interface\_name”.
...
for legacy systems still needed it. Further a BIOS\_BUG warning prints
...
Modern Windows returns \_REV = 2. Linux used ACPI\_CA\_SUPPORT\_LEVEL,
...
the default via cmdline “acpi\_osi=!Darwin”. Linux-4.7 fixed
the ability to use acpi\_osi=!Darwin as a workaround, and
