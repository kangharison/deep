...
> 출처(원문): https://docs.kernel.org/firmware-guide/acpi/dsd/graph.html
...
The data structure may be accessed at runtime by using the device\_\*
and fwnode\_\* functions defined in include/linux/fwnode.h .
...
[data-node-ref] [Referencing hierarchical data nodes](data-node-references.html)
...
:   [\_DSD Device Properties Usage Rules](../DSD-properties-rules.html)
