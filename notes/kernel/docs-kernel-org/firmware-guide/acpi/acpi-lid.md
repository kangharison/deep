...
> 출처(원문): https://docs.kernel.org/firmware-guide/acpi/acpi-lid.html
...
Notify(lid\_device, 0x80) to notify the OSPMs whenever the lid state has
...
1. button.lid\_init\_state=method:
...
2. button.lid\_init\_state=open:
...
3. button.lid\_init\_state=ignore:
