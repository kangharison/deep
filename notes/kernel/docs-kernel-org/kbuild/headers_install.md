...
> 출처(원문): https://docs.kernel.org/kbuild/headers_install.html
...
The “make headers\_install” command exports the kernel’s header files in a
...
The “make headers\_install” command can be run in the top level directory of the
...
INSTALL\_HDR\_PATH indicates where to install the headers. It defaults to
“./usr”.

An ‘include’ directory is automatically created inside INSTALL\_HDR\_PATH and
headers are installed in ‘INSTALL\_HDR\_PATH/include’.
