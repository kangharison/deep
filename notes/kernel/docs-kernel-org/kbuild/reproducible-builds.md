...
> 출처(원문): https://docs.kernel.org/kbuild/reproducible-builds.html
...
be overridden using the [KBUILD\_BUILD\_TIMESTAMP](kbuild.html#kbuild-build-timestamp) variable.
...
[KBUILD\_BUILD\_USER and KBUILD\_BUILD\_HOST](kbuild.html#kbuild-build-user-kbuild-build-host) variables. If you are
...
the [KCFLAGS](kbuild.html#kcflags) and [KAFLAGS](kbuild.html#kaflags) variables to cover both `.c` and `.S`
files.
...
Some CONFIG options such as CONFIG\_DEBUG\_EFI embed absolute paths in
