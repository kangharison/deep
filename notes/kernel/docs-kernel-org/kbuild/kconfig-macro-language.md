...
> 출처(원문): https://docs.kernel.org/kbuild/kconfig-macro-language.html
...
dependency as explained in [Kconfig Language](kconfig-language.html).
...
this is \_useful\_ inconsistency.
