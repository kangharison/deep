...
> 출처(원문): https://docs.kernel.org/kbuild/kconfig.html
...
:   The allyesconfig/allmodconfig/alldefconfig/allnoconfig/randconfig variants
    can also use the environment variable KCONFIG\_ALLCONFIG as a flag or a
...
:   This variable can be used to skew the probabilities. This variable can
    ...
    | KCONFIG\_PROBABILITY | y:n split | y:m:n split |
    | --- | --- | --- |
...
> are not interested in MEMORY\_HOTPLUG, you could try:
>
> ```
> /^hotplug
> ```
...
>
> > ATH5K ATH9K ATH5K\_AHB ATH5K\_DEBUG [...] ATH6KL ATH6KL\_DEBUG
> > [...] ATH9K\_AHB ATH9K\_BTCOEX\_SUPPORT ATH9K\_COMMON [...]
>
...
:   It is possible to select different color themes using the variable
    MENUCONFIG\_COLOR. To select a theme use:
