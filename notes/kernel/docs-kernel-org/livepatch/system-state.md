...
> 출처(원문): https://docs.kernel.org/livepatch/system-state.html
...
Each modified state is described by [`struct klp_state`](api.html#c.klp_state "klp_state"), see
...
[`struct klp_state`](api.html#c.klp_state "klp_state"):
...
> * [`klp_get_state()`](api.html#c.klp_get_state "klp_get_state")
>
>   + Get [`struct klp_state`](api.html#c.klp_state "klp_state") associated with the given livepatch
>     and state id.
> * [`klp_get_prev_state()`](api.html#c.klp_get_prev_state "klp_get_prev_state")
>
>   + Get [`struct klp_state`](api.html#c.klp_state "klp_state") associated with the given feature id and
>     already installed livepatches.
...
>   checking *[`klp_get_prev_state()`](api.html#c.klp_get_prev_state "klp_get_prev_state")*.
