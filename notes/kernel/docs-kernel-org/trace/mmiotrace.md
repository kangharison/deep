...
> 출처(원문): https://docs.kernel.org/trace/mmiotrace.html
...
the Nouveau project as the first real user. Only x86 and x86\_64 architectures
are supported.
...
Mmiotrace feature is compiled in by the CONFIG\_MMIOTRACE option. Tracing is
...
$ echo “X is up” > /sys/kernel/tracing/trace\_marker
...
calling one of the ioremap\_\*() functions. Mmiotrace is hooked into the
