...
> 출처(원문): https://docs.kernel.org/trace/coresight/panic.html
...
or from crashdump kernel using a special device file /dev/crash\_tmc\_xxx.
...
1. Boot Linux kernel with “crash\_kexec\_post\_notifiers” added to the kernel
