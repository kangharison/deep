...
> 출처(원문): https://docs.kernel.org/trace/coresight/coresight-ect.html
...
where the optional <trigger> is only needed for trigXX\_attach | detach
operations.
...
set state on cti\_sys0.trigout(1)
