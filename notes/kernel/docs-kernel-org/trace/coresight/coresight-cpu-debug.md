...
> 출처(원문): https://docs.kernel.org/trace/coresight/coresight-cpu-debug.html
...
The driver calls the pm\_runtime\_{put|get} operations as needed to handle the
debug power domain.
...
“coresight\_cpu\_debug.enable=1” to the kernel command line parameter.
...
To enable it, write a ‘1’ into /sys/kernel/debug/coresight\_cpu\_debug/enable:

```
# echo 1 > /sys/kernel/debug/coresight_cpu_debug/enable
```

To disable it, write a ‘0’ into /sys/kernel/debug/coresight\_cpu\_debug/enable:
...
subsystem, more specifically by using the “/dev/cpu\_dma\_latency”
interface (see [PM Quality Of Service Interface](../../power/pm_qos_interface.html) for more
...
[CPU Idle Time Management](../../admin-guide/pm/cpuidle.html)):
