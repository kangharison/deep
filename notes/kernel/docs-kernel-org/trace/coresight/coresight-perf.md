...
> 출처(원문): https://docs.kernel.org/trace/coresight/coresight-perf.html
...
* “aux-action=start-paused”: it is specified for the cs\_etm PMU event to
...
> stats-asm\_pure\_loop-out.csv
> stats-memcpy\_thread-16k\_10.csv
> ...
...
PERF\_TEST\_CORESIGHT\_STATDIR environment variable before running perf
test like:
...
PERF\_TEST\_CORESIGHT\_DATADIR environment variable such as:
