...
> 출처(원문): https://docs.kernel.org/trace/hisi-ptt.html
...
The name of each PTT device is composed of ‘hisi\_ptt’ prefix with
...
* qos\_tx\_cpl: weight of Tx completion TLPs
* qos\_tx\_np: weight of Tx non-posted TLPs
* qos\_tx\_p: weight of Tx posted TLPs
...
* rx\_alloc\_buf\_level: watermark of Rx requested
* tx\_alloc\_buf\_level: watermark of Tx requested
...
under $(PTT PMU dir)/root\_port\_filters and files of Requester filters
are under $(PTT PMU dir)/requester\_filters.
