...
> 출처(원문): https://docs.kernel.org/trace/rv/runtime-verification.html
...
> synchronization model for the PREEMPT\_RT Linux kernel.* Journal of Systems
...
“tracing\_on” switcher in the trace interface.
