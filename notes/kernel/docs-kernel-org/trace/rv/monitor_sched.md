...
> 출처(원문): https://docs.kernel.org/trace/rv/monitor_sched.html
...
flag set to true (e.g. from preempt\_enable or exiting from interrupts). This
...
In the situation above, standard preemption starts (e.g. from preempt\_enable
