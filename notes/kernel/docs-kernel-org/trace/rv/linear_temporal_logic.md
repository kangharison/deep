...
> 출처(원문): https://docs.kernel.org/trace/rv/linear_temporal_logic.html
...
In the above examples, RAIN, GO\_OUTSIDE, HAVE\_UMBRELLA and WET are the
“atomic propositions”.
...
the LTL. See [Runtime Verification Monitor Synthesis](monitor_synthesis.html) for details on using
rvgen.
