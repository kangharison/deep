...
> 출처(원문): https://docs.kernel.org/watchdog/mlx-wdt.html
...
Watchdog driver is probed from the common mlx\_platform driver.
Mlx\_platform driver provides an appropriate set of registers for
...
watchdog configuration flags: nowayout and start\_at\_boot, hw watchdog
