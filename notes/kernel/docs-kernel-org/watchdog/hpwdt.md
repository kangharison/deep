...
> 출처(원문): https://docs.kernel.org/watchdog/hpwdt.html
...
> |  |  |
> | --- | --- |
> | soft\_margin | allows the user to set the watchdog timer value. Default value is 30 seconds. |
> | timeout | an alias of soft\_margin. |
...
>     [The Linux Watchdog driver API](watchdog-api.html) and [The Linux IPMI Driver](../driver-api/ipmi.html)
>
...
> :   * [Documentation for Kdump - The kexec-based Crash Dumping Solution](../admin-guide/kdump/kdump.html)
>     * [The kernel’s command-line parameters](../admin-guide/kernel-parameters.html) (panic=)
