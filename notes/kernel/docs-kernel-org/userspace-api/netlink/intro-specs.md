...
> 출처(원문): https://docs.kernel.org/userspace-api/netlink/intro-specs.html
...
specifications. For more detailed description of the specs see [Netlink protocol specifications (in YAML)](specs.html).
