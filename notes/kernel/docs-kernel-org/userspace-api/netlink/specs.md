...
> 출처(원문): https://docs.kernel.org/userspace-api/netlink/specs.html
...
> * the C uAPI header
> * documentation of the protocol as a ReST file - see [Documentation/netlink/specs/index.rst](../../netlink/specs/index.html#specs)
...
See [Using Netlink protocol specifications](intro-specs.html) for a practical starting guide.
...
schema. See the documentation of [genetlink-c](c-code-gen.html)
for information on how C names are derived from name properties.

See also [Documentation/core-api/netlink.rst](../../core-api/netlink.html#kernel-netlink) for
...
Netlink attribute type, see [Attribute types](#attr-types).
...
more detail in [Netlink specification support for legacy Generic Netlink families](genetlink-legacy.html).
...
or both of these properties, each holding a [Message attribute list](#attr-list).
...
Specification of attributes in the event, holds a [Message attribute list](#attr-list).
...
See [pad](#pad-type) for padding of 64 bit attributes.
