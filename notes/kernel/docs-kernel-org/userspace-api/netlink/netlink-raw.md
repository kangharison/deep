...
> 출처(원문): https://docs.kernel.org/userspace-api/netlink/netlink-raw.html
...
The netlink-raw schema extends the [genetlink-legacy](genetlink-legacy.html)
schema with properties that are needed to specify the protocol numbers and
multicast IDs used by raw netlink families. See [Classic Netlink](intro.html#classic-netlink) for more
...
[rt-link](../../netlink/specs/rt-link.html#netlink-rt-link) and
[tc](../../netlink/specs/tc.html#netlink-tc) use attribute nesting as an
...
The `GENERIC ATTRs` at the outer level are defined in the core (or rt\_link or
...
Many raw netlink families such as [tc](../../netlink/specs/tc.html#netlink-tc)
