...
> 출처(원문): https://docs.kernel.org/userspace-api/check_exec.html
...
The `AT_EXECVE_CHECK` *[execveat(2)](https://man7.org/linux/man-pages/man2/execveat.2.html)* flag, and the
...
Passing the `AT_EXECVE_CHECK` flag to *[execveat(2)](https://man7.org/linux/man-pages/man2/execveat.2.html)* only performs a
...
## SECBIT\_EXEC\_RESTRICT\_FILE and SECBIT\_EXEC\_DENY\_INTERACTIVE

When `SECBIT_EXEC_RESTRICT_FILE` is set, a process should only interpret or
execute a file if a call to *[execveat(2)](https://man7.org/linux/man-pages/man2/execveat.2.html)* with the related file
...
call to *[execveat(2)](https://man7.org/linux/man-pages/man2/execveat.2.html)* with the related file descriptor and the
...
1. `SECBIT_EXEC_RESTRICT_FILE=0` and `SECBIT_EXEC_DENY_INTERACTIVE=0`
   ...
   potential issues thanks to the call to *[execveat(2)](https://man7.org/linux/man-pages/man2/execveat.2.html)* with
