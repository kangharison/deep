...
> 출처(원문): https://docs.kernel.org/userspace-api/gpio/sysfs.html
...
This API is obsoleted by the [GPIO Character Device Userspace API](chardev.html) and the ABI documentation has
been moved to [ABI file obsolete/sysfs-gpio](../../admin-guide/abi-obsolete-files.html#abi-file-obsolete-sysfs-gpio).

New developments should use the [GPIO Character Device Userspace API](chardev.html), and existing developments are
...
Please read [Subsystem drivers using GPIO](../../driver-api/gpio/drivers-on-gpio.html)
...
the sysfs interface by [`gpiod_export()`](../../driver-api/gpio/index.html#c.gpiod_export "gpiod_export"). The driver can control whether the
...
After the GPIO has been exported, [`gpiod_export_link()`](../../driver-api/gpio/index.html#c.gpiod_export_link "gpiod_export_link") allows creating
