...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/dev-encoder.html
...
Refer to [Glossary](dev-decoder.html#decoder-glossary).
...
1. To enumerate the set of coded formats supported by the encoder, the
   client may call [`VIDIOC_ENUM_FMT()`](vidioc-enum-fmt.html#c.V4L.VIDIOC_ENUM_FMT "VIDIOC_ENUM_FMT") on `CAPTURE`.

   * The full set of supported formats will be returned, regardless of the
     format set on `OUTPUT`.
2. To enumerate the set of supported raw formats, the client may call
   [`VIDIOC_ENUM_FMT()`](vidioc-enum-fmt.html#c.V4L.VIDIOC_ENUM_FMT "VIDIOC_ENUM_FMT") on `OUTPUT`.
...
3. The client may use [`VIDIOC_ENUM_FRAMESIZES()`](vidioc-enum-framesizes.html#c.V4L.VIDIOC_ENUM_FRAMESIZES "VIDIOC_ENUM_FRAMESIZES") to detect supported
   ...
   * Values returned by [`VIDIOC_ENUM_FRAMESIZES()`](vidioc-enum-framesizes.html#c.V4L.VIDIOC_ENUM_FRAMESIZES "VIDIOC_ENUM_FRAMESIZES") for a raw pixel format
     ...
     `CAPTURE`.
4. The client may use [`VIDIOC_ENUM_FRAMEINTERVALS()`](vidioc-enum-frameintervals.html#c.V4L.VIDIOC_ENUM_FRAMEINTERVALS "VIDIOC_ENUM_FRAMEINTERVALS") to detect supported
   frame intervals for a given format and resolution, passing the desired pixel
   format in [`v4l2_frmivalenum`](vidioc-enum-frameintervals.html#c.V4L.v4l2_frmivalenum "v4l2_frmivalenum") `pixel_format` and the resolution
   in [`v4l2_frmivalenum`](vidioc-enum-frameintervals.html#c.V4L.v4l2_frmivalenum "v4l2_frmivalenum") `width` and [`v4l2_frmivalenum`](vidioc-enum-frameintervals.html#c.V4L.v4l2_frmivalenum "v4l2_frmivalenum")
   `height`.

   * Values returned by [`VIDIOC_ENUM_FRAMEINTERVALS()`](vidioc-enum-frameintervals.html#c.V4L.VIDIOC_ENUM_FRAMEINTERVALS "VIDIOC_ENUM_FRAMEINTERVALS") for a coded pixel
   ...
   * Values returned by [`VIDIOC_ENUM_FRAMEINTERVALS()`](vidioc-enum-frameintervals.html#c.V4L.VIDIOC_ENUM_FRAMEINTERVALS "VIDIOC_ENUM_FRAMEINTERVALS") for a raw pixel
     ...
     `CAPTURE`.
   * Support for [`VIDIOC_ENUM_FRAMEINTERVALS()`](vidioc-enum-frameintervals.html#c.V4L.VIDIOC_ENUM_FRAMEINTERVALS "VIDIOC_ENUM_FRAMEINTERVALS") is optional. If it is
...
1. Set the coded format on the `CAPTURE` queue via [`VIDIOC_S_FMT()`](vidioc-g-fmt.html#c.V4L.VIDIOC_S_FMT "VIDIOC_S_FMT").
...
2. **Optional.** Enumerate supported `OUTPUT` formats (raw formats for
   source) for the selected coded format via [`VIDIOC_ENUM_FMT()`](vidioc-enum-fmt.html#c.V4L.VIDIOC_ENUM_FMT "VIDIOC_ENUM_FMT").
...
3. Set the raw source format on the `OUTPUT` queue via
   ...
   * **Returned fields:**
     ...
     :   may be adjusted to match encoder minimums, maximums and alignment
         ...
         reported by [`VIDIOC_ENUM_FRAMESIZES()`](vidioc-enum-framesizes.html#c.V4L.VIDIOC_ENUM_FRAMESIZES "VIDIOC_ENUM_FRAMESIZES").
...
4. Set the raw frame interval on the `OUTPUT` queue via
   [`VIDIOC_S_PARM()`](vidioc-g-parm.html#c.V4L.VIDIOC_S_PARM "VIDIOC_S_PARM"). This also sets the coded frame interval on the
...
5. **Optional** Set the coded frame interval on the `CAPTURE` queue via
   [`VIDIOC_S_PARM()`](vidioc-g-parm.html#c.V4L.VIDIOC_S_PARM "VIDIOC_S_PARM"). This is only necessary if the coded frame
   ...
   by the [V4L2\_FMT\_FLAG\_ENC\_CAP\_FRAME\_INTERVAL](vidioc-enum-fmt.html#fmtdesc-flags) format flag.
...
6. **Optional.** Set the visible resolution for the stream metadata via
   [`VIDIOC_S_SELECTION()`](vidioc-g-selection.html#c.V4L.VIDIOC_S_SELECTION "VIDIOC_S_SELECTION") on the `OUTPUT` queue if it is desired
   ...
   * **Required fields:**
     ...
     :   visible rectangle; this must fit within the V4L2\_SEL\_TGT\_CROP\_BOUNDS
...
7. Allocate buffers for both `OUTPUT` and `CAPTURE` via
   [`VIDIOC_REQBUFS()`](vidioc-reqbufs.html#c.V4L.VIDIOC_REQBUFS "VIDIOC_REQBUFS"). This may be performed in any order.
   ...
   * **Returned fields:**
   ...
   Alternatively, [`VIDIOC_CREATE_BUFS()`](vidioc-create-bufs.html#c.V4L.VIDIOC_CREATE_BUFS "VIDIOC_CREATE_BUFS") can be used to have more
...
8. Begin streaming on both `OUTPUT` and `CAPTURE` queues via
   [`VIDIOC_STREAMON()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMON "VIDIOC_STREAMON"). This may be performed in any order. The actual
...
queues via [`VIDIOC_QBUF()`](vidioc-qbuf.html#c.V4L.VIDIOC_QBUF "VIDIOC_QBUF") and [`VIDIOC_DQBUF()`](vidioc-qbuf.html#c.V4L.VIDIOC_DQBUF "VIDIOC_DQBUF"), following the
standard semantics.
...
[`v4l2_buffer`](buffer.html#c.V4L.v4l2_buffer "v4l2_buffer") `struct when` dequeued. See the documentation of
[`v4l2_buffer`](buffer.html#c.V4L.v4l2_buffer "v4l2_buffer") and each coded pixel format for exact list of flags
and their meanings.
...
The client is allowed to use [`VIDIOC_S_CTRL()`](vidioc-g-ctrl.html#c.V4L.VIDIOC_S_CTRL "VIDIOC_S_CTRL") to change encoder
...
([Request API](../mediactl/request-api.html#media-request-api)) should be considered, if supported by the encoder.
...
1. Begin the drain sequence by issuing [`VIDIOC_ENCODER_CMD()`](vidioc-encoder-cmd.html#c.V4L.VIDIOC_ENCODER_CMD "VIDIOC_ENCODER_CMD").
   ...
   * **Required fields:**
   ...
   [`VIDIOC_ENCODER_CMD()`](vidioc-encoder-cmd.html#c.V4L.VIDIOC_ENCODER_CMD "VIDIOC_ENCODER_CMD") will not fail even if any of the queues is
   not streaming, but at the same time it will not initiate the Drain
   sequence and so the steps described below would not be applicable.
2. Any `OUTPUT` buffers queued by the client before the
   [`VIDIOC_ENCODER_CMD()`](vidioc-encoder-cmd.html#c.V4L.VIDIOC_ENCODER_CMD "VIDIOC_ENCODER_CMD") was issued will be processed and encoded as
...
3. Once all `OUTPUT` buffers queued before the `V4L2_ENC_CMD_STOP` call are
   ...
   * a pair of [`VIDIOC_STREAMOFF()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMOFF "VIDIOC_STREAMOFF") and [`VIDIOC_STREAMON()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMON "VIDIOC_STREAMON") on the
     ...
     and [`VIDIOC_STREAMOFF()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMOFF "VIDIOC_STREAMOFF") will be discarded.
...
* In case of no buffer in the `CAPTURE` queue at the time the drain
  ...
  flag set.
* If [`VIDIOC_STREAMOFF()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMOFF "VIDIOC_STREAMOFF") is called on the `CAPTURE` queue in the
  middle of the drain sequence, the drain sequence is canceled and all
  `CAPTURE` buffers are implicitly returned to the client.
* If [`VIDIOC_STREAMOFF()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMOFF "VIDIOC_STREAMOFF") is called on the `OUTPUT` queue in the
...
using [`VIDIOC_TRY_ENCODER_CMD()`](vidioc-encoder-cmd.html#c.V4L.VIDIOC_TRY_ENCODER_CMD "VIDIOC_TRY_ENCODER_CMD").
...
2. Stop streaming on the `CAPTURE` queue via [`VIDIOC_STREAMOFF()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMOFF "VIDIOC_STREAMOFF"). This
   will return all currently queued `CAPTURE` buffers to the client, without
   valid frame data.
3. Start streaming on the `CAPTURE` queue via [`VIDIOC_STREAMON()`](vidioc-streamon.html#c.V4L.VIDIOC_STREAMON "VIDIOC_STREAMON") and
   ...
   V4L2\_ENC\_CMD\_STOP of the Drain sequence.
