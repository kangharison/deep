...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/pixfmt-intro.html
...
defined in the [videodev2.h](videodev.html#videodev) header file. These
identifiers represent
[four character (FourCC) codes](vidioc-enum-fmt.html#v4l2-fourcc) which are also
...
[YUV422](pixfmt-yuv-planar.html#v4l2-pix-fmt-yuv422m) frame is normally stored in one
