...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/pixfmt-srggb12.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# 2.6.1.9. V4L2\_PIX\_FMT\_SRGGB12 (‘RG12’), V4L2\_PIX\_FMT\_SGRBG12 (‘BA12’), V4L2\_PIX\_FMT\_SGBRG12 (‘GB12’), V4L2\_PIX\_FMT\_SBGGR12 (‘BG12’),
...
of a small V4L2\_PIX\_FMT\_SBGGR12 image:
