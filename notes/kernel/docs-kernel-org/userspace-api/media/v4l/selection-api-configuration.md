...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/selection-api-configuration.html
...
Applications can use the [selection API](vidioc-g-selection.html#vidioc-g-selection) to
...
[constraint flags](v4l2-selection-flags.html#v4l2-selection-flags).

## 1.27.3.1. Configuration of video capture

See figure [Cropping and composing targets](selection-api-targets.html#sel-targets-capture) for examples of the selection
...
the image size set by [VIDIOC\_S\_FMT](vidioc-g-fmt.html#vidioc-g-fmt).
...
specified using [VIDIOC\_S\_FMT](vidioc-g-fmt.html#vidioc-g-fmt) ioctl.
