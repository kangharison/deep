...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/vidioc-querystd.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# 7.51. ioctl VIDIOC\_QUERYSTD, VIDIOC\_SUBDEV\_QUERYSTD

## 7.51.1. Name

VIDIOC\_QUERYSTD - VIDIOC\_SUBDEV\_QUERYSTD - Sense the video standard received by the current input
...
automatically. To do so, applications call [ioctl VIDIOC\_QUERYSTD, VIDIOC\_SUBDEV\_QUERYSTD](#vidioc-querystd) with a
pointer to a [v4l2\_std\_id](vidioc-enumstd.html#v4l2-std-id) type. The driver
...
[ioctl VIDIOC\_QUERYSTD, VIDIOC\_SUBDEV\_QUERYSTD](#vidioc-querystd). The reason is that a new video standard can mean
...
will have to call [ioctl VIDIOC\_QUERYSTD, VIDIOC\_SUBDEV\_QUERYSTD](#vidioc-querystd), and if the detected video
