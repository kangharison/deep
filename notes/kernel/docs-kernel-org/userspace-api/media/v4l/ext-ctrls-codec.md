...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/ext-ctrls-codec.html
...
defines are prefixed with V4L2\_CID\_MPEG/V4L2\_MPEG as the controls
...
enum v4l2\_mpeg\_stream\_vbi\_fmt -
...
enum v4l2\_mpeg\_audio\_sampling\_freq -
...
enum v4l2\_mpeg\_audio\_encoding -
...
enum v4l2\_mpeg\_audio\_l1\_bitrate -
...
enum v4l2\_mpeg\_audio\_l2\_bitrate -
...
enum v4l2\_mpeg\_audio\_l3\_bitrate -
...
enum v4l2\_mpeg\_audio\_ac3\_bitrate -
...
enum v4l2\_mpeg\_audio\_mode\_extension -
...
enum v4l2\_mpeg\_audio\_emphasis -
...
enum v4l2\_mpeg\_audio\_dec\_playback -
...
enum v4l2\_mpeg\_video\_encoding -
...
enum v4l2\_mpeg\_video\_aspect -
...
enum v4l2\_mpeg\_video\_bitrate\_mode -
...
enum v4l2\_mpeg\_video\_frame\_skip\_mode -
...
| `V4L2_MPEG_VIDEO_FRAME_SKIP_MODE_BUF_LIMIT` | Frame skip mode enabled and buffer limit is set by the [VBV (MPEG1/2/4)](#v4l2-mpeg-video-vbv-size) or [CPB (H264) buffer size](#v4l2-mpeg-video-h264-cpb-size) control. |
...
:   This read-only control returns the 33-bit video Presentation Time
    ...
    [ioctl VIDIOC\_DECODER\_CMD, VIDIOC\_TRY\_DECODER\_CMD](vidioc-decoder-cmd.html#vidioc-decoder-cmd).
...
enum v4l2\_mpeg\_video\_h264\_vui\_sar\_idc -
...
enum v4l2\_mpeg\_video\_h264\_level -
...
enum v4l2\_mpeg\_video\_mpeg2\_level -
...
enum v4l2\_mpeg\_video\_mpeg4\_level -
...
enum v4l2\_mpeg\_video\_h264\_profile -
...
enum v4l2\_mpeg\_video\_mpeg2\_profile -
...
enum v4l2\_mpeg\_video\_mpeg4\_profile -
...
enum v4l2\_mpeg\_video\_multi\_slice\_mode -
...
enum v4l2\_mpeg\_video\_h264\_loop\_filter\_mode -
...
:   Loop filter alpha coefficient, defined in the H264 standard.
    This value corresponds to the slice\_alpha\_c0\_offset\_div2 slice header
...
:   Loop filter beta coefficient, defined in the H264 standard.
    This corresponds to the slice\_beta\_offset\_div2 slice header field, and
...
enum v4l2\_mpeg\_video\_h264\_entropy\_mode -
...
enum v4l2\_mpeg\_video\_intra\_refresh\_period\_type -
:   Sets the type of intra refresh. The period to refresh
    the whole frame is specified by V4L2\_CID\_MPEG\_VIDEO\_INTRA\_REFRESH\_PERIOD.
...
:   Minimum quantization parameter for the H264 I frame to limit I frame
    ...
    V4L2\_CID\_MPEG\_VIDEO\_H264\_MIN\_QP is also set, the quantization parameter
...
:   Maximum quantization parameter for the H264 I frame to limit I frame
    quality to a range. Valid range: from 0 to 51. If
    V4L2\_CID\_MPEG\_VIDEO\_H264\_MAX\_QP is also set, the quantization parameter
    should be chosen to meet both requirements.
...
:   Period between I-frames in the open GOP for H264. In case of an open
    ...
    (Instantaneous Decoding Refresh) frames is taken from the GOP\_SIZE
...
enum v4l2\_mpeg\_video\_header\_mode -
...
:   vop\_time\_increment\_resolution value for MPEG4. Applicable to the
    MPEG4 encoder.

`V4L2_CID_MPEG_VIDEO_MPEG4_VOP_TIME_INC (integer)`
:   vop\_time\_increment value for MPEG4. Applicable to the MPEG4
    encoder.
...
enum v4l2\_mpeg\_video\_h264\_sei\_fp\_arrangement\_type -
...
enum v4l2\_mpeg\_video\_h264\_fmo\_map\_type -
...
enum v4l2\_mpeg\_video\_h264\_fmo\_change\_dir -
...
enum v4l2\_mpeg\_video\_h264\_hierarchical\_coding\_type -
...
:   This read-only control returns the average QP value of the currently
    ...
    (VIDIOC\_DQBUF). Its valid range depends on the encoding format and parameters.
    ...
    If the codec’s MIN\_QP and MAX\_QP are set, then the QP will meet both requirements.
...
enum v4l2\_mpeg\_mfc51\_video\_frame\_skip\_mode -
:   Indicates in what conditions the encoder should skip frames. If
    encoding a frame would cause the encoded stream to be larger then a
    chosen data limit then the frame will be skipped. Possible values
    are:
...
enum v4l2\_mpeg\_mfc51\_video\_force\_frame\_type -
...
enum v4l2\_mpeg\_cx2341x\_video\_spatial\_filter\_mode -
...
enum v4l2\_mpeg\_cx2341x\_video\_luma\_spatial\_filter\_type -
...
enum v4l2\_mpeg\_cx2341x\_video\_chroma\_spatial\_filter\_type -
...
enum v4l2\_mpeg\_cx2341x\_video\_temporal\_filter\_mode -
...
enum v4l2\_mpeg\_cx2341x\_video\_median\_filter\_type -
...
:   The CX2341X MPEG encoder can insert one empty MPEG-2 PES packet into
    ...
    bytes, including the packet\_start\_code\_prefix and stream\_id
    fields. The stream\_id is 0xBF (private stream 2). The payload
...
enum v4l2\_vp8\_num\_partitions -
...
enum v4l2\_vp8\_num\_ref\_frames -
...
enum v4l2\_vp8\_golden\_frame\_sel -
...
enum v4l2\_mpeg\_video\_vp8\_profile -
...
enum v4l2\_mpeg\_video\_vp9\_profile -
...
enum v4l2\_mpeg\_video\_vp9\_level -
...
:   Quantization parameter for an I frame for HEVC.
    Valid range: [V4L2\_CID\_MPEG\_VIDEO\_HEVC\_MIN\_QP,
...
:   Minimum quantization parameter for the HEVC I frame to limit I frame
    ...
    If V4L2\_CID\_MPEG\_VIDEO\_HEVC\_MIN\_QP is also set, the quantization parameter
    should be chosen to meet both requirements.

`V4L2_CID_MPEG_VIDEO_HEVC_I_FRAME_MAX_QP (integer)`
:   Maximum quantization parameter for the HEVC I frame to limit I frame
    quality to a range. Valid range: from 0 to 51 for 8 bit and from 0 to 63 for 10 bit.
    If V4L2\_CID\_MPEG\_VIDEO\_HEVC\_MAX\_QP is also set, the quantization parameter
    should be chosen to meet both requirements.
...
:   HIERARCHICAL\_QP allows the host to specify the quantization parameter
    values for each temporal layer through HIERARCHICAL\_QP\_LAYER. This is
    valid only if HIERARCHICAL\_CODING\_LAYER is greater than 1. Setting the
    control value to 1 enables setting of the QP values for the layers.

`V4L2_CID_MPEG_VIDEO_HEVC_HIER_CODING_TYPE`
:   (enum)

enum v4l2\_mpeg\_video\_hevc\_hier\_coding\_type -
...
enum v4l2\_mpeg\_video\_hevc\_profile -
...
enum v4l2\_mpeg\_video\_hevc\_level -
...
enum v4l2\_mpeg\_video\_hevc\_tier -
:   TIER\_FLAG specifies tiers information of the HEVC encoded picture. Tier
...
enum v4l2\_mpeg\_video\_hevc\_loop\_filter\_mode -
...
enum v4l2\_mpeg\_video\_hevc\_hier\_refresh\_type -
:   Selects refresh type for HEVC encoder.
    Host has to specify the period into
    V4L2\_CID\_MPEG\_VIDEO\_HEVC\_REFRESH\_PERIOD.
...
:   Selects the refresh period for HEVC encoder.
    ...
    This is valid only if REFRESH\_TYPE is not 0.
...
:   Specifies if HEVC generates a stream with a size of the length field
    ...
    through the V4L2\_CID\_MPEG\_VIDEO\_HEVC\_SIZE\_OF\_LENGTH\_FIELD control. Setting
...
enum v4l2\_mpeg\_video\_hevc\_size\_of\_length\_field -
:   Indicates the size of length field.
    This is valid when encoding WITHOUT\_STARTCODE\_ENABLE is enabled.
