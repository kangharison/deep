...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/ext-ctrls-fm-tx.html
...
The FM Transmitter (FM\_TX) class includes controls for common features
...
## 1.20.1. FM\_TX Control IDs

`V4L2_CID_FM_TX_CLASS (class)`
:   The FM\_TX class descriptor. Calling
...
:   Sets the Programme Service name (PS\_NAME) for transmission. It is
    ...
    Annex E of [IEC 62106](biblio.html#iec62106), the RDS specification, there is a full
...
:   Sets the Radio Text info for transmission. It is a textual
    ...
    E of [IEC 62106](biblio.html#iec62106). The length of Radio Text strings depends on
...
For more details about RDS specification, refer to [IEC 62106](biblio.html#iec62106)
