...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/ext-ctrls-camera.html
...
enum v4l2\_exposure\_auto\_type -
...
enum v4l2\_auto\_n\_preset\_white\_balance -
...
:   Determines ISO equivalent of an image sensor indicating the sensor’s
    ...
    as per [ISO 12232:2006](biblio.html#iso12232) standard, where doubling the sensor
...
enum v4l2\_iso\_sensitivity\_type -
...
:   This read-only control describes the rotation correction in degrees in the
    ...
    V4L2\_CID\_CAMERA\_SENSOR\_ROTATION control is 0, no rotation is required to
    ...
    V4L2\_CID\_CAMERA\_SENSOR\_ROTATION control is 180 degrees, as images will
    ...
    V4L2\_CID\_CAMERA\_SENSOR\_ROTATION will report a 90 degree rotation.
