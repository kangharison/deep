...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/ext-ctrls-jpeg.html
...
:   The chroma subsampling factors describe how each component of an
    ...
    spatial dimension. See [ITU-T.81](biblio.html#itu-t81), clause A.1.1. for more
...
For more details about JPEG specification, refer to [ITU-T.81](biblio.html#itu-t81),
[JFIF](biblio.html#jfif), [W3C JPEG JFIF](biblio.html#w3c-jpeg-jfif).
