...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/colorspaces.html
...
following resources are useful: [poynton](biblio.html#poynton) is a good practical
book for video engineers, [colimg](biblio.html#colimg) has a much broader scope and
