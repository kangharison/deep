...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/dev-osd.html
...
[Video Overlay](dev-overlay.html#overlay) interface.

The OSD function is accessible through the same character special file
as the [Video Output](dev-capture.html#capture) function.
...
struct [`v4l2_capability`](vidioc-querycap.html#c.V4L.v4l2_capability "v4l2_capability") returned by the
...
the [VIDIOC\_G\_FBUF](vidioc-g-fbuf.html#vidioc-g-fbuf) ioctl. It returns, amongst
other information, the physical address of the framebuffer in the
`base` field of struct [`v4l2_framebuffer`](vidioc-g-fbuf.html#c.V4L.v4l2_framebuffer "v4l2_framebuffer").
...
A struct [`v4l2_window`](dev-overlay.html#c.V4L.v4l2_window "v4l2_window") defines the size of the
...
[`v4l2_format`](vidioc-g-fmt.html#c.V4L.v4l2_format "v4l2_format") to
`V4L2_BUF_TYPE_VIDEO_OUTPUT_OVERLAY` and call the
[VIDIOC\_G\_FMT](vidioc-g-fmt.html#vidioc-g-fmt) ioctl. The driver fills the
struct [`v4l2_window`](dev-overlay.html#c.V4L.v4l2_window "v4l2_window") substructure named `win`. It is not
...
substructure and call the [VIDIOC\_S\_FMT](vidioc-g-fmt.html#vidioc-g-fmt) ioctl.
The driver adjusts the parameters against hardware limits and returns
the actual parameters as [VIDIOC\_G\_FMT](vidioc-g-fmt.html#vidioc-g-fmt) does. Like [VIDIOC\_S\_FMT](vidioc-g-fmt.html#vidioc-g-fmt),
the [VIDIOC\_TRY\_FMT](vidioc-g-fmt.html#vidioc-g-fmt) ioctl can be used to learn
about driver capabilities without actually changing driver state. Unlike
[VIDIOC\_S\_FMT](vidioc-g-fmt.html#vidioc-g-fmt) this also works after the overlay has been enabled.

A struct [`v4l2_crop`](vidioc-g-crop.html#c.V4L.v4l2_crop "v4l2_crop") defines the size and position
of the target rectangle. The scaling factor of the overlay is implied by
the width and height given in struct [`v4l2_window`](dev-overlay.html#c.V4L.v4l2_window "v4l2_window")
and struct [`v4l2_crop`](vidioc-g-crop.html#c.V4L.v4l2_crop "v4l2_crop"). The cropping API applies to
...
direction of the data flow. For more information see [Image Cropping, Insertion and Scaling -- the CROP API](crop.html#crop).
