...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/func-ioctl.html
...
The [ioctl()](#func-ioctl) function is used to program V4L2 devices. The
...
specified in [Function Reference](user-func.html#user-func).
