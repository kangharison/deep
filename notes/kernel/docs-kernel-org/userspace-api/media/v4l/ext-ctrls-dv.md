...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/ext-ctrls-dv.html
...
(Digital Visual Interface), HDMI ([HDMI](biblio.html#hdmi)) and DisplayPort
([DP](biblio.html#dp)). These controls are generally expected to be private to
...
Identification Data, [EDID](biblio.html#vesaedid)) and HDCP (High-bandwidth Digital
Content Protection System, [HDCP](biblio.html#hdcp)) processing, allowing the
...
:   HDMI transmitters can transmit in DVI-D mode (just video) or in HDMI
    ...
    mode to use: V4L2\_DV\_TX\_MODE\_DVI\_D or V4L2\_DV\_TX\_MODE\_HDMI.
    This control is applicable to HDMI connectors.

`V4L2_CID_DV_TX_RGB_RANGE`
:   (enum)

enum v4l2\_dv\_rgb\_range -
:   Select the quantization range for RGB output. V4L2\_DV\_RANGE\_AUTO
    follows the RGB quantization range specified in the standard for the
    video interface (ie. [CEA-861-E](biblio.html#cea861) for HDMI).
    V4L2\_DV\_RANGE\_LIMITED and V4L2\_DV\_RANGE\_FULL override the
...
enum v4l2\_dv\_it\_content\_type -
...
enum v4l2\_dv\_rgb\_range -
:   Select the quantization range for RGB input. V4L2\_DV\_RANGE\_AUTO
    follows the RGB quantization range specified in the standard for the
    video interface (ie. [CEA-861-E](biblio.html#cea861) for HDMI).
    V4L2\_DV\_RANGE\_LIMITED and V4L2\_DV\_RANGE\_FULL override the
