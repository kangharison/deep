...
> 출처(원문): https://docs.kernel.org/userspace-api/media/v4l/dev-mem2mem.html
...
both sides and finally call [VIDIOC\_STREAMON](vidioc-streamon.html#vidioc-streamon)
...
See [Codec Control Reference](ext-ctrls-codec.html#codec-controls). More details on how to use codec memory-to-memory
