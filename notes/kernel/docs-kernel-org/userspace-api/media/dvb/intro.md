...
> 출처(원문): https://docs.kernel.org/userspace-api/media/dvb/intro.html
...
[Components of a Digital TV card/STB](#stb-components) shows a crude schematic of the control and data
