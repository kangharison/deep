...
> 출처(원문): https://docs.kernel.org/userspace-api/media/cec/cec-intro.html
...
Channel) of the HDMI 1.4a ([HDMI](../v4l/biblio.html#hdmi)) specification and the
extensions added to CEC version 2.0 are defined in chapter 11 of the
HDMI 2.0 ([HDMI2](../v4l/biblio.html#hdmi2)) specification.
...
[ioctl CEC\_ADAP\_G\_CAPS](cec-ioc-adap-g-caps.html#cec-adap-g-caps) ioctl will tell userspace what it is allowed to do.
