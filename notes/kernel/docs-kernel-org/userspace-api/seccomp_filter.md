...
> 출처(원문): https://docs.kernel.org/userspace-api/seccomp_filter.html
...
:   Results in the kernel sending a `SIGSYS` signal to the triggering
    ...
    `SIGSYS` triggered by seccomp will have a si\_code of `SYS_SECCOMP`.
...
like O\_CLOEXEC on the file descriptor in the notifying process. If the supervisor
