...
> 출처(원문): https://docs.kernel.org/userspace-api/accelerators/ocxl.html
...
host process. It is done through a ‘intrp\_req’ defined in the
...
[ABI file testing/sysfs-class-ocxl](../../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-class-ocxl)
