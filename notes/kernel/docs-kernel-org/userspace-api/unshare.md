...
> 출처(원문): https://docs.kernel.org/userspace-api/unshare.html
...
ERRORS
:   EPERM CLONE\_NEWNS was specified by a non-root process (process
...
> 1. Reorganization of existing copy\_\* functions
