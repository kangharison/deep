...
> 출처(원문): https://docs.kernel.org/userspace-api/dma-buf-alloc-exchange.html
...
the [EGL\_EXT\_image\_dma\_buf\_import\_modifiers](https://registry.khronos.org/EGL/extensions/EXT/EGL_EXT_image_dma_buf_import_modifiers.txt) extension entrypoints for EGL, the
[VK\_EXT\_image\_drm\_format\_modifier](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VK_EXT_image_drm_format_modifier.html) extension for Vulkan, and the
[zwp\_linux\_dmabuf\_v1](https://gitlab.freedesktop.org/wayland/wayland-protocols/-/blob/main/unstable/linux-dmabuf/linux-dmabuf-unstable-v1.xml) extension for Wayland.
