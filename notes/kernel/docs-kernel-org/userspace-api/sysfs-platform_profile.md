...
> 출처(원문): https://docs.kernel.org/userspace-api/sysfs-platform_profile.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# Platform Profile Selection (e.g. /sys/firmware/acpi/platform\_profile)
...
The purpose of the platform\_profile attribute is to offer a generic sysfs
...
gets a consistent experience the sysfs-platform\_profile ABI document defines
...
>    expected behaviour, to the sysfs-platform\_profile ABI documentation.

## “Custom” profile support

The platform\_profile class also supports profiles advertising a “custom”
...
Individual drivers will register a ‘platform\_profile’ class device that has
...
common profile from `platform_profile_choices` to the platform\_profile
