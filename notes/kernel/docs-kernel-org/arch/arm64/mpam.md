...
> 출처(원문): https://docs.kernel.org/arch/arm64/mpam.html
...
See [User Interface for Resource Control feature (resctrl)](../../filesystems/resctrl.html) for more details.
...
* Cache portion bitmap controls (CPOR) on the L2 or L3 caches. To expose
  ...
  placement.
* Memory bandwidth maximum controls (MBW\_MAX) on or after the L3 cache.
...
* Cache Storage Usage (CSU) counters can expose the ‘llc\_occupancy’ provided
...
dyndbg=”file mpam\_resctrl.c +pl”
