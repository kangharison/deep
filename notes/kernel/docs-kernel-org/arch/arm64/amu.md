...
> 출처(원문): https://docs.kernel.org/arch/arm64/amu.html
...
activity monitors extension. Therefore, when CONFIG\_ARM64\_AMU\_EXTN is
...
CONFIG\_ARM64\_AMU\_EXTN. To be noted that for security reasons, this does not
bypass the setting of AMUSERENR\_EL0 to trap accesses from EL0 (userspace) to
...
SYS\_AMEVCNTR1\_EL0(n), where n is a value between 0 and 15.
