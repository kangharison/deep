...
> 출처(원문): https://docs.kernel.org/arch/arm64/arm-acpi.html
...
MUST set the ACPI\_20\_TABLE\_GUID to point to the RSDP table (the table with
...
value for ACPI\_HANDLE, or checking .of\_node, or other information in
the device structure. This is detailed further in the “Driver
Recommendations” section.

In non-driver code, if the presence of ACPI needs to be detected at
run time, then check the value of acpi\_disabled. If CONFIG\_ACPI is not
set, acpi\_disabled will always be 1.
...
DO keep the MODULE\_DEVICE\_TABLE entries together in the driver to make it
...
:   This macro defines the string to be returned when
    ...
    The command line parameter acpi\_os=<string>
...
[ACPI Tables](acpi_object_usage.html).
