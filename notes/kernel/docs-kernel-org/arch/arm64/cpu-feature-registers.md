...
> 출처(원문): https://docs.kernel.org/arch/arm64/cpu-feature-registers.html
...
via the HWCAP\_CPUID in HWCAPs.
...
>
>    MIDR\_EL1 is exposed to help identify the processor. On a
...
>    the MIDR. Alternately, MIDR\_EL1, REVIDR\_EL1, and AIDR\_EL1 are exposed
>    via sysfs at:
>
>    ```
...
>    for the particular feature (except for MIDR\_EL1, see section 4).
...
>    | Revision | [3-0] | y |
>
> > NOTE: The ‘visible’ fields of MIDR\_EL1 will contain the value
...
>    | RPRES | [7-4] | y |
>    | WFXT | [3-0] | y |
> 10. MVFR0\_EL1 - AArch32 Media and VFP Feature Register 0
>
> > |  |  |  |
> > | --- | --- | --- |
> > | Name | bits | visible |
> > | FPDP | [11-8] | y |
>
> 11. MVFR1\_EL1 - AArch32 Media and VFP Feature Register 1
>
> > |  |  |  |
> > | --- | --- | --- |
> > | Name | bits | visible |
...
> > | SIMDLS | [11-8] | y |
>
> 12. ID\_ISAR5\_EL1 - AArch32 Instruction Set Attribute Register 5
>
> > |  |  |  |
> > | --- | --- | --- |
> > | Name | bits | visible |
