...
> 출처(원문): https://docs.kernel.org/arch/arm64/asymmetric-32bit.html
...
[ABI file testing/sysfs-devices-system-cpu](../../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-devices-system-cpu).
...
>    See [SCHED\_DEADLINE](#sched-deadline).
...
[execve(2)](#execve-2), in which case step (1) is skipped and a warning is
...
(2) of the process described in [execve(2)](#execve-2) and the cpuset hierarchy is
