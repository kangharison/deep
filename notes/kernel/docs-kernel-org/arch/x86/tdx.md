...
> 출처(원문): https://docs.kernel.org/arch/x86/tdx.html
...
to touch every driver. DMA buffers and [`ioremap()`](../../driver-api/device-io.html#c.ioremap "ioremap") do the conversions
automatically.
...
TDX guest uses TDCALL[TDG.MR.REPORT] to get the TDREPORT (TDREPORT\_STRUCT)
