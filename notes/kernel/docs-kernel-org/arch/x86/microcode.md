...
> 출처(원문): https://docs.kernel.org/arch/x86/microcode.html
...
MCG\_STATUS.MCIP. Since MCEs can be at most one in a system, if an
...
For instance, say MSR\_X is no longer available after an update,
...
the regular builtin firmware method CONFIG\_EXTRA\_FIRMWARE. Only 64-bit is
currently supported.
