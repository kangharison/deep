...
> 출처(원문): https://docs.kernel.org/arch/sparc/adi.html
...
ADI is enabled on a set of pages using `mprotect()` with PROT\_ADI flag.
...
ASI\_MCD\_PRIMARY or ASI\_MCD\_ST\_BLKINIT\_PRIMARY. ADI block size is
...
> |  |  |
> | --- | --- |
> | AT\_ADI\_BLKSZ | ADI block size. This is the granularity and alignment, in bytes, of ADI versioning. |
> | AT\_ADI\_NBITS | Number of ADI version bits in the VA |
