...
> 출처(원문): https://docs.kernel.org/arch/arm/kernel_mode_neon.html
...
relies on the GCC header <arm\_neon.h>, (which #includes <stdint.h>), you should
observe the following in addition to the rules above:

* Compile the unit containing the NEON intrinsics with ‘-ffreestanding’ so GCC
  uses its builtin version of <stdint.h> (this is a C99 header which the kernel
  does not supply);
* Include <arm\_neon.h> last, or at least after <linux/types.h>
