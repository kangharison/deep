...
> 출처(원문): https://docs.kernel.org/arch/arm/ixp4xx.html
...
1. A direct mapped window from 0x48000000 to 0x4bffffff (64MB).
   To access PCI via this space, we simply [`ioremap()`](../../driver-api/device-io.html#c.ioremap "ioremap") the BAR
...
you need more PCI memory, enable the IXP4XX\_INDIRECT\_PCI config option.
