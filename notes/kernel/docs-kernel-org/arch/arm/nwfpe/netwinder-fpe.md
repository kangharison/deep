...
> 출처(원문): https://docs.kernel.org/arch/arm/nwfpe/netwinder-fpe.html
...
is caused by a failure to alias fp\_current to the kernel variable
current\_set[0] correctly.
