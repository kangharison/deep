...
> 출처(원문): https://docs.kernel.org/arch/arm/microchip.html
...
Please refer to the [Devicetree (DT) ABI](../../devicetree/bindings/ABI.html) file for a
...
* Device Tree Source Include files (.dtsi) are used to collect common nodes that can be
  ...
  be placed at the end of the file name, separated with a “\_” (at91sam9x5\_can.dtsi
  or sama5d3\_gmac.dtsi for example).
* board Device Tree Source files (.dts) are prefixed by the string “at91-” so
  ...
  to this rule (sama5d3[13456]ek.dts, usb\_a9g20.dts or animeo\_ip.dts for example).
