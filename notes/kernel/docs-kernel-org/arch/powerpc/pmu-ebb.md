...
> 출처(원문): https://docs.kernel.org/arch/powerpc/pmu-ebb.html
...
using the Linux perf\_events API.
...
It is a feature of the perf\_events API that events can be created on other
...
existing “pinned” and “exclusive” attributes of perf\_events. This means EBB
...
perf\_events subsystem.

An EBB event must be created with the “pinned” and “exclusive” attributes set.
Note that if you are creating a group of EBB events, only the leader can have
these attributes set.

An EBB event must NOT set any of the “inherit”, “sample\_period”, “freq” or
“enable\_on\_exec” attributes.
...
perf\_events API. This can be achieved either via the ioctl() interface, or the
`prctl()` interface.

However, due to the design of the perf\_events API, enabling an event does not
