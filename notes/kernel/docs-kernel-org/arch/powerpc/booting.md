...
> 출처(원문): https://docs.kernel.org/arch/powerpc/booting.html
...
> > trampoline located in arch/powerpc/kernel/prom\_init.c to
...
> a) add your platform support as a \_boolean\_ option in
> arch/powerpc/Kconfig, following the example of PPC\_PSERIES
> and PPC\_PMAC. The latter is probably a good
> example of a board support to start from.
>
> b) create your main platform file as
> “arch/powerpc/platforms/myplatform/myboard\_setup.c” and add it
> to the Makefile under the condition of your `CONFIG_`
> option. This file will define a structure of type “ppc\_md”
