...
> 출처(원문): https://docs.kernel.org/arch/powerpc/imc.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# [IMC (In-Memory Collection Counters)](#id1)
...
To see per chip data for nest\_mcs0/PM\_MCS\_DOWN\_128B\_DATA\_XFER\_MC0/:
...
information. The CPMCxSEL and CPMC\_LOAD in the trace SCOM, specifies the event
...
### [TRACE\_IMC\_SCOM bit representation](#id6)
...
CPMC\_LOAD contains the sampling duration. SAMPSEL and CPMCxSEL determines the
...
memory and reloads the CMPC\_LOAD value for the next sampling duration. IMC
...
## [Benefits of using IMC trace-mode](#id8)
...
That is, the PMI interrupt counts do not increment when using the trace\_imc event.
