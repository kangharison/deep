...
> 출처(원문): https://docs.kernel.org/arch/powerpc/htm.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# [HTM (Hardware Trace Macro)](#id1)

Athira Rajeev, 2 Mar 2025

## [Basic overview](#id2)

H\_HTM is used as an interface for executing Hardware Trace Macro (HTM)
...
be controlled using the H\_HTM hcall. The hcall can be invoked for any core/chip
...
## [Benefits of using HTM debugfs interface](#id5)
