...
> 출처(원문): https://docs.kernel.org/arch/sh/new-machine.html
...
It should be noted that CPU subtypes are \_not\_ abstracted. Thus, these still
...
>   example vapor\_inb. These will be needed when filling out the machine
>   vector.
>
>   Note that these prototypes are generated automatically by setting
>   \_\_IO\_PREFIX to something sensible. A typical example would be:
>
>   ```
...
(assume arch/sh/configs/vapor\_defconfig), you can also use this directly as a
...
> | adx\_defconfig | Build for adx |
> | cqreek\_defconfig | Build for cqreek |
> | dreamcast\_defconfig | Build for dreamcast |
> | ... |  |
> | vapor\_defconfig | Build for vapor |
