...
> 출처(원문): https://docs.kernel.org/arch/s390/zfcpdump.html
...
To build a dump enabled kernel the kernel config option CONFIG\_CRASH\_DUMP
has to be set.

To get a valid zfcpdump kernel configuration use “make zfcpdump\_defconfig”.
