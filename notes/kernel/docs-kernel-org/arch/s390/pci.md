...
> 출처(원문): https://docs.kernel.org/arch/s390/pci.html
...
> * /sys/kernel/debug/s390dbf/pci\_\*/

For example:

> * /sys/kernel/debug/s390dbf/pci\_msg/sprintf
>
>   holds messages from the processing of PCI events, like machine check handling
>   and setting of global functionality, like UID checking.
>
> Change the level of logging to be more or less verbose by piping
> a number between 0 and 6 to /sys/kernel/debug/s390dbf/pci\_\*/level. For
> details, see the documentation on the S/390 debug feature at
> [S390 Debug Feature](s390dbf.html).
...
* /sys/bus/pci/slots/XXXXXXXX:
  ...
  echo 0 > /sys/bus/pci/devices/DDDD:BB:dd.f/sriov\_numvf
* /sys/bus/pci/devices/DDDD:BB:dd.f/:
  ...
  + fidparm:
    ...
    promiscuous mode.
* /sys/firmware/clp/uid\_checking:

  In addition to the per-device uid\_is\_unique attribute this presents a
