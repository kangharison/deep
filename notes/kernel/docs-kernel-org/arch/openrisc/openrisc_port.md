...
> 출처(원문): https://docs.kernel.org/arch/openrisc/openrisc_port.html
...
For more information on this, please check [Ramfs, rootfs and initramfs](../../filesystems/ramfs-rootfs-initramfs.html).
