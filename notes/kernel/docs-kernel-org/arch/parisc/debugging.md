...
> 출처(원문): https://docs.kernel.org/arch/parisc/debugging.html
...
address you can lookup in System.map, add \_\_PAGE\_OFFSET (0x10000000
currently).
...
than \_\_PAGE\_OFFSET (0x10000000) which mean a virtual address didn’t
