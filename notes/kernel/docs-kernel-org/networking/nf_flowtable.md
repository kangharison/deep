...
> 출처(원문): https://docs.kernel.org/networking/nf_flowtable.html
...
You can identify hardware offloaded flows through the [HW\_OFFLOAD] tag when
...
which refers to the software flowtable fastpath and [HW\_OFFLOAD] which refers
...
This documentation is based on the LWN.net articles [[1]](#id5)[[2]](#id6). Rafal Milecki
also made a very complete and comprehensive summary called “A state of network
acceleration” that describes how things were before this infrastructure was
mainlined [[3]](#id7) and it also makes a rough summary of this work [[4]](#id8).
