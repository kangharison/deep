...
> 출처(원문): https://docs.kernel.org/networking/psp.html
...
| --- | --- | --- | --- | --- |
| Rx plain (data) | accept | accept | drop | drop |
| Rx plain (ACK|FIN|RST) | accept | accept | accept | drop |
| Rx PSP (good) | drop | accept | accept | accept |
| Rx PSP (bad crypt, !=SPI) | drop | drop | drop | drop |
| Tx | plain text | plain text | encrypted (excl. rtx) | encrypted (excl. rtx) |
