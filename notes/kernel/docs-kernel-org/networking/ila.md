...
> 출처(원문): https://docs.kernel.org/networking/ila.html
...
and the other is ila\_xlat (called from NFHOOK PREROUTING hook). ila\_xlat
...
The usage of ila\_xlat is:

ip ila add loc\_match MATCH loc LOC csum-mode MODE ident-type TYPE
