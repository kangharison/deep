...
> 출처(원문): https://docs.kernel.org/networking/nexthop-group-resilient.html
...
> | `NHA_RES_GROUP_IDLE_TIMER` | Idle timer in units of clock\_t. |
> | `NHA_RES_GROUP_UNBALANCED_TIMER` | Unbalanced timer in units of clock\_t. |
...
> |  |  |
> | --- | --- |
> | `NHA_RES_GROUP_UNBALANCED_TIME` | How long has the resilient group been out of balance, in units of clock\_t. |
