...
> 출처(원문): https://docs.kernel.org/networking/vrf.html
...
and out of the VRF as a whole[[1]](#id3). Similarly, netfilter[[2]](#id4) and tc rules
...
4. Enslave L3 interfaces to a VRF device:
   ...
   The IPv6 sysctl option keep\_addr\_on\_down can be enabled to keep IPv6 global
...
or to specify the output device using cmsg and IP\_PKTINFO.
...
tcp\_l3mdev\_accept and udp\_l3mdev\_accept sysctl options:
...
This is so as to specify the output device with cmsg and IP\_PKTINFO, but
