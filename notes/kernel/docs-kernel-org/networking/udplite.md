...
> 출처(원문): https://docs.kernel.org/networking/udplite.html
...
>
> > * Sender checksum coverage: UDPLITE\_SEND\_CSCOV
> >
> >   For example:
> >
> >   ```
...
> >   base header.
> > * Receiver checksum coverage: UDPLITE\_RECV\_CSCOV
> >
...
> >   all packets which have a coverage \_less\_ than this value. For example, if
...
> same manner as before, e.g. UDP\_CORK or UDP\_ENCAP.
>
...
> messages use the KERN\_DEBUG level (7).
>
...
> and cannot be disabled using SO\_NO\_CHECK. Thus:
>
> ```
...
> minimum size of the send buffer is 2048 (defined as SOCK\_MIN\_SNDBUF
> in include/net/sock.h), the default value is configurable as
> net.core.wmem\_default or via setting the SO\_SNDBUF socket(7)
> option. The maximum upper bound for the send buffer is determined
> by net.core.wmem\_max.
>
...
> Exceptional and error conditions are logged to syslog at the KERN\_DEBUG
