...
> 출처(원문): https://docs.kernel.org/networking/regulatory.html
...
set they can inform the wireless core using [`regulatory_hint()`](../driver-api/80211/cfg80211.html#c.regulatory_hint "regulatory_hint").
...
registering on its [`struct wiphy`](../driver-api/80211/cfg80211.html#c.wiphy "wiphy") a `reg_notifier()` callback. This notifier
...
[`kmalloc()`](../core-api/mm-api.html#c.kmalloc "kmalloc") a structure big enough to hold your regulatory domain
structure and you should then fill it with your data. Finally you simply
call [`regulatory_hint()`](../driver-api/80211/cfg80211.html#c.regulatory_hint "regulatory_hint") with the regulatory domain structure in it.
