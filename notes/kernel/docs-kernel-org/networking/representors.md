...
> 출처(원문): https://docs.kernel.org/networking/representors.html
...
[Documentation/networking/switchdev.rst](switchdev.html#switchdev).
...
>   if) their network access is implemented through a virtual switch port. [[1]](#id2)
...
[Documentation/networking/devlink/devlink-port.rst](devlink/devlink-port.html#devlink-port) for the
details of this API.
...
>   [Documentation/networking/devlink/devlink-port.rst](devlink/devlink-port.html#devlink-port))
