...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/cellular/qualcomm/rmnet.html
...
Checksum length is the Length in bytes starting from CKSUM\_START\_OFFSET,
...
The driver uses rtnl\_link\_ops for communication.
