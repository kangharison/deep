...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/intel/iavf.html
...
(PF) driver compiled with CONFIG\_PCI\_IOV. The iavf driver requires
CONFIG\_PCI\_MSI to be enabled.
...
* The sch\_mqprio, act\_mirred and cls\_flower modules must be loaded
...
The shaper bw\_rlimit parameter is optional.
...
shaper bw\_rlimit: for each tc, sets minimum and maximum bandwidth rates.
Totals must be equal or less than port speed.

For example: min\_rate 1Gbit 3Gbit: Verify bandwidth limit using network
