...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/intel/ixgbe.html
...
max\_vfs worth of virtual functions.
...
With kernel 3.6, the driver supports the simultaneous usage of max\_vfs and DCB
features, subject to the constraints described below. Prior to kernel 3.6, the
driver did not support the simultaneous operation of max\_vfs greater than 0 and
