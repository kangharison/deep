...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/intel/igb.html
...
max\_vfs worth of virtual functions. If the value is greater than 0 it will
...
* For SLES: /etc/sysconfig/network/<config\_file>
