...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/intel/i40e.html
...
Packets that match the ATR rules are counted in fdir\_atr\_match stats in
...
“add vsi failed for VF N, aq\_err 16”. To workaround the issue, enable less than
...
1. Disable XPS on both ends by using the included virt\_perf\_default script
...
and using the included set\_irq\_affinity script. Please see the script’s help
