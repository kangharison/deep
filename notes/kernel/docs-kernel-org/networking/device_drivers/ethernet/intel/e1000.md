...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/intel/e1000.html
...
:   When e1000 is loaded with default settings and multiple adapters
    ...
    RX\_POLLING (NAPI) and default driver settings.
...
:   Degradation in throughput performance may be observed in some Jumbo frames
    ...
    size and/or increasing the /proc/sys/net/ipv4/tcp\_\*mem entry values may help.
