...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/intel/idpf.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# [idpf Linux\* Base Driver for the Intel(R) Infrastructure Data Path Function](#id1)
...
## [Identifying Your Adapter](#id2)

For information on how to identify your adapter, and for the latest Intel
network drivers, refer to the Intel Support website:
<http://www.intel.com/support>

## [Additional Features and Configurations](#id3)
...
## [Performance Optimization](#id7)

Driver defaults are meant to fit a wide variety of workloads, but if further
optimization is required, we recommend experimenting with the following
settings.

### [Interrupt Rate Limiting](#id8)
...
>   device’s local\_cpulist: /sys/class/net/<ethX>/device/local\_cpulist.
