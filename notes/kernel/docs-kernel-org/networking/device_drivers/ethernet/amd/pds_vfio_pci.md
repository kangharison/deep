...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/amd/pds_vfio_pci.html
...
example assumes the pds\_core and pds-vfio-pci modules are already
loaded.
...
After performing the steps above, a file in /dev/vfio/<iommu\_group>
