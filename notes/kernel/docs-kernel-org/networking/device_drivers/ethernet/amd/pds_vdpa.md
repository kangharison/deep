...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/amd/pds_vdpa.html
...
in the `pds_core` device to create the auxiliary devices used by pds\_vdpa.
...
>         :   -> Pensando devices
>             :   -> Pensando Ethernet PDS\_VDPA Support
