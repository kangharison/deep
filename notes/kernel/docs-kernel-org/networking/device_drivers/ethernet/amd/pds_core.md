...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/amd/pds_core.html
...
If such devices are listed as above, then the pds\_core.ko driver should find
...
| `enable_vnet` | runtime | Boolean | Enables vDPA functionality through an auxiliary\_bus device |
...
>         :   -> AMD devices
>             :   -> AMD/Pensando Ethernet PDS\_CORE Support
