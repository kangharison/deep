...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/microsoft/netvsc.html
...
>
> hv\_netvsc supports XDP in native mode, and transparently sets the XDP
...
> ```
>
> XDP\_REDIRECT action is not yet supported.
