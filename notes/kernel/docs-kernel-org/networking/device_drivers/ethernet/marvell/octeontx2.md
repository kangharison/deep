...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/marvell/octeontx2.html
...
* [Overview](#overview)
* [Drivers](#drivers)
* [Basic packet flow](#basic-packet-flow)
* [Devlink health reporters](#devlink-health-reporters)
* [Quality of service](#quality-of-service)
* [RVU representors](#rvu-representors)
...
2. ERROR events
   ...
   * Fault due to NPA\_AQ\_INST\_S read or NPA\_AQ\_RES\_S write.
   * AQ Doorbell Error.
3. RAS events

   * RAS Error Reporting for NPA\_AQ\_INST\_S/NPA\_AQ\_RES\_S.
4. RVU events
...
2. ERROR events
   ...
   * Fault due to NIX\_AQ\_INST\_S read or NIX\_AQ\_RES\_S write.
   * AQ Doorbell Error.
3. RAS events
   ...
   * RAS Error Reporting for NIX\_AQ\_INST\_S/NIX\_AQ\_RES\_S.
4. RVU events
...
(see [Documentation/networking/devlink/devlink-port.rst](../../../devlink/devlink-port.html#devlink-port)) interface.
