...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/mellanox/mlx5/tracepoints.html
...
kernel tracepoints interfaces (refer to [ftrace - Function Tracer](../../../../../trace/ftrace.html)).

For the list of support mlx5 events, check /sys/kernel/tracing/events/mlx5/.

tc and eswitch offloads tracepoints:

* mlx5e\_configure\_flower: trace flower filter actions and cookies offloaded to mlx5:
  ...
  ```
* mlx5e\_delete\_flower: trace flower filter actions and cookies deleted from mlx5:
  ...
  ```
* mlx5e\_stats\_flower: trace flower stats request:
  ...
  ```
* mlx5e\_tc\_update\_neigh\_used\_value: trace tunnel rule neigh update value offloaded to mlx5:
  ...
  ```
* mlx5e\_rep\_neigh\_update: trace neigh update tasks scheduled due to neigh state change events:
...
* mlx5\_esw\_bridge\_fdb\_entry\_init: trace bridge FDB entry offloaded to mlx5:
  ...
  ```
* mlx5\_esw\_bridge\_fdb\_entry\_cleanup: trace bridge FDB entry deleted from mlx5:
  ...
  ```
* mlx5\_esw\_bridge\_fdb\_entry\_refresh: trace bridge FDB entry offload refreshed in
  mlx5:
  ...
  ```
* mlx5\_esw\_bridge\_vlan\_create: trace bridge VLAN object add on mlx5
  representor:
  ...
  ```
* mlx5\_esw\_bridge\_vlan\_cleanup: trace bridge VLAN object delete from mlx5
  representor:
  ...
  ```
* mlx5\_esw\_bridge\_vport\_init: trace mlx5 vport assigned with bridge upper
  device:
  ...
  ```
* mlx5\_esw\_bridge\_vport\_cleanup: trace mlx5 vport removed from bridge upper
  device:
...
* mlx5\_esw\_vport\_qos\_create: trace creation of transmit scheduler arbiter for vport:
  ...
  ```
* mlx5\_esw\_vport\_qos\_config: trace configuration of transmit scheduler arbiter for vport:
  ...
  ```
* mlx5\_esw\_vport\_qos\_destroy: trace deletion of transmit scheduler arbiter for vport:
  ...
  ```
* mlx5\_esw\_group\_qos\_create: trace creation of transmit scheduler arbiter for rate group:
  ...
  ```
* mlx5\_esw\_group\_qos\_config: trace configuration of transmit scheduler arbiter for rate group:
  ...
  ```
* mlx5\_esw\_group\_qos\_destroy: trace deletion of transmit scheduler arbiter for group:
...
* mlx5\_sf\_add: trace addition of the SF port:
  ...
  ```
* mlx5\_sf\_free: trace freeing of the SF port:
  ...
  ```
* mlx5\_sf\_activate: trace activation of the SF port:
  ...
  ```
* mlx5\_sf\_deactivate: trace deactivation of the SF port:
  ...
  ```
* mlx5\_sf\_hwc\_alloc: trace allocating of the hardware SF context:
  ...
  ```
* mlx5\_sf\_hwc\_free: trace freeing of the hardware SF context:
  ...
  ```
* mlx5\_sf\_hwc\_deferred\_free: trace deferred freeing of the hardware SF context:
  ...
  ```
* mlx5\_sf\_update\_state: trace state updates for SF contexts:
  ...
  ```
* mlx5\_sf\_vhca\_event: trace SF vhca event and state:
  ...
  ```
* mlx5\_sf\_dev\_add: trace SF device add event:
  ...
  ```
* mlx5\_sf\_dev\_del: trace SF device delete event:
