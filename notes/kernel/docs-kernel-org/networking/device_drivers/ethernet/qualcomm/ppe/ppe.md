...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/qualcomm/ppe/ppe.html
...
Author: Lei Wei <[quic\_leiwei@quicinc.com](mailto:quic_leiwei%40quicinc.com)>

## Contents

* [PPE Overview](#ppe-overview)
* [PPE Driver Overview](#ppe-driver-overview)
* [PPE Driver Supported SoCs](#ppe-driver-supported-socs)
...
blocks are provided in the ppe\_config.c file.

The ppe.h defines the PPE device data structure which will be used by PPE driver functions.

The ppe\_debugfs.c enables the PPE statistics counters such as PPE port Rx and Tx counters,
