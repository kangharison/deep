...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/cirrus/cs89x0.html
...
8. Many Linux distributions use the ‘modprobe’ command to load
   ...
   are asking ‘modprobe’ to pass the ‘io’, ‘dma’ and ‘use\_dma’
...
14. If the cs89x0 driver is compiled directly into the kernel, DMA
    ...
    ‘cs89x0\_dma=N’ where ‘N’ is the desired DMA channel number (5, 6 or 7).
...
enabled by the ‘use\_dma=1’ module option.
