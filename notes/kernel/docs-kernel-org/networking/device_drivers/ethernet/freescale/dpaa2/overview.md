...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/freescale/dpaa2/overview.html
...
* registering a new bus type named “fsl-mc” with the kernel,
  and implementing bus call-backs (e.g. match/uevent/dev\_groups)
...
*[ABI file testing/sysfs-bus-fsl-mc](../../../../../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-bus-fsl-mc)*.
