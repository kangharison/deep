...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/freescale/dpaa2/switch-driver.html
...
>   (DPSW\_OPT\_CTRL\_IF\_DIS not passed as a create time option). Without the
...
‘’vlan\_id’’ key will be accepted. Mirroring based on any other fields from the
