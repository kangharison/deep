...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/freescale/dpaa2/ethernet-driver.html
...
abstractions see
*[DPAA2 (Data Path Acceleration Architecture Gen2) Overview](overview.html)*.
