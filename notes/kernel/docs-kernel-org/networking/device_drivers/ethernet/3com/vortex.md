...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/ethernet/3com/vortex.html
...
3c575-series Cardbus cards which used to be handled by 3c575\_cb.c.
...
>
> The value of rx\_copybreak is used to decide when to make the copy.
> If the packet size is less than rx\_copybreak, the packet is copied.
> The default value for rx\_copybreak is 200 bytes.

max\_interrupt\_work=N

> The driver’s interrupt service routine can handle many receive and
> transmit packets in a single invocation. It does this in a loop.
> The value of max\_interrupt\_work governs how many times the interrupt
> service routine will loop. The default value is 32 loops. If this
> is exceeded the interrupt service routine gives up and generates a
> warning message “eth0: Too much work in interrupt”.

hw\_checksums=N1,N2,N3,...
...
global\_enable\_wol=N

> Sets enable\_wol mode for all 3c59x NICs in the machine. Entries in
...
Later (current) versions of the driver \_do\_ support locking of the
...
>
> On a side note, adding HAS\_NWAY seems to share a problem with the
