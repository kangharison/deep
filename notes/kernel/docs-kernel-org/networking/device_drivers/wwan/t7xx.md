...
> 출처(원문): https://docs.kernel.org/networking/device_drivers/wwan/t7xx.html
...
::
:   $ cat /sys/bus/pci/devices/${bdf}/t7xx\_mode

Write from userspace to set the device mode.

::
:   $ echo fastboot\_switching > /sys/bus/pci/devices/${bdf}/t7xx\_mode
...
::
:   $ cat /sys/bus/pci/devices/${bdf}/t7xx\_debug\_ports

Write from userspace to set the debug ports status.

::
:   $ echo 1 > /sys/bus/pci/devices/${bdf}/t7xx\_debug\_ports
