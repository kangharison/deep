...
> 출처(원문): https://docs.kernel.org/networking/dsa/b53.html
...
configuration described in the [Configuration showcases](configuration.html#dsa-config-showcases).
...
See [Configuration with tagging support](configuration.html#dsa-tagged-configuration).
...
The configuration slightly differ from the [Configuration without tagging support](configuration.html#dsa-vlan-configuration).
...
In difference to the configuration described in [Configuration without tagging support](configuration.html#dsa-vlan-configuration)
