...
> 출처(원문): https://docs.kernel.org/networking/xfrm/xfrm_proc.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# XFRM proc - /proc/net/xfrm\_\* files

Masahide NAKAMURA <[nakam@linux-ipv6.org](mailto:nakam%40linux-ipv6.org)>

## Transformation Statistics

The xfrm\_proc code is a set of statistics showing numbers of packets
