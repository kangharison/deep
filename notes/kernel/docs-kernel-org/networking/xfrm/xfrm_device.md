...
> 출처(원문): https://docs.kernel.org/networking/xfrm/xfrm_device.html
...
stack’s XFRM subsystem. Additionally, the feature bits NETIF\_F\_HW\_ESP and
NETIF\_F\_HW\_ESP\_TX\_CSUM will signal the availability of the offload.

## Flow

At probe time and before the call to [`register_netdev()`](../kapi.html#c.register_netdev "register_netdev"), the driver should
set up local data structures and XFRM callbacks, and set the feature bits.
The XFRM code’s listener will finish the setup on NETDEV\_REGISTER.
...
The driver can also set an offload\_handle in the SA, an opaque void pointer
...
`xfrm_replay_advance_esn()` for RX, and xfrm\_replay\_overflow\_offload\_esn for TX.
