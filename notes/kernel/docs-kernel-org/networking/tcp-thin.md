...
> 출처(원문): https://docs.kernel.org/networking/tcp-thin.html
...
TCP\_THIN\_LINEAR\_TIMEOUTS and TCP\_THIN\_DUPACK IOCTLS or the
tcp\_thin\_linear\_timeouts and tcp\_thin\_dupack sysctls. Both
