...
> 출처(원문): https://docs.kernel.org/networking/msg_zerocopy.html
...
such as sendfile and splice. The MSG\_ZEROCOPY flag extends the
...
specific, IP\_RECVERR or IPV6\_RECVERR (for TCP or UDP socket).
For VSOCK socket, cmsg\_level will be SOL\_VSOCK and cmsg\_type will be
VSOCK\_RECVERR.
...
tools/testing/vsock/vsock\_test\_zerocopy.c.
