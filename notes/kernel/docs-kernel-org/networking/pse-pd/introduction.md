...
> 출처(원문): https://docs.kernel.org/networking/pse-pd/introduction.html
...
* For general PSE (PoE) code, use “c33\_pse” key words. For example:
  `enum ethtool_c33_pse_admin_state c33_admin_control;`.
  This aligns with Clause 33, encompassing various PoE forms.
* For PoDL PSE - specific code, use “podl\_pse”. For example:
