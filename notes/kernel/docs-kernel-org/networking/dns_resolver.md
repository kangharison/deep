...
> 출처(원문): https://docs.kernel.org/networking/dns_resolver.html
...
by way of requesting a key of key type dns\_resolver. These queries are
...
> * Implements the dns\_resolver key\_type to contact userspace.
...
This can be cleared by any process that has the CAP\_SYS\_ADMIN capability by
the use of KEYCTL\_KEYRING\_CLEAR on the keyring ID.

## Reading DNS Keys from Userspace

Keys of dns\_resolver type can be read from userspace using `keyctl_read()` or
“keyctl read/print/pipe”.

## Mechanism

The dns\_resolver module registers a key type called “dns\_resolver”. Keys of
...
See [Key Request Service](../security/keys/request-key.html) for further information about
