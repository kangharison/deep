...
> 출처(원문): https://docs.kernel.org/networking/arcnet.html
...
Author:
:   Avery Pennarun <[apenwarr@worldvisions.ca](mailto:apenwarr%40worldvisions.ca)>

Note

See also [ARCnet Hardware](arcnet-hardware.html) in this directory for jumper-setting
...
[netdev@vger.kernel.org](mailto:netdev%40vger.kernel.org) and make sure to Cc: maintainer listed in
“ARCNET NETWORK LAYER” heading of [List of maintainers](../process/maintainers.html).
...
These are COM90xx chips which are \_completely\_ memory mapped. The support for
...
> |  |  |
> | --- | --- |
> | arc0 | RFC1201 protocol, the official Internet standard which just happens to be 100% compatible with Novell’s TRXNET driver. Version 1.00 of the ARCnet driver supported \_only\_ this protocol. arc0 is the fastest of the three protocols (for whatever reason), and allows larger packets to be used because it supports RFC1201 “packet splitting” operations. Unless you have a specific need to use a different protocol, I strongly suggest that you stick with this one. |
...
Send mail following [Where do I discuss these drivers?](#arcnet-netdev). Describe your setup, preferably
...
D\_DURING or more, it would be a REALLY good idea to kill your klogd daemon
first! D\_DURING displays 4-5 lines for each packet sent or received. D\_TX,
D\_RX, and D\_SKB actually DISPLAY each packet as it is sent or received,
...
found unless you turn on the D\_INIT\_REASONS debugging flag.
...
If your debug level includes D\_DURING and you did NOT define SLOW\_XMIT\_COPY,
...
D\_NORMAL+D\_EXTRA+D\_INIT. To include D\_DURING, you would add 16 to this,
