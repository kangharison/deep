...
> 출처(원문): https://docs.kernel.org/usb/usb-serial.html
...
> properly enumerated, assigned a port, and then communication \_should\_ be
...
> >       Get\_Status, Set\_Feature, O\_NONBLOCK, select()
>
...
> > > * Stop bits 1-2
> > > * Parity N,E,O,M,S
> > > * Handshake None, Software (XON/XOFF), Hardware (CTSRTS,CTSDTR) [[1]](#id3)
> > > * Break Set and clear
> > > * Line control Input/Output query and control [[2]](#id4)
>
> [[1](#id1)]
>
...
>       with this driver with a simple addition to the usb\_device\_id table. I
