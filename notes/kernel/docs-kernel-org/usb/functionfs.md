...
> 출처(원문): https://docs.kernel.org/usb/functionfs.html
...
may not be in init section (ie. may not use the \_\_init tag).
...
For more information about FunctionFS descriptors see [FunctionFS Descriptors](functionfs-desc.html)
...
On kernel level the gadget checks ffs\_data->dev\_name to identify
