...
> 출처(원문): https://docs.kernel.org/usb/gadget_printer.html
...
/dev/g\_printer . Both blocking and non-blocking read/write calls are supported.
...
(ex: modprobe g\_printer idVendor=0x0525 idProduct=0xa4a8 ):
...
1. save it to a file called prn\_example.c
