...
> 출처(원문): https://docs.kernel.org/usb/misc_usbsevseg.html
...
USB VENDOR\_ID 0x0fc5
USB PRODUCT\_ID 0x1227
Both the 6 character and 8 character displays have PRODUCT\_ID,
...
2. Set the device’s mode:
   echo $mode\_msb > /sys/bus/usb/.../mode\_msb
   echo $mode\_lsb > /sys/bus/usb/.../mode\_lsb
3. Set the textmode:
