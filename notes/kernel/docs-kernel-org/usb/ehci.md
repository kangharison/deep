...
> 출처(원문): https://docs.kernel.org/usb/ehci.html
...
but they may want to check for “usb\_device->speed == USB\_SPEED\_HIGH”.
...
In the Linux 2.5 kernels, new usb\_sg\_\*() api calls have been defined; they
...
:   More than standard 80% periodic bandwidth allocation is possible
    through sysfs uframe\_periodic\_max parameter. Describe that.
