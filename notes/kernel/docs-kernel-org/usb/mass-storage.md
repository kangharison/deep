...
> 출처(원문): https://docs.kernel.org/usb/mass-storage.html
...
>   FSG\_MAX\_LUNS (8) LUNs set. If more files are specified, they will
...
>   have. It is limited by FSG\_MAX\_LUNS (8) and higher value will be
>   capped.
>
...
> read from /sys/module/g\_mass\_storage/parameters/\* files.

## Other gadgets using mass storage function

> The Mass Storage Gadget uses the Mass Storage Function to handle
> mass storage protocol. As a composite function, MSF may be used by
> other gadgets as well (eg. g\_multi and acm\_ms).
>
...
> may take a look at mass\_storage.c, acm\_ms.c and multi.c (sorted by
> complexity).
