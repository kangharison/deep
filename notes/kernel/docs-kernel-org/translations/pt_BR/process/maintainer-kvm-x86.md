...
> 출처(원문): https://docs.kernel.org/translations/pt_BR/process/maintainer-kvm-x86.html
...
dos mantenedores da árvore “tip” ([Coding style notes](../../../process/maintainer-tip.html#maintainer-tip-coding-style)), já que
...
Veja [The canonical patch format](../../../process/submitting-patches.html#the-canonical-patch-format) para mais informações, com uma ressalva:
...
Veja [Describe your changes](../../../process/submitting-patches.html#describe-changes) para mais informações, com uma ressalva: comece com
...
patches que visam primariamente o código de arch/x86 que \_NÃO\_ seja código KVM.
...
explicitamente o patch com “Cc: [stable@vger.kernel.org](mailto:stable%40vger.kernel.org)” (embora o e-mail em si
...
KVM\_INTEL=m, KVM\_AMD=m e KVM\_WERROR=y. Compilar cada combinação possível de
Kconfigs não é viável, mas quanto mais, melhor. KVM\_SMM, KVM\_XEN, PROVE\_LOCKING
e X86\_64 são opções (knobs) particularmente interessantes para se testar.
...
para um recurso via KVM\_GET\_SUPPORTED\_CPUID, ou seja, para instruções/recursos
...
[Security bugs](../../../process/security-bugs.html#securitybugs) se você suspeitar que um bug possa levar a um escape,
