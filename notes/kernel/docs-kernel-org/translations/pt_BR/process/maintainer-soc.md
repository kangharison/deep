...
> 출처(원문): https://docs.kernel.org/translations/pt_BR/process/maintainer-soc.html
...
### 2.2.1. Submetendo Patches para um Determinado SoC
...
### 2.2.2. Submetendo Patches para os Mantenedores Principais de SoC

Os mantenedores principais de SoC podem ser contatados via o alias
[soc@kernel.org](mailto:soc%40kernel.org) apenas nos seguintes casos:
...
3. Introdução de uma plataforma SoC completamente nova. Tal trabalho de novo SoC
   ...
   positiva da comunidade, o trabalho deve ser enviado para [soc@kernel.org](mailto:soc%40kernel.org) em
...
Note que o endereço [soc@kernel.org](mailto:soc%40kernel.org) geralmente não é o local para discutir os
patches; portanto, o trabalho enviado para este endereço já deve ser
considerado aceitável pela comunidade.

## 2.3. Informações para (novos) Submantenedores
...
### 2.3.1. Estabilidade da ABI do Devicetree
...
### 2.3.2. Dependências de Branch de Driver
...
### 2.3.3. Convenção de Nomenclatura de Devicetree
...
### 2.3.4. Validando Arquivos de Devicetree
...
### 2.3.5. Branches e Pull Requests
...
para [soc@kernel.org](mailto:soc%40kernel.org), agrupados nas mesmas categorias.
