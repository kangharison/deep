...
> 출처(원문): https://docs.kernel.org/translations/pt_BR/process/howto.html
...
do kernel Linux e como usar os identificadores [SPDX](https://spdx.org/) no
código-fonte estão descritas em [Documentation/process/license-rules.rst](../../../process/license-rules.html#kernel-licensing).
...
o mantenedor das páginas de manual em [alx@kernel.org](mailto:alx%40kernel.org), e coloque em cópia (CC)
a lista [linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org).

Aqui está uma lista de arquivos que estão na árvore de fontes do kernel e
que são de leitura obrigatória:

> [Documentation/admin-guide/README.rst](../../../admin-guide/README.html#readme)
...
>
> [Requisitos mínimos para compilar o Kernel](changes.html)
...
>
> [Documentation/process/stable-api-nonsense.rst](../../../process/stable-api-nonsense.html#stable-api-nonsense)
...
>
> [Documentation/process/security-bugs.rst](../../../process/security-bugs.html#securitybugs)
...
>
> [Documentation/process/management-style.rst](../../../process/management-style.html#managementstyle)
...
>     do kernel.
>
> [Documentation/process/stable-kernel-rules.rst](../../../process/stable-kernel-rules.html#stable-kernel-rules)
...
>
> [Documentation/process/kernel-docs.rst](../../../process/kernel-docs.html#kernel-docs)
...
>
> [Documentation/process/applying-patches.rst](../../../process/applying-patches.html#applying-patches)
...
<[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)> e são lançadas conforme a necessidade exigir.
...
O arquivo [Documentation/process/stable-kernel-rules.rst](../../../process/stable-kernel-rules.html#stable-kernel-rules)
...
O arquivo ‘[Reporting issues](../../../admin-guide/reporting-issues.html)’ no diretório
...
Mantenedor: Greg Kroah-Hartman <[greg@kroah.com](mailto:greg%40kroah.com)>
