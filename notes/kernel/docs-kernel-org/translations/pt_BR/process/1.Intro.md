...
> 출처(원문): https://docs.kernel.org/translations/pt_BR/process/1.Intro.html
...
[How the development process works](../../../process/2.Process.html#development-process) apresenta o processo de desenvolvimento, o ciclo de
...
[Early-stage planning](../../../process/3.Early-stage.html#development-early-stage) cobre os primeiros passos do processo de
desenvolvimento, com ênfase no envolvimento da comunidade de desenvolvedores o
mais cedo possível.

[Getting the code right](../../../process/4.Coding.html#development-coding) é sobre o processo de codificação; muitas armadilhas
...
[Posting patches](../../../process/5.Posting.html#development-posting) fala sobre o processo de envio de patches para
...
[Followthrough](../../../process/6.Followthrough.html#development-followthrough) cobre o que acontece após o envio dos patches;
...
[Advanced topics](../../../process/7.AdvancedTopics.html#development-advancedtopics) introduz dois tópicos mais “avançados”:
gerenciamento de patches com git e revisão de patches por outros.

[For more information](../../../process/8.Conclusion.html#development-conclusion) conclui o documento com indicações de fontes com
...
Esse documento foi escrito por Jonathan Corbet, [corbet@lwn.net](mailto:corbet%40lwn.net). Aprimorado
