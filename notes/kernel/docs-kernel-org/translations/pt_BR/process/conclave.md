...
> 출처(원문): https://docs.kernel.org/translations/pt_BR/process/conclave.html
...
* Em até duas semanas, um representante deste grupo comunicará à comunidade em
  geral, utilizando a lista de discussão [ksummit@lists.linux.dev](mailto:ksummit%40lists.linux.dev), quais serão os
  próximos passos.
