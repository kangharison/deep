...
> 출처(원문): https://docs.kernel.org/translations/pt_BR/index.html
...
mantenedor:
:   Daniel Pereira <[danielmaraboo@gmail.com](mailto:danielmaraboo%40gmail.com)>
...
*única* documentação oficial é a em língua inglesa: [The Linux Kernel documentation](../../index.html#linux-doc)

A propagação simultânea de uma alteração em [The Linux Kernel documentation](../../index.html#linux-doc) para todas as
...
* [Introdução](process/1.Intro.html)
* [Como começar](process/howto.html)
* [Requisitos mínimos](process/changes.html)
* [Conclave (Continuidade do projeto)](process/conclave.html)
* [Manuais dos mantenedores](process/maintainer-handbooks.html)
* [1. Processo do subsistema de rede (netdev)](process/maintainer-netdev.html)
* [2. Processo do subsistema SoC](process/maintainer-soc.html)
* [3. Conformidade de DTS para SoC](process/maintainer-soc-clean-dts.html)
* [Processo do subsistema KVM x86](process/maintainer-kvm-x86.html)
