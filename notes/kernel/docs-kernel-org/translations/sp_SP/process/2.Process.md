...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/2.Process.html
...
* Utilice respuestas intercaladas (“en línea”), lo que hace que su
  ...
  [Documentation/translations/sp\_SP/process/submitting-patches.rst](submitting-patches.html#sp-interleaved-replies).
