...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/4.Coding.html
...
[Linux kernel coding style](../../../process/coding-style.html). Durante gran parte de ese tiempo,
...
[clang-format](../../../dev-tools/clang-format.html) para más detalles.
...
> * FRAME\_WARN para obtener advertencias sobre marcos de pila más grandes
...
>   kernel.
> * DEBUG\_OBJECTS agregará código para rastrear la vida útil de varios
...
> * DEBUG\_SLAB puede encontrar una variedad de errores en la asignación y
>   uso de memoria; debe usarse en la mayoría de los kernels de desarrollo.
> * DEBUG\_SPINLOCK, DEBUG\_ATOMIC\_SLEEP y DEBUG\_MUTEXES encontrarán una serie
...
[Fault injection capabilities infrastructure](../../../fault-injection/fault-injection.html) para obtener más
...
ref:[Coccinelle](../../../dev-tools/coccinelle.html) <devtools\_coccinelle> para
...
[Documentation/doc-guide/](../../../doc-guide/index.html#doc-guide).
