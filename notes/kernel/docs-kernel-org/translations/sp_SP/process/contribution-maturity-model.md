...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/contribution-maturity-model.html
...
Original:
:   [Linux Kernel Contribution Maturity Model](../../../process/contribution-maturity-model.html)
