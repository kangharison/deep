...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/handling-regressions.html
...
[Reporting regressions](../../../admin-guide/reporting-regressions.html), que cubre el tema
...
3. Cuando se manden correcciones para las regresiones, añadir etiquetas
   ...
   [Submitting patches: the essential guide to getting your code into the kernel](../../../process/submitting-patches.html) y
   [Documentation/process/5.Posting.rst](../../../process/5.Posting.html#development-posting).
...
[Documentation/process/5.Posting.rst](../../../process/5.Posting.html#development-posting), y
...
Repase la documentación: [Reporting regressions](../../../admin-guide/reporting-regressions.html),
