...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/maintainer-kvm-x86.html
...
Original:
:   [KVM x86](../../../process/maintainer-kvm-x86.html)
...
[Coding style notes](../../../process/maintainer-tip.html#maintainer-tip-coding-style), ya que los parches/series a menudo
...
Consulte [The canonical patch format](../../../process/submitting-patches.html#the-canonical-patch-format) para obtener más información,
...
Consulte [Describe your changes](../../../process/submitting-patches.html#describe-changes) para obtener más información, con una
...
parches. que se dirigen principalmente a código arch/x86 que \_NO\_ es código
KVM.
...
para KVM\_INTEL=m KVM\_AMD=m, y KVM\_WERROR=y. Construir todas las
combinaciones posibles de Kconfigs no es factible, pero cuantas más mejor.
KVM\_SMM, KVM\_XEN, PROVE\_LOCKING, y X86\_64 son particularmente interesantes.
...
soporte para un a través de KVM\_GET\_SUPPORTED\_CPUID, es decir, para
...
Por favor, siga el protocolo para [Security bugs](../../../process/security-bugs.html#securitybugs) si sospecha que un
