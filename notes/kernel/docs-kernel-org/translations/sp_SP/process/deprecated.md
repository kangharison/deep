...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/deprecated.html
...
Original:
:   [Documentation/process/deprecated.rst](../../../process/deprecated.html#deprecated)
...
que usar \_\_deprecated es sencillo para anotar una API obsoleta en
...
de funciones [`pr_warn()`](../../../core-api/printk-basics.html#c.pr_warn "pr_warn"). Los responsables del sistema pueden haber definido
*panic\_on\_warn* sysctl para asegurarse que sus sistemas no continúan
...
Específicamente, [`kmalloc()`](../../../core-api/mm-api.html#c.kmalloc "kmalloc") puede ser sustituido con [`kmalloc_array()`](../../../core-api/mm-api.html#c.kmalloc_array "kmalloc_array"),
[`kzalloc()`](../../../core-api/mm-api.html#c.kzalloc "kzalloc") puede ser sustituido con [`kcalloc()`](../../../core-api/mm-api.html#c.kcalloc "kcalloc").
...
Si se usa [`struct_size()`](../../../core-api/kernel-api.html#c.struct_size "struct_size") en una estructura que contiene un elemento
de longitud cero o un array de un único elemento como un array miembro,
por favor reescribir ese uso y cambiar a un [miembro array flexible](#zero-length-and-one-element-arrays)

Para otros cálculos, por favor use las funciones de ayuda: [`size_mul()`](../../../core-api/kernel-api.html#c.size_mul "size_mul"),
[`size_add()`](../../../core-api/kernel-api.html#c.size_add "size_add"), and [`size_sub()`](../../../core-api/kernel-api.html#c.size_sub "size_sub"). Por ejemplo, en el caso de:
...
Para más detalles, mire también [`array3_size()`](../../../core-api/kernel-api.html#c.array3_size "array3_size") y [`flex_array_size()`](../../../core-api/kernel-api.html#c.flex_array_size "flex_array_size"),
como también la familia de funciones relacionadas [`check_mul_overflow()`](../../../core-api/kernel-api.html#c.check_mul_overflow "check_mul_overflow"),
[`check_add_overflow()`](../../../core-api/kernel-api.html#c.check_add_overflow "check_add_overflow"), [`check_sub_overflow()`](../../../core-api/kernel-api.html#c.check_sub_overflow "check_sub_overflow"), y [`check_shl_overflow()`](../../../core-api/kernel-api.html#c.check_shl_overflow "check_shl_overflow").

## simple\_strtol(), simple\_strtoll(), simple\_strtoul(), simple\_strtoull()

Las funciones: [`simple_strtol()`](../../../core-api/kernel-api.html#c.simple_strtol "simple_strtol"), [`simple_strtoll()`](../../../core-api/kernel-api.html#c.simple_strtoll "simple_strtoll"), [`simple_strtoul()`](../../../core-api/kernel-api.html#c.simple_strtoul "simple_strtoul"), y
[`simple_strtoull()`](../../../core-api/kernel-api.html#c.simple_strtoull "simple_strtoull") explícitamente ignoran los desbordamientos, lo que puede
llevar a resultados inesperados por las funciones que las llaman. Las
funciones respectivas [`kstrtol()`](../../../core-api/kernel-api.html#c.kstrtol "kstrtol"), [`kstrtoll()`](../../../core-api/kernel-api.html#c.kstrtoll "kstrtoll"), [`kstrtoul()`](../../../core-api/kernel-api.html#c.kstrtoul "kstrtoul"), y [`kstrtoull()`](../../../core-api/kernel-api.html#c.kstrtoull "kstrtoull")
...
[`strcpy()`](../../../core-api/kernel-api.html#c.strcpy "strcpy") no realiza verificaciones de los límites del buffer de destino.
Esto puede resultar en desbordamientos lineals más allá del fin del buffer,
causando todo tipo de errores. Mientras CONFIG\_FORTIFY\_SOURCE=y otras
...
es la función [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy"), aunque se ha de tener cuidado con cualquier caso
en el el valor retornado por [`strcpy()`](../../../core-api/kernel-api.html#c.strcpy "strcpy") sea usado, ya que [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy") no
...
El uso de [`strncpy()`](../../../core-api/kernel-api.html#c.strncpy "strncpy") no garantiza que el buffer de destino esté terminado en
...
el mejor reemplazo es usar la función [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy"), aunque se ha de tener
cuidado en los casos en los que el valor de [`strncpy()`](../../../core-api/kernel-api.html#c.strncpy "strncpy") fuera usado, ya que
[`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy") no devuelve un puntero al destino, sino el número de
...
ser terminado en el caracter nulo, debería usar [`strscpy_pad()`](../../../core-api/kernel-api.html#c.strscpy_pad "strscpy_pad").

Si una función usa cadenas de caracteres que no necesitan terminar en NUL,
debería usarse [`strtomem()`](../../../core-api/kernel-api.html#c.strtomem "strtomem"), y el destino debería señalarse con el atributo
[\_\_nonstring](https://gcc.gnu.org/onlinedocs/gcc/Common-Variable-Attributes.html)
...
caracter NUL, usar [`strtomem_pad()`](../../../core-api/kernel-api.html#c.strtomem_pad "strtomem_pad").

## strlcpy()

`strlcpy()` primero lee por completo el buffer de origen (ya que el valor
devuelto intenta ser el mismo que el de [`strlen()`](../../../core-api/kernel-api.html#c.strlen "strlen")). Esta lectura puede
...
carácter NUL. El reemplazo seguro de esta función es [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy"), pero se ha
de tener cuidado que en los casos en lso que se usase el valor devuelto de
`strlcpy()`, ya que [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy") devolverá valores negativos de erno cuando se
produzcan truncados.
...
se puede arrancar temporalmente con la opción de depuración “[no\_hash\_pointers](https://git.kernel.org/linus/5ead723a20e0447bc7db33dc3070b420e5f80aa6)”.
...
CONFIG\_THREAD\_INFO\_IN\_TASK=y), o sobre-escritura de la memoria adyacente
a la pila (cuando se construye sin CONFIG\_VMAP\_STACK=y).
...
es obvio solamente mirando al código si STATE\_ONE está escrito para
intencionadamente saltar en STATE\_TWO:
...
que expande las extensiones de gcc [\_\_attribute\_\_((\_\_fallthrough\_\_))](https://gcc.gnu.org/onlinedocs/gcc/Statement-Attributes.html).
...
accidentalmente \_no\_ es usado al final de la estructura (lo que podía pasar
...
los arrays (via sizeof(), CONFIG\_FORTIFY\_SOURCE, y CONFIG\_UBSAN\_BOUNDS).
...
usa la función de ayuda [`struct_size()`](../../../core-api/kernel-api.html#c.struct_size "struct_size"), de otro modo estaríamos
...
[`struct_size()`](../../../core-api/kernel-api.html#c.struct_size "struct_size") y [`flex_array_size()`](../../../core-api/kernel-api.html#c.flex_array_size "flex_array_size"):
