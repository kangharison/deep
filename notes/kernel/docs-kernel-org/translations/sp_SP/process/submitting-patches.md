...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/submitting-patches.html
...
Original:
:   [Documentation/process/submitting-patches.rst](../../../process/submitting-patches.html#submittingpatches)
...
[A guide to the Kernel Development Process](../../../process/development-process.html). Además, lea
[Linux Kernel patch submission checklist](../../../process/submit-checklist.html) para obtener una lista de
elementos a verificar antes de enviar código. Para los parches de
“binding” del árbol de dispositivos, lea
[Submitting Devicetree (DT) binding patches](../../../devicetree/bindings/submitting-patches.html).
...
[Subsystem and maintainer tree specific development process notes](../../../process/maintainer-handbooks.html).
...
Consulte [Formato de parche canónico](#sp-the-canonical-patch-format).
...
Lea [Separate your changes](../../../process/submitting-patches.html#split-changes).
...
detalles pueden ser encontrados en [Linux kernel coding style](../../../process/coding-style.html).
...
son esos maintainers. El script scripts/get\_maintainer.pl puede ser muy
útil en este paso (pase rutas a sus parches como argumentos para
scripts/get\_maintainer.pl). Si no puede encontrar un maintainer del
...
[Security bugs](../../../process/security-bugs.html).
...
[Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.html) además de este documento.
...
Consulte [Email clients info for Linux](../../../process/email-clients.html) para obtener sugerencias
...
[Formato de parche canónico](#sp-the-canonical-patch-format)).

Consulte [Email clients info for Linux](../../../process/email-clients.html) para obtener
...
[Describe your changes](../../../process/submitting-patches.html#describe-changes) para más detalles.
...
[Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.html).
...
incluir \_todos\_ los errores de compilación; pero lo suficiente como para
...
Kernel [Linux kernel coding style](../../../process/coding-style.html)
