...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/embargoed-hardware-issues.html
...
Original:
:   [Embargoed hardware issues](../../../process/embargoed-hardware-issues.html)
...
del kernel de Linux ([errores de seguridad](security-bugs.html)) en su
lugar.
...
> | Qualcomm | Trilok Soni <[quic\_tsoni@quicinc.com](mailto:quic_tsoni%40quicinc.com)> |
...
Para el contacto inicial, consulte [Contacto](#contacto). Para las listas de
