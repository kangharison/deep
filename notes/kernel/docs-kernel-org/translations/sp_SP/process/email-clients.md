...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/email-clients.html
...
Original:
:   [Documentation/process/email-clients.rst](../../../process/email-clients.html#email-clients)
...
> set send\_charset=”us-ascii:utf-8”
