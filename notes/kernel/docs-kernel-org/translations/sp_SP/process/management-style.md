...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/management-style.html
...
[translations/sp\_SP/process/coding-style.rst](coding-style.html#sp-codingstyle) hasta
cierto punto y está escrito principalmente para evitar responder a [[1]](#f1)
...
convierte en un no-no según [1) Decisiones](#decisiones).
...
“eres un pen\*ejo” de millones de manera diferentes [[2]](#f2), a veces sin
...
real de irritar a alguien [[3]](#f3).
