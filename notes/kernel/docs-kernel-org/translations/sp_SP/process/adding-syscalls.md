...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/adding-syscalls.html
...
[Documentation/process/submitting-patches.rst](../../../process/submitting-patches.html#submittingpatches) que
...
>   >   *[read(2)](https://man7.org/linux/man-pages/man2/read.2.html)*/*[write(2)](https://man7.org/linux/man-pages/man2/write.2.html)* tienen que ser implementadas
>   >   como solicitudes *[ioctl(2)](https://man7.org/linux/man-pages/man2/ioctl.2.html)*, las cuales pueden llevar a un
>   >   API algo opaca.
...
>   específico, entonces la opción de comando adicional *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)*
>   podría ser más apropiada. Sin embargo, *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)* es una
...
>   la funcionalidad existente *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)*, o la nueva funcionalidad
...
>   un comando adicional *[prctl(2)](https://man7.org/linux/man-pages/man2/prctl.2.html)* podría ser más apropiado. Tal
>   como con *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)*, esta llamada al sistema es un multiplexor
...
Revise *[perf\_event\_open(2)](https://man7.org/linux/man-pages/man2/perf_event_open.2.html)* y la función `perf_copy_attr()` (en
...
*[poll(2)](https://man7.org/linux/man-pages/man2/poll.2.html)* en ese descriptor de archivo. Hacer un descriptor de
...
revise el man page *[openat(2)](https://man7.org/linux/man-pages/man2/openat.2.html)*; para un ejemplo de AT\_EMPTY\_PATH,
mire el man page *[fstatat(2)](https://man7.org/linux/man-pages/man2/fstatat.2.html)* manpage.)
...
describe en el man page *[capabilities(7)](https://man7.org/linux/man-pages/man7/capabilities.7.html)*. Elija una parte de
...
>   usualmente x86 (incluyendo todas las x86\_64, x86\_32 y x32).
...
También actualice el conteo de \_\_NR\_syscalls para reflejar la llamada de
...
entrada “común” (para x86\_64 y x86\_32) en
...
por ejemplo, los argumentos de *[splice(2)](https://man7.org/linux/man-pages/man2/splice.2.html)*) del tipo
...
`COMPAT_SYSCALL_DEFINEn`, de manera análoga a SYSCALL\_DEFINEn. Esta
...
arch/x86/entry/syscalls/syscall\_64.tbl no se cambia).
...
Para x86\_64, esto es implementado como un punto de entrada `stub_xyzzy`
...
comun con la versión x86\_64, entonces su tabla syscall también necesitará
...
stub\_xyzzy, pero el UML construido no incluye una implementación
...
x86\_64 (-m64), x86\_32 (-m32) y x32 (-mx32) programa ABI.
...
> * Artículo LWN de Michael Kerrisk sobre evitar nuevos usos de CAP\_SYS\_ADMIN:
...
> * Discusión de Michael Kerrisk de nuevas system call vs. extensiones *[prctl(2)](https://man7.org/linux/man-pages/man2/prctl.2.html)*:
...
> * Enumerando rarezas por la (re-)utilización de O\_\* numbering space flags:
>
