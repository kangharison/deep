...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/8.Conclusion.html
...
[Documentation/translations/sp\_SP/process/howto.rst](howto.html#sp-process-howto);
también lea
