...
> 출처(원문): https://docs.kernel.org/translations/sp_SP/process/5.Posting.html
...
and [Documentation/translations/sp\_SP/process/submit-checklist.rst](submit-checklist.html#sp-submitchecklist)
...
>   intacto.
>
>   [Documentation/translations/sp\_SP/process/email-clients.rst](email-clients.html#sp-email-clients)
