...
> 출처(원문): https://docs.kernel.org/translations/ja_JP/process/submit-checklist.html
...
の翻訳です。
免責条項については、
[免責条項の抄訳](../disclaimer-ja_JP.html#translations-ja-jp-disclaimer) および、
[Disclaimer (英語版)](../../index.html#translations-disclaimer) を参照してください。

以下は、カーネルパッチの投稿時に、そのスムーズな受け入れのために心がける
べき基本的な事項です。

これは、 [Submitting patches: the essential guide to getting your code into the kernel](../../../process/submitting-patches.html) およびその他の
...
2. [Linux kernel coding style](../../../process/coding-style.html) に詳述されている一般的なスタイル
   についてチェック済み。
...
1. 新規の、もしくは変更された `CONFIG` オプションについて、それが関係する
   ...
   [Kconfig Language](../../../kbuild/kconfig-language.html) の
...
1. グローバルなカーネル API が [kernel-doc](../../../doc-guide/kernel-doc.html#kernel-doc) の形式で
...
5. 新規ユーザースペース・インターフェースが、すべて `Documentation/ABI/`
   以下に記載されている。詳しくは、 [Linux ABI description](../../../admin-guide/abi.html)
...
4. 最低限、slab と ページ・アロケーションの失敗に関する誤り注入
   ...
   詳しくは、 [Fault-injection](../../../fault-injection/index.html) を参照。
