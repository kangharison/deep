...
> 출처(원문): https://docs.kernel.org/translations/ja_JP/process/howto.html
...
>     だけをレビューします。
>
> [Documentation/process/submitting-patches.rst](../../../process/coding-style.html#codingstyle)
...
カーネルツリーに入っている、
[Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.html) ファイルにはどのような種
...
もしパッチをメールに付ける場合は、
[Submitting patches: the essential guide to getting your code into the kernel](../../../process/submitting-patches.html) に提示されているように、そ
