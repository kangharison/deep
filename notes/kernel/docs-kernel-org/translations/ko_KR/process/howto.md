...
> 출처(원문): https://docs.kernel.org/translations/ko_KR/process/howto.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

NOTE:
This is a version of [HOWTO do Linux kernel development](../../../process/howto.html) translated into korean
...
[Documentation/process/license-rules.rst](../../../process/license-rules.html#kernel-licensing) 에 설명되어
...
커널 트리 문서들 내의 [Documentation/process/stable-kernel-rules.rst](../../../process/stable-kernel-rules.html#stable-kernel-rules)
...
메인 커널 소스 디렉토리에 있는 ‘[Reporting issues](../../../admin-guide/reporting-issues.html)’
...
[Documentation/process/submitting-patches.rst](../../../process/submitting-patches.html#submittingpatches) 에
