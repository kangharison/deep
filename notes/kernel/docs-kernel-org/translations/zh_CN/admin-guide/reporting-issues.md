...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/admin-guide/reporting-issues.html
...
[Reporting regressions](../../../admin-guide/reporting-regressions.html) 对此进行了更详细的解释。
它还提供了很多你可能想知道的关于回归的其他信息；例如，它解释了如何将您的问题
添加到回归跟踪列表中，以确保它不会被忽略。

什么是安全问题留给您自己判断。在继续之前，请考虑阅读
[安全缺陷](../process/security-bugs.html) ，
...
如果你的内核被污染了，请阅读 [受污染的内核](tainted-kernels.html)
...
为了说明如何使用 [MAINTAINERS](../../../process/maintainers.html#maintainers) 文件，让我们假设您的笔记
...
是“ath10k\_pci”，您不会找到任何东西，因为名称太具体了。有时你需要在网上寻找
...
“scripts/get\_maintainer.pl”，它尝试找到所有要联系的人。它会查询MAINTAINERS
...
get\_maintainer.pl。脚本会查看提交历史，以找到最近哪些人参与了相关代码的编写，
...
启用 CONFIG\_KALLSYMS 选项。此外，还可以启用 CONFIG\_DEBUG\_KERNEL 和
CONFIG\_DEBUG\_INFO；后者是相关选项，但只有启用前者才能开启。请注意，
CONFIG\_DEBUG\_INFO 会需要更多储存空间来构建内核。但这是值得的，因为这些选项将
...
CONFIG\_DEBUG\_INFO 和 CONFIG\_KALLSYMS选项时，这种方法才起效。如果已启用此选项，
...
[二分（bisect）缺陷](bug-bisect.html) 文档中进行了详细
...
[Reporting regressions](../../../admin-guide/reporting-regressions.html) ；它还提供了大量其他您
可能希望了解的有关回归的信息。
...
现在就像 [MAINTAINERS](../../../process/maintainers.html#maintainers) 维护者文件告诉你的那样发送或提交
...
更多信息请参见 [安全缺陷](../process/security-bugs.html) 。
...
特别关照”部分和文档 [二分（bisect）缺陷](bug-bisect.html) 。
...
[所有你想知道的事情 - 关于linux稳定版发布](../process/stable-kernel-rules.html) 中所列出的
规则的修改。
