...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/admin-guide/tainted-kernels.html
...
Original:
:   [Tainted kernels](../../../admin-guide/tainted-kernels.html)
...
>    没有MODULE\_LICENSE（模块许可证）或MODULE\_LICENSE未被insmod认可为GPL
>    兼容的模块被认为是专有的。
...
>    * 某些驱动程序正在被用在不受支持的体系结构上（例如x86\_64以外的其他系统
>      上的scsi/snic，非x86/x86\_64/itanium上的scsi/ips，已经损坏了arm64上
