...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/admin-guide/bug-hunting.html
...
[Tainted kernels](../../../admin-guide/tainted-kernels.html) 文件中进行了描述，“正在被加
载”用“+”标注，“正在被卸载”用“-”标注。
...
2. 从串口终端启动（参见
   ...
   Minicom运行良好。
3. 使用Kdump（参阅 [Documentation for Kdump - The kexec-based Crash Dumping Solution](../../../admin-guide/kdump/kdump.html) ），使用
