...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/admin-guide/README.html
...
>   内核安装说明。请阅读
>   [Documentation/process/changes.rst](../../../process/changes.html#changes) 文件，它包含了升级内核
>   可能会导致的问题的相关信息。
...
>   >   内核问题，从而降低内核的稳定性（[`kmalloc()`](../../../core-api/mm-api.html#c.kmalloc "kmalloc")）。因此，您可能应该
>   >   用于研究“开发”、“实验”或“调试”特性相关问题。

## 编译内核

> * 确保您至少有gcc 8.1可用。
>   有关更多信息，请参阅 [Documentation/process/changes.rst](../../../process/changes.html#changes) 。
...
更多用GDB调试内核的信息，请参阅：
[通过gdb调试内核和模块](../dev-tools/gdb-kernel-debugging.html)
