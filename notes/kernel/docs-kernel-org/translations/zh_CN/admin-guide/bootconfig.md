...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/admin-guide/bootconfig.html
...
Original:
:   [Boot Configuration](../../../admin-guide/bootconfig.html)
...
如果您有一个关键字字符串，则可以直接使用 [`xbc_find_value()`](../../../admin-guide/bootconfig.html#c.xbc_find_value "xbc_find_value") 查询该键的值。如果
你想知道引导配置里有哪些关键字，可以使用 [`xbc_for_each_key_value()`](../../../admin-guide/bootconfig.html#c.xbc_for_each_key_value "xbc_for_each_key_value") 迭代键值对。
请注意，您需要使用 [`xbc_array_for_each_value()`](../../../admin-guide/bootconfig.html#c.xbc_array_for_each_value "xbc_array_for_each_value") 访问数组的值，例如:
...
如果您想查找具有前缀字符串的键，可以使用 [`xbc_find_node()`](../../../admin-guide/bootconfig.html#c.xbc_find_node "xbc_find_node") 通过前缀字符串查找
节点，然后用 [`xbc_node_for_each_key_value()`](../../../admin-guide/bootconfig.html#c.xbc_node_for_each_key_value "xbc_node_for_each_key_value") 迭代前缀节点下的键。
