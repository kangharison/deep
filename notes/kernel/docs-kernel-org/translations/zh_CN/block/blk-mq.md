...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/block/blk-mq.html
...
Original:
:   [Multi-Queue Block IO Queueing Mechanism (blk-mq)](../../../block/blk-mq.html)
...
多关于 Linux IO 调度器知识 [here](https://www.kernel.org/doc/html/latest/block/index.html)。调度只发
...
硬件队列（由 [`struct blk_mq_hw_ctx`](../../../block/blk-mq.html#c.blk_mq_hw_ctx "blk_mq_hw_ctx") 表示）是设备驱动用来映射设备提交队列
...
* [Linux 块 I/O：多队列 SSD 并发访问简介](http://kernel.dk/blk-mq.pdf)
* [NOOP 调度器](https://en.wikipedia.org/wiki/Noop_scheduler)
* [Null 块设备驱动程序](https://www.kernel.org/doc/html/latest/block/null_blk.html)
