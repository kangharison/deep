...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/filesystems/ubifs-authentication.html
...
Original:
:   [UBIFS Authentication Support](../../../filesystems/ubifs-authentication.html)
...
*脏空间* （旧空间，废弃内容） [[1]](#id5) 的数量。因为 UBIFS 从不在单个 LEB 混
...
由于LEB只能追加写入不能覆盖，空闲空间（即 LEB 剩余可写空间）与废弃
