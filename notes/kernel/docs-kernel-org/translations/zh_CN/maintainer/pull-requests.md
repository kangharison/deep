...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/maintainer/pull-requests.html
...
Original:
:   [Creating Pull Requests](../../../maintainer/pull-requests.html)
...
的标记，并用您的gpg密钥签名（参见 [Configuring Git](../../../maintainer/configure-git.html) ）。
