...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/core-api/union_find.html
...
Original:
:   [Union-Find in Linux](../../../core-api/union_find.html)
...
作者:
:   Xavier <[xavier\_qy@163.com](mailto:xavier_qy%40163.com)>
...
Linux的并查集实现在文件“lib/union\_find.c”中。要使用它，需要
“#include <linux/union\_find.h>”。
