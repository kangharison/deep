...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/core-api/local_ops.html
...
Original:
:   [Semantics and Behavior of Local Atomic Operations](../../../core-api/local_ops.html)
...
意味着删除LOCK前缀（在i386和x86\_64上）和任何SMP同步屏障。如果架构在SMP和
...
那些本地计数器可以从外部的CPU中读取，以求得计数的总和。请注意，local\_read
...
如果你想使用远程local\_read来同步CPU之间对资源的访问，必须在写入者和读取者
