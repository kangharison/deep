...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/security/ipe.html
...
寻找有关IPE使用的文档，请参阅 [IPE admin
guide](../../../admin-guide/LSM/ipe.html)。
...
最初，IPE的策略可以包含一个policy\_version字段，声明系统上所有可激活策略
...
[测试套件](https://github.com/microsoft/ipe/tree/test-suite)
可以测试用户界面和强制执行功能。
