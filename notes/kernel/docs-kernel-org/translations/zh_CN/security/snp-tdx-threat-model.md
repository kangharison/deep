...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/security/snp-tdx-threat-model.html
...
Original:
:   [Confidential Computing in Linux for x86 virtualization](../../../security/snp-tdx-threat-model.html)
...
的更多细节，可以参考
[Intel Trust Domain Extensions (TDX)](../../../arch/x86/tdx.html) 和
