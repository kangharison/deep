...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/security/siphash.html
...
Original:
:   [SipHash - a short input PRF](../../../security/siphash.html)
...
代其他哈希函数，例如：jhash，md5\_transform，sha1\_transform等。
...
的方法就是将结构体的成员按照大小降序的方式排序，并且使用[`offsetofend()`](../../../driver-api/basics.html#c.offsetofend "offsetofend")
