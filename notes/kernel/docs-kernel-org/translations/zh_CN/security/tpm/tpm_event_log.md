...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/security/tpm/tpm_event_log.html
...
Original:
:   [TPM Event Log](../../../../security/tpm/tpm_event_log.html)
...
EFI\_TCG2\_PROTOCOL.`GetEventLog()`后被镜像到这个表中。
