...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/process/code-of-conduct-interpretation.html
...
[贡献者契约行为准则](code-of-conduct.html#cn-code-of-conduct) 准则是一个通用文档，旨在为几乎所有开源社区提供一套规则。
