...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/process/embargoed-hardware-issues.html
...
小组处理，报告者将被引导至常规Linux内核安全小组([Documentation/admin-guide/](../../../process/security-bugs.html#securitybugs))联系。
...
初次接触见 [接触](#zh-contact). 对于特定于事件的邮件列表，密钥和S/MIME证书通过
特定列表发送的电子邮件传递给订阅者。
