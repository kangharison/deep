...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/process/cve.html
...
独立于 [安全漏洞报送流程](../../../process/security-bugs.html)。
...
自己发现了一个未修复的安全问题，请按照 [安全漏洞报送流程](../../../process/security-bugs.html) 发送到Linux内核社区。
