...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/process/maintainer-pgp-guide.html
...
资格获得Linux 基金会提供的\_`qualify for a free Nitrokey Start` 。
