...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/process/researcher-guidelines.html
...
Original:
:   [Researcher Guidelines](../../../process/researcher-guidelines.html)
...
* 在哪个版本的 Linux 上发现了这个问题？强烈推荐使用最新的发布版本或最近的 linux-next 分支（参见 [HOWTO do Linux kernel development](../../../process/howto.html)）。
