...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/process/management-style.html
...
它的目的是在某种程度上参照 [process/coding-style.rst](../../../process/coding-style.html#codingstyle)
主要是为了避免反复回答 [[1]](#cnf1) 相同（或类似）的问题。
...
问题在于 #1 很容易去做，因为你可以用数百万种不同的方式说“你是一个笨蛋” [[2]](#cnf2)
