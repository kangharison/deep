...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/process/8.Conclusion.html
...
Original:
:   [Documentation/process/8.Conclusion.rst](../../../process/8.Conclusion.html#development-conclusion)
...
文档目录。顶级
[Documentation/translations/zh\_CN/process/howto.rst](howto.html#cn-process-howto)
文件是一个重要的起点；
[Documentation/translations/zh\_CN/process/submitting-patches.rst](submitting-patches.html#cn-submittingpatches)
