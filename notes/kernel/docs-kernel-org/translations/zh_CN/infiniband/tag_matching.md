...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/infiniband/tag_matching.html
...
Original:
:   [Tag matching logic](../../../infiniband/tag_matching.html)
...
1. Eager协议--当发送方处理完发送时，完整的信息就会被发送。在send\_cq中会收到
