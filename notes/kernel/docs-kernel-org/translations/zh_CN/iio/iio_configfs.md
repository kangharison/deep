...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/iio/iio_configfs.html
...
Original:
:   [Industrial IIO configfs support](../../../iio/iio_configfs.html)
...
为了使configfs支持IIO，我们需要在编译时选中config的CONFIG\_IIO\_CONFIGFS
选项。
...
/sw\_trigger.h：中的接口下将新的触发器类型实现为单独的内核模块：
...
它确实引入了触发目录的sampling\_frequency属性。
