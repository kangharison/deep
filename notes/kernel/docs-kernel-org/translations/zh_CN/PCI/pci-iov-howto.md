...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/PCI/pci-iov-howto.html
...
Original:
:   [PCI Express I/O Virtualization Howto](../../../PCI/pci-iov-howto.html)
...
在第二种方法中，对sysfs文件sriov\_numvfs的写入将启用和禁用与PCIe PF相关的VF。
