...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/rust/general-information.html
...
Original:
:   [General Information](../../../rust/general-information.html)
...
要了解如何编写文档，请看 [编码指南](coding-guidelines.html) 。
