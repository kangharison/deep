...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/mm/page_owner.html
...
中加入”page\_owner=on”。如果内核是用page owner构建的，并且由于没有启用启动
...
1. 构建用户空间的帮助:
   ...
   ```
2. 启用page owner: 添加 “page\_owner=on” 到 boot cmdline.
3. 做你想调试的工作。
4. 分析来自页面所有者的信息:
