...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/mm/active_mm.html
...
注意，在配置了 CONFIG\_MMU\_LAZY\_TLB\_REFCOUNT=n 的内核中，mm\_count 引用计数
可能不再包括“懒惰”用户（运行任务中 ->active\_mm == mm && ->mm == NULL）。
