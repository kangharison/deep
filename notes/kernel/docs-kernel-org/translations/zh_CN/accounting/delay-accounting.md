...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/accounting/delay-accounting.html
...
Original:
:   [Delay accounting](../../../accounting/delay-accounting.html)
...
kernel.task\_delayacct进行开关。注意，只有在启用延时计数后启动的
任务才会有相关信息。
...
:   # ./getdelays -i -p 1
    ...
    linuxrc: read=65536, write=0, cancelled\_write=0
