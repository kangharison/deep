...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/accounting/psi.html
...
Original:
:   [PSI - Pressure Stall Information](../../../accounting/psi.html)
...
对于CONFIG\_CGROUP=y及挂载了cgroup2文件系统的系统，能够获取cgroups内任务的psi。
