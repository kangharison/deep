...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/userspace-api/no_new_privs.html
...
Original:
:   [No New Privileges Flag](../../../userspace-api/no_new_privs.html)
...
适当权限的任务仍然可以调用 `setuid(2)` 并接收 SCM\_RIGHTS 数据报。
