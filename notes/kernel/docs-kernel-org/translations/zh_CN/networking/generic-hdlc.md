...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/networking/generic-hdlc.html
...
Original:
:   [Generic HDLC layer](../../../networking/generic-hdlc.html)
...
硬件驱动需使用#define DEBUG\_RINGS编译选项构建。
