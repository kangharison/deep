...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/arch/riscv/boot-image-header.html
...
Original:
:   [Boot image header in RISC-V Linux](../../../../arch/riscv/boot-image-header.html)
...
* 对于引导加载程序加载内核映像来说，image\_size成员对引导加载程序而言是必须的，否
  则将引导失败。
