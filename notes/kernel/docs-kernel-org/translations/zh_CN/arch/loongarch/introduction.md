...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/arch/loongarch/introduction.html
...
Original:
:   [Introduction to LoongArch](../../../../arch/loongarch/introduction.html)
...
[参考文献](#loongarch-references-zh-cn):
...
[参考文献](#loongarch-references-zh-cn) 中的文档。
...
此处给出一个直接映射的例子：物理地址0x00000000\_00001000的强序非缓存直接映射虚拟地址
（在XKPRANGE中）是0x80000000\_00001000，其一致可缓存直接映射虚拟地址（在XKPRANGE中）
是0x90000000\_00001000，而其弱序非缓存直接映射虚拟地址（在XKPRANGE中）是0xA0000000\_
00001000。
