...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/virt/ne_overview.html
...
Original:
:   [Nitro Enclaves](../../../virt/ne_overview.html)
...
ioctl逻辑被映射到PCI设备命令，例如，NE\_START\_ENCLAVE ioctl映射到一个enclave
