...
> 출처(원문): https://docs.kernel.org/translations/zh_CN/virt/acrn/io-request.html
...
Original:
:   [I/O request handling](../../../../virt/acrn/io-request.html)
...
I/O请求通信。一个I/O请求是一个256字节的结构体缓冲区，它是 “acrn\_io\_request” 结构
