...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/arch/arm64/amu.html
...
Original:
:   [Documentation/arch/arm64/amu.rst](../../../../arch/arm64/amu.html#amu-index)
...
因此，當配置 CONFIG\_ARM64\_AMU\_EXTN 後我們無條件使能後續
...
如果固件沒有提供適當的支持最好關閉 CONFIG\_ARM64\_AMU\_EXTN。
值得注意的是，出於安全原因，不要繞過 AMUSERRENR\_EL0 設置而捕獲從
...
特定輔助計數器可以通過 SYS\_AMEVCNTR1\_EL0(n) 訪問，其中n介於0到15。
