...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/arch/loongarch/introduction.html
...
[參考文獻](#loongarch-references-zh-tw):
...
[參考文獻](#loongarch-references-zh-tw) 中的文檔。
...
此處給出一個直接映射的例子：物理地址0x00000000\_00001000的強序非緩存直接映射虛擬地址
（在XKPRANGE中）是0x80000000\_00001000，其一致可緩存直接映射虛擬地址（在XKPRANGE中）
是0x90000000\_00001000，而其弱序非緩存直接映射虛擬地址（在XKPRANGE中）是0xA0000000\_
00001000。
