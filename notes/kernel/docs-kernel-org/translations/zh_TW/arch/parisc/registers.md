...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/arch/parisc/registers.html
...
Original:
:   [Register Usage for Linux/PA-RISC](../../../../arch/parisc/registers.html)
