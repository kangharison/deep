...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/process/8.Conclusion.html
...
文檔目錄。頂級
[Documentation/translations/zh\_CN/process/howto.rst](howto.html#tw-process-howto)
文件是一個重要的起點；
[Documentation/translations/zh\_CN/process/submitting-patches.rst](submitting-patches.html#tw-submittingpatches)
