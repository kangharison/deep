...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/process/howto.html
...
[Documentation/translations/zh\_TW/process/license-rules.rst](license-rules.html#tw-kernel-licensing)
...
:   [Documentation/admin-guide/README.rst](../../../admin-guide/README.html#readme)
    ...
    [Documentation/translations/zh\_TW/process/coding-style.rst](coding-style.html#tw-codingstyle)
    :   描述Linux內核的代碼風格和理由。所有新代碼需要遵守這篇文檔中定義的規
        范。大多數維護者只會接收符合規定的補丁，很多人也只會幫忙檢查符合風格
        的代碼。

    [Documentation/translations/zh\_TW/process/submitting-patches.rst](submitting-patches.html#tw-submittingpatches)
    ...
    [Documentation/translations/zh\_TW/process/stable-api-nonsense.rst](stable-api-nonsense.html#tw-stable-api-nonsense)
    ...
    [Documentation/translations/zh\_TW/process/management-style.rst](management-style.html#tw-managementstyle)
...
內核源碼中的 [Documentation/process/stable-kernel-rules.rst](../../../process/stable-kernel-rules.html#stable-kernel-rules)
