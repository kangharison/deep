...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/process/management-style.html
...
它的目的是在某種程度上參照 [process/coding-style.rst](../../../process/coding-style.html#codingstyle)
主要是爲了避免反覆回答 [[1]](#cnf1) 相同（或類似）的問題。
...
問題在於 #1 很容易去做，因爲你可以用數百萬種不同的方式說“你是一個笨蛋” [[2]](#cnf2)
