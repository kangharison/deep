...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/process/kernel-enforcement-statement.html
...
Original:
:   [Documentation/process/kernel-enforcement-statement.rst](../../../process/kernel-enforcement-statement.html#process-statement-kernel)
