...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/process/embargoed-hardware-issues.html
...
Original:
:   [Documentation/process/embargoed-hardware-issues.rst](../../../process/embargoed-hardware-issues.html#embargoed-hardware-issues)
...
小組處理，報告者將被引導至常規Linux內核安全小組([Documentation/admin-guide/](../../../process/security-bugs.html#securitybugs))聯繫。
...
初次接觸見 [接触](../../zh_CN/process/embargoed-hardware-issues.html#zh-contact). 對於特定於事件的郵件列表，密鑰和S/MIME證書通過
特定列表發送的電子郵件傳遞給訂閱者。
