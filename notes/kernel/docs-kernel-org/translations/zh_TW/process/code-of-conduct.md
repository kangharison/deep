...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/process/code-of-conduct.html
...
有關Linux內核社區如何解釋此文檔，請參閱 [Linux內核貢獻者契約行爲準則解釋](code-of-conduct-interpretation.html#tw-code-of-conduct-interpretation)
