...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/admin-guide/tainted-kernels.html
...
>    沒有MODULE\_LICENSE（模塊許可證）或MODULE\_LICENSE未被insmod認可爲GPL
>    兼容的模塊被認爲是專有的。
...
>    * 某些驅動程序正在被用在不受支持的體系結構上（例如x86\_64以外的其他系統
>      上的scsi/snic，非x86/x86\_64/itanium上的scsi/ips，已經損壞了arm64上
