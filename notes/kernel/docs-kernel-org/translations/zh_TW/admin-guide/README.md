...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/admin-guide/README.html
...
Original:
:   [Linux kernel release 6.x <http://kernel.org/>](../../../admin-guide/README.html)
...
>   內核安裝說明。請閱讀
>   [Documentation/process/changes.rst](../../../process/changes.html#changes) 文件，它包含了升級內核
>   可能會導致的問題的相關信息。
...
>   [Configuration targets and editors](../../../kbuild/kconfig.html)。
> * `make config` 注意事項:
>
...
>   >   內核問題，從而降低內核的穩定性（[`kmalloc()`](../../../core-api/mm-api.html#c.kmalloc "kmalloc")）。因此，您可能應該
>   >   用於研究“開發”、“實驗”或“調試”特性相關問題。

## 編譯內核

> * 確保您至少有gcc 5.1可用。
>   有關更多信息，請參閱 [Documentation/process/changes.rst](../../../process/changes.html#changes) 。
...
[报告问题](../../zh_CN/admin-guide/reporting-issues.html) 。

想要理解內核錯誤報告，請參閱：
[追踪缺陷](../../zh_CN/admin-guide/bug-hunting.html) 。

更多用GDB調試內核的信息，請參閱：
[通过gdb调试内核和模块](../../zh_CN/dev-tools/gdb-kernel-debugging.html)
和 [Using kgdb, kdb and the kernel debugger internals](../../../process/debugging/kgdb.html) 。
