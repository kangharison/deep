...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/admin-guide/reporting-regressions.html
...
Original:
:   [Reporting regressions](../../../admin-guide/reporting-regressions.html)
...
的迴歸；關於內核開發者如何處理的方面參見 [Handling regressions](../../../process/handling-regressions.html) 。
...
1. 如果某程序在原先的Linux內核上運行良好，但在較新版本上效果更差、或者根本不
   ...
   節參見下方。
2. 按照 [报告问题](../../zh_CN/admin-guide/reporting-issues.html) 中
...
只需按照 [报告问题](../../zh_CN/admin-guide/reporting-issues.html) 中
...
如 [报告问题](../../zh_CN/admin-guide/reporting-issues.html) （簡要）
和 [二分（bisect）缺陷](../../zh_CN/admin-guide/bug-bisect.html) （詳細）中所
...
多發言，其中一些在 [Handling regressions](../../../process/handling-regressions.html) 中被引用。
