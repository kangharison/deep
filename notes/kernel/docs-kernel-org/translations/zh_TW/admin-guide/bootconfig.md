...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/admin-guide/bootconfig.html
...
如果您有一個關鍵字字符串，則可以直接使用 [`xbc_find_value()`](../../../admin-guide/bootconfig.html#c.xbc_find_value "xbc_find_value") 查詢該鍵的值。如果
你想知道引導配置裏有哪些關鍵字，可以使用 [`xbc_for_each_key_value()`](../../../admin-guide/bootconfig.html#c.xbc_for_each_key_value "xbc_for_each_key_value") 迭代鍵值對。
請注意，您需要使用 [`xbc_array_for_each_value()`](../../../admin-guide/bootconfig.html#c.xbc_array_for_each_value "xbc_array_for_each_value") 訪問數組的值，例如:
...
如果您想查找具有前綴字符串的鍵，可以使用 [`xbc_find_node()`](../../../admin-guide/bootconfig.html#c.xbc_find_node "xbc_find_node") 通過前綴字符串查找
節點，然後用 [`xbc_node_for_each_key_value()`](../../../admin-guide/bootconfig.html#c.xbc_node_for_each_key_value "xbc_node_for_each_key_value") 迭代前綴節點下的鍵。
