...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/admin-guide/unicode.html
...
Original:
:   [Unicode support](../../../admin-guide/unicode.html)
...
| --- | --- | --- |
| LAT1\_MAP | Latin-1 (ISO 8859-1) | ESC ( B |
| GRAF\_MAP | DEC VT100 pseudographics | ESC ( 0 |
| IBMPC\_MAP | IBM code page 437 | ESC ( U |
| USER\_MAP | User defined | ESC ( K |
