...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/admin-guide/reporting-issues.html
...
[Reporting regressions](../../../admin-guide/reporting-regressions.html) 對此進行了更詳細的解釋。
它還提供了很多你可能想知道的關於迴歸的其他信息；例如，它解釋瞭如何將您的問題
添加到迴歸跟蹤列表中，以確保它不會被忽略。

什麼是安全問題留給您自己判斷。在繼續之前，請考慮閱讀
[安全缺陷](../../zh_CN/process/security-bugs.html) ，
...
如果你的內核被污染了，請閱讀 [受污染的内核](../../zh_CN/admin-guide/tainted-kernels.html)
...
爲了說明如何使用 [MAINTAINERS](../../../process/maintainers.html#maintainers) 文件，讓我們假設您的筆記
...
是“ath10k\_pci”，您不會找到任何東西，因爲名稱太具體了。有時你需要在網上尋找
...
“scripts/get\_maintainer.pl”，它嘗試找到所有要聯繫的人。它會查詢MAINTAINERS
...
get\_maintainer.pl。腳本會查看提交歷史，以找到最近哪些人蔘與了相關代碼的編寫，
...
啓用 CONFIG\_KALLSYMS 選項。此外，還可以啓用 CONFIG\_DEBUG\_KERNEL 和
CONFIG\_DEBUG\_INFO；後者是相關選項，但只有啓用前者才能開啓。請注意，
CONFIG\_DEBUG\_INFO 會需要更多儲存空間來構建內核。但這是值得的，因爲這些選項將
...
CONFIG\_DEBUG\_INFO 和 CONFIG\_KALLSYMS選項時，這種方法才起效。如果已啓用此選項，
...
[二分（bisect）缺陷](../../zh_CN/admin-guide/bug-bisect.html) 文檔中進行了詳細
...
[Reporting regressions](../../../admin-guide/reporting-regressions.html) ；它還提供了大量其他您
可能希望瞭解的有關回歸的信息。
...
現在就像 [MAINTAINERS](../../../process/maintainers.html#maintainers) 維護者文件告訴你的那樣發送或提交
...
更多信息請參見 [安全缺陷](../../zh_CN/process/security-bugs.html) 。
...
特別關照”部分和文檔 [二分（bisect）缺陷](../../zh_CN/admin-guide/bug-bisect.html) 。
...
[所有你想知道的事情 - 关于linux稳定版发布](../../zh_CN/process/stable-kernel-rules.html) 中所列出的
規則的修改。
