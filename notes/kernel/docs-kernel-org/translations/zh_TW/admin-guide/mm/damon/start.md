...
> 출처(원문): https://docs.kernel.org/translations/zh_TW/admin-guide/mm/damon/start.html
...
Original:
:   [Getting Started](../../../../../admin-guide/mm/damon/start.html)
...
[sysfs](../../../../../filesystems/sysfs.html) 被掛載。
