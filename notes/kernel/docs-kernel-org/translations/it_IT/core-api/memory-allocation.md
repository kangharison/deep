...
> 출처(원문): https://docs.kernel.org/translations/it_IT/core-api/memory-allocation.html
...
Original:
:   [Documentation/core-api/memory-allocation.rst](../../../core-api/memory-allocation.html#memory-allocation)
