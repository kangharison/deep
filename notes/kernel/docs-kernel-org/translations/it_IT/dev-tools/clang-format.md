...
> 출처(원문): https://docs.kernel.org/translations/it_IT/dev-tools/clang-format.html
...
Original:
:   [Documentation/dev-tools/clang-format.rst](../../../dev-tools/clang-format.html#clangformat)
...
>   allinea/ordina. Vedere [it\_clangformatreformat](#it-clangformatreformat).
...
>   eccetera. Vedere [it\_clangformatreview](#it-clangformatreview).
...
il più possibile
[Documentation/translations/it\_IT/process/coding-style.rst](../process/coding-style.html#it-codingstyle).
...
Consultare [it\_clangformatextra](#it-clangformatextra).
