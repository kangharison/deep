...
> 출처(원문): https://docs.kernel.org/translations/it_IT/kernel-hacking/hacking.html
...
[Documentation/kernel-hacking/hacking.rst](../../../kernel-hacking/hacking.html#kernel-hacking-hack)
...
se [bottom half lock](#it-local-bh-disable) è bloccato.
...
[`printk()`](../../../core-api/printk-basics.html#c.printk "printk") fornisce messaggi alla console, dmesg, e al demone syslog.
...
[`printk()`](../../../core-api/printk-basics.html#c.printk "printk") utilizza un buffer interno di 1K e non s’accorge di
...
### `copy_to_user()` / `copy_from_user()` / [`get_user()`](../../../core-api/mm-api.html#c.get_user "get_user") / [`put_user()`](../../../core-api/mm-api.html#c.put_user "put_user")

Definite in `include/linux/uaccess.h` / `asm/uaccess.h`

**[DORMONO]**

[`put_user()`](../../../core-api/mm-api.html#c.put_user "put_user") e [`get_user()`](../../../core-api/mm-api.html#c.get_user "get_user") sono usate per ricevere ed
...
Al contrario di:c:func:[`put_user()`](../../../core-api/mm-api.html#c.put_user "put_user") e [`get_user()`](../../../core-api/mm-api.html#c.get_user "get_user"), queste
...
### [`kmalloc()`](../../../core-api/mm-api.html#c.kmalloc "kmalloc")/[`kfree()`](../../../core-api/mm-api.html#c.kfree "kfree")
...
utente, ma [`kmalloc()`](../../../core-api/mm-api.html#c.kmalloc "kmalloc") ha un argomento aggiuntivo per indicare alcune
...
potete usare [`vmalloc()`](../../../core-api/mm-api.html#c.vmalloc "vmalloc"). Essa allocherà memoria virtuale all’interno
...
### [`mdelay()`](../../../timers/delay_sleep_functions.html#c.mdelay "mdelay")/[`udelay()`](../../../timers/delay_sleep_functions.html#c.udelay "udelay")

Definite in `include/asm/delay.h` / `include/linux/delay.h`

Le funzioni [`udelay()`](../../../timers/delay_sleep_functions.html#c.udelay "udelay") e [`ndelay()`](../../../timers/delay_sleep_functions.html#c.ndelay "ndelay") possono essere utilizzate
per brevi pause. Non usate grandi valori perché rischiate d’avere un
overflow - in questo contesto la funzione [`mdelay()`](../../../timers/delay_sleep_functions.html#c.mdelay "mdelay") è utile,
oppure considerate [`msleep()`](../../../timers/delay_sleep_functions.html#c.msleep "msleep").
...
### `__initcall()`/[`module_init()`](../../../driver-api/basics.html#c.module_init "module_init")
...
caricabili dinamicamente). L’utilizzo delle macro [`module_init()`](../../../driver-api/basics.html#c.module_init "module_init")
e [`module_exit()`](../../../driver-api/basics.html#c.module_exit "module_exit") semplifica la scrittura di codice che può funzionare
sia come modulo, sia come parte del kernel, senza l’ausilio di #ifdef.

La macro [`module_init()`](../../../driver-api/basics.html#c.module_init "module_init") definisce quale funzione dev’essere
...
macro [`module_init()`](../../../driver-api/basics.html#c.module_init "module_init") diventa equivalente a `__initcall()`,
...
### [`module_exit()`](../../../driver-api/basics.html#c.module_exit "module_exit")
...
### [`try_module_get()`](../../../driver-api/basics.html#c.try_module_get "try_module_get")/[`module_put()`](../../../driver-api/basics.html#c.module_put "module_put")
...
codice del modulo, dovreste chiamare [`try_module_get()`](../../../driver-api/basics.html#c.try_module_get "try_module_get") su quel modulo:
...
chiamare [`module_put()`](../../../driver-api/basics.html#c.module_put "module_put") quando avete finito.
...
a questo scopo: [`wait_event_interruptible()`](../../../driver-api/basics.html#c.wait_event_interruptible "wait_event_interruptible") (`include/linux/wait.h`).
...
La versione [`wait_event()`](../../../driver-api/basics.html#c.wait_event "wait_event") ignora i segnali.
...
`atomic_t`. [`atomic_read()`](../../../driver-api/basics.html#c.atomic_read "atomic_read") e [`atomic_set()`](../../../driver-api/basics.html#c.atomic_set "atomic_set") leggono ed
impostano il contatore, [`atomic_add()`](../../../driver-api/basics.html#c.atomic_add "atomic_add"), [`atomic_sub()`](../../../driver-api/basics.html#c.atomic_sub "atomic_sub"),
[`atomic_inc()`](../../../driver-api/basics.html#c.atomic_inc "atomic_inc"), [`atomic_dec()`](../../../driver-api/basics.html#c.atomic_dec "atomic_dec"), e
[`atomic_dec_and_test()`](../../../driver-api/basics.html#c.atomic_dec_and_test "atomic_dec_and_test") (ritorna vero se raggiunge zero dopo essere
stata decrementata).
...
[`set_bit()`](../../../core-api/kernel-api.html#c.set_bit "set_bit"), [`clear_bit()`](../../../core-api/kernel-api.html#c.clear_bit "clear_bit") e [`change_bit()`](../../../core-api/kernel-api.html#c.change_bit "change_bit")
impostano, cancellano, ed invertono il bit indicato.
[`test_and_set_bit()`](../../../core-api/kernel-api.html#c.test_and_set_bit "test_and_set_bit"), [`test_and_clear_bit()`](../../../core-api/kernel-api.html#c.test_and_clear_bit "test_and_clear_bit") e
[`test_and_change_bit()`](../../../core-api/kernel-api.html#c.test_and_change_bit "test_and_change_bit") fanno la stessa cosa, ad eccezione che
...
[Spazio dei nomi dei simboli](../core-api/symbol-namespaces.html).
...
In particolare, [`list_for_each_entry()`](../../../core-api/list.html#c.list_for_each_entry "list_for_each_entry") è utile.
...
Utilizzate [`ERR_PTR()`](../../../core-api/kernel-api.html#c.ERR_PTR "ERR_PTR") (`include/linux/err.h`) per codificare
un numero d’errore negativo in un puntatore, e [`IS_ERR()`](../../../core-api/kernel-api.html#c.IS_ERR "IS_ERR") e
[`PTR_ERR()`](../../../core-api/kernel-api.html#c.PTR_ERR "PTR_ERR") per recuperarlo di nuovo: così si evita d’avere un
...
* Nomi delle funzioni come stringhe (\_\_func\_\_).
...
* Modificate il file `Makefile`: le variabili CONFIG sono esportate qui,
  ...
  “obj-$(CONFIG\_xxx) += xxx.o”. La sintassi è documentata nel file
...
per avermi fornito un ottimo riassunto di [`disable_irq()`](../../../core-api/genericirq.html#c.disable_irq "disable_irq"),
