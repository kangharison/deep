...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/management-style.html
...
Original:
:   [Linux kernel management style](../../../process/management-style.html)
...
[translations/it\_IT/process/coding-style.rst](coding-style.html#it-codingstyle),
ed è principalmente scritto per evitare di rispondere [[1]](#f1) in continuazione
...
diviene un no-no secondo la sezione [1) Le decisioni](#it-decisions).
...
è possibile dire “sei una testa di c\*\*\*” in milioni di modi differenti [[2]](#f2),
...
veramente far arrabbiare qualcuno [[3]](#f3).
