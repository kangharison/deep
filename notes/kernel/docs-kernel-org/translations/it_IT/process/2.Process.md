...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/2.Process.html
...
Original:
:   [Documentation/process/2.Process.rst](../../../process/2.Process.html#development-process)
...
* Rispondete sotto alla porzione di righe citate, così da dare un contesto alle
  ...
  leggete [Documentation/translations/it\_IT/process/submitting-patches.rst](submitting-patches.html#it-interleaved-replies).
