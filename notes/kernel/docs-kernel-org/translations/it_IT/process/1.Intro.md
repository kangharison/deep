...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/1.Intro.html
...
Original:
:   [Documentation/process/1.Intro.rst](../../../process/1.Intro.html#development-process-intro)
...
La sezione [Come funziona il processo di sviluppo](2.Process.html#it-development-process) introduce il processo di sviluppo,
...
La sezione [I primi passi della pianificazione](3.Early-stage.html#it-development-early-stage) copre i primi stadi della
pianificazione di un progetto di sviluppo, con particolare enfasi sul
coinvolgimento della comunità, il prima possibile.

La sezione [Scrivere codice corretto](4.Coding.html#it-development-coding) riguarda il processo di scrittura
...
La sezione [Pubblicare modifiche](5.Posting.html#it-development-posting) parla del processo di pubblicazione
...
La sezione [Completamento](6.Followthrough.html#it-development-followthrough) copre ciò che accade dopo
...
La sezione [Argomenti avanzati](7.AdvancedTopics.html#it-development-advancedtopics) introduce un paio di argomenti
“avanzati”: gestire le modifiche con git e controllare le modifiche pubblicate
da altri.

La sezione [Per maggiori informazioni](8.Conclusion.html#it-development-conclusion) chiude il documento con dei
