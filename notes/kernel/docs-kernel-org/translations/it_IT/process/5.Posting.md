...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/5.Posting.html
...
[translations/it\_IT/process/submitting-patches.rst](submitting-patches.html#it-submittingpatches)
e [translations/it\_IT/process/submit-checklist.rst](submit-checklist.html#it-submitchecklist).
...
‘[Configurare Git](../maintainer/configure-git.html)’
...
>   in [Documentation/translations/it\_IT/process/submitting-patches.rst](submitting-patches.html#it-submittingpatches).
...
>
>   [Documentation/translations/it\_IT/process/email-clients.rst](email-clients.html#it-email-clients)
