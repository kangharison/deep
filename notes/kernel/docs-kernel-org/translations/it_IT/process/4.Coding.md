...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/4.Coding.html
...
Original:
:   [Documentation/process/4.Coding.rst](../../../process/4.Coding.html#development-coding)
...
[Documentation/translations/it\_IT/process/coding-style.rst](../../../process/coding-style.html#codingstyle).
...
[Documentation/translations/it\_IT/dev-tools/clang-format.rst](../../../dev-tools/clang-format.html#clangformat)
...
> * FRAME\_WARN per ottenere degli avvertimenti su stack frame più
...
> * DEBUG\_OBJECTS aggiungerà un codice per tracciare il ciclo di vita di
...
> * DEBUG\_SLAB può trovare svariati errori di uso e di allocazione di memoria;
>   esso dovrebbe esser usato dalla maggior parte dei kernel di sviluppo.
> * DEBUG\_SPINLOCK, DEBUG\_ATOMIC\_SLEEP, e DEBUG\_MUTEXES troveranno un certo
...
[Fault injection capabilities infrastructure](../../../fault-injection/fault-injection.html) per avere maggiori
...
[Documentation/dev-tools/coccinelle.rst](../../../dev-tools/coccinelle.html#devtools-coccinelle).
...
Il file [Documentation/translations/it\_IT/admin-guide/kernel-parameters.rst](../../../admin-guide/kernel-parameters.html#kernelparameters)
...
[Documentation/translations/it\_IT/doc-guide/](../../../doc-guide/index.html#doc-guide).
