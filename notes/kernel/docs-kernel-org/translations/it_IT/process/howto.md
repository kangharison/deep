...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/howto.html
...
Original:
:   [Documentation/process/howto.rst](../../../process/howto.html#process-howto)
...
> [Documentation/translations/it\_IT/admin-guide/README.rst](../admin-guide/README.html#it-readme)
...
>
> [Documentation/translations/it\_IT/process/changes.rst](changes.html#it-changes)
>
> > Questo file fornisce una lista dei pacchetti software necessari
> > a compilare e far funzionare il kernel con successo.
>
> [Documentation/translations/it\_IT/process/coding-style.rst](coding-style.html#it-codingstyle)
>
...
>
> [Documentation/translations/it\_IT/process/stable-api-nonsense.rst](stable-api-nonsense.html#it-stable-api-nonsense)
>
...
>
> [Documentation/translations/it\_IT/process/security-bugs.rst](security-bugs.html#it-securitybugs)
...
>
> [Documentation/translations/it\_IT/process/management-style.rst](management-style.html#it-managementstyle)
...
>
> [Documentation/translations/it\_IT/process/stable-kernel-rules.rst](stable-kernel-rules.html#it-stable-kernel-rules)
...
>
> [Documentation/translations/it\_IT/process/kernel-docs.rst](kernel-docs.html#it-kernel-docs)
...
>
> [Documentation/translations/it\_IT/process/applying-patches.rst](applying-patches.html#it-applying-patches)
...
Il file [Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.html) (nei sorgenti) documenta
...
Il file ‘[Reporting issues](../../../admin-guide/reporting-issues.html)’ nella
...
leggibili come indicato in [Submitting patches: the essential guide to getting your code into the kernel](../../../process/submitting-patches.html).
