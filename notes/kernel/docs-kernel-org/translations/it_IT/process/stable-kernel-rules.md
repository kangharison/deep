...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/stable-kernel-rules.html
...
* Deve correggere un vero baco che causi problemi agli utenti oppure aggiunge
  ...
  + Corregge un problema come un oops, un blocco, una corruzione di dati, un
    ...
    compilazione (ma non per cose già segnate con CONFIG\_BROKEN), o problemi
...
L’[Opzione 1](#it-option-1) è **fortemente** raccomandata; è il modo più facile e
usato. L’[Opzione 2](#it-option-2) si usa quando al momento della sottomissione non si
era pensato di riportare la modifica su versioni precedenti.
L’[Opzione 3](#it-option-3) è un’alternativa ai due metodi precedenti quando la patch
