...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/changes.html
...
| Sphinx[[1]](#f1) | 2.4.4 | sphinx-build --version |
...
Verificate le istruzioni [Quick Start](../../../rust/quick-start.html) su come soddisfare i
...
Dalla versione 5.2, quando viene impostato CONFIG\_DEBUG\_INFO\_BTF, il sistema di
...
Probabilmente, vorrete anche il programma microcode\_ctl da usare con questo
dispositivo.
...
Per i dettaglio sui requisiti di Sphinx, fate riferimento a [Installazione Sphinx](../doc-guide/sphinx.html#it-sphinx-install)
in [Documentation/translations/it\_IT/doc-guide/sphinx.rst](../doc-guide/sphinx.html#it-sphinxdoc)
