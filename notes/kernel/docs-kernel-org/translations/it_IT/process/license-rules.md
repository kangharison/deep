...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/license-rules.html
...
Original:
:   [Documentation/process/license-rules.rst](../../../process/license-rules.html#kernel-licensing)
...
[Identificatori di licenza](#identificatori-di-licenza) e sono stati copiati dalla lista ufficiale di
...
1. Posizionamento:
   ...
   come prima riga ‘#!PATH\_TO\_INTERPRETER’. Per questi script l’identificativo
...
3. Sintassi:
   ...
   [Eccezioni](#eccezioni) nel capitolo [Identificatori di licenza](#identificatori-di-licenza)
...
1. Licenze raccomandate:
   ...
   [Metatag](#metatag). Il nome di questi file è lo stesso usato come identificatore
   ...
   * Usage-Guidance:
     ...
     [Sintassi degli identificatori di licenza](#sintassi-degli-identificatori-di-licenza).
   * License-Text:
...
2. Licenze deprecate:
   ...
   di usati per le [Licenze raccomandate](#licenze-raccomandate).
...
3. Solo per doppie licenze
   ...
   licenza e i suoi [Metatag](#metatag). I nomi dei file sono identici agli
   ...
   [Licenze raccomandate](#licenze-raccomandate).
...
4. Eccezioni:
   ...
   [Metatag per le eccezioni](#metatag-per-le-eccezioni).
