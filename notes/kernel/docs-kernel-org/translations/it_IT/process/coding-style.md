...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/coding-style.html
...
Original:
:   [Documentation/process/coding-style.rst](../../../process/coding-style.html#codingstyle)
...
alignof, e \_\_attribute\_\_, il cui aspetto è molto simile a quello delle
...
ma non con sizeof, typeof, alignof, o \_\_attribute\_\_. Ad esempio,
...
>    una bella cosa. Il motivo per cui abbiamo cose come pte\_t eccetera è
...
>    >
>    > > typedef unsigned long myfalgs\_t;
>
...
>    Perciò, utilizziamo \_\_u32 e tipi simili in tutte le strutture dati
...
:ref:[Documentation/translations/it\_IT/doc-guide/](../doc-guide/index.html#it-doc-guide) e in
`script/kernel-doc`.
...
[Documentation/translations/it\_IT/dev-tools/clang-format.rst](../dev-tools/clang-format.html#it-clangformat).
...
il documento [Kconfig Language](../../../kbuild/kconfig-language.html)
...
essere trovato nella gestore della memoria (`struct mm_sturct`: mm\_user e
mm\_count), e nel codice dei filesystem (`struct super_block`: s\_count e
s\_active).
...
ret è un nome comune per una variabile locale - \_\_foo\_ret difficilmente
...
Ci sono alcune macro per la diagnostica in <linux/dev\_printk.h> che dovreste
...
alcun dispositivo, <linux/printk.h> definisce [`pr_info()`](../../../core-api/printk-basics.html#c.pr_info "pr_info"), [`pr_warn()`](../../../core-api/printk-basics.html#c.pr_warn "pr_warn"), [`pr_err()`](../../../core-api/printk-basics.html#c.pr_err "pr_err"),
eccetera. Quando tutto funziona correttamente, non dovrebbero esserci stampe,
per cui preferite dev\_dbg/pr\_debug a meno che non sia qualcosa di sbagliato
da segnalare.
...
altri. Le funzioni `pr_XXX()` stampano incondizionatamente ma [`pr_debug()`](../../../core-api/printk-basics.html#c.pr_debug "pr_debug") no;
essa non viene compilata nella configurazione predefinita, a meno che
DEBUG o CONFIG\_DYNAMIC\_DEBUG non vengono impostati. Questo vale anche per
`dev_dbg()` e in aggiunta VERBOSE\_DEBUG per aggiungere i messaggi `dev_vdbg()`.
...
racchiusa in #ifdef, potete usare printk(KERN\_DEBUG ...).

## 14) Assegnare memoria

Il kernel fornisce i seguenti assegnatori ad uso generico:
[`kmalloc()`](../../../core-api/mm-api.html#c.kmalloc "kmalloc"), [`kzalloc()`](../../../core-api/mm-api.html#c.kzalloc "kzalloc"), [`kmalloc_array()`](../../../core-api/mm-api.html#c.kmalloc_array "kmalloc_array"), [`kcalloc()`](../../../core-api/mm-api.html#c.kcalloc "kcalloc"), [`vmalloc()`](../../../core-api/mm-api.html#c.vmalloc "vmalloc"), e [`vzalloc()`](../../../core-api/mm-api.html#c.vzalloc "vzalloc").
Per maggiori informazioni, consultate la documentazione dell’API:
[Documentation/translations/it\_IT/core-api/memory-allocation.rst](../core-api/memory-allocation.html#it-memory-allocation)
...
a meno che non venga esplicitamente specificato \_\_GFP\_NOWARN. Quindi, nella
...
`PCI device present` è un predicato, e la funzione [`pci_dev_present()`](../../../driver-api/pci/pci.html#c.pci_dev_present "pci_dev_present") ritorna
...
che ritornano un puntatore; queste utilizzano NULL o ERR\_PTR come meccanismo
...
inutilizzata, marcate questa definizione come \_\_maybe\_unused piuttosto che
...
Nel codice, dov’è possibile, usate la macro IS\_ENABLED per convertire i
