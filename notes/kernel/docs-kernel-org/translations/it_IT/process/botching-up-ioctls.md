...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/botching-up-ioctls.html
...
Original:
:   [(How to avoid) Botching up ioctls](../../../process/botching-up-ioctls.html)
...
* I puntatori sono di tipo `__u64`, con un *cast* da/a `uintptr_t` da lato
  ...
  possono effettuare. La macro [`u64_to_user_ptr()`](../../../driver-api/basics.html#c.u64_to_user_ptr "u64_to_user_ptr") può essere usata nel kernel
...
>   driver i915 l’abbozza con l’ioctl set\_tiling, ed ora siamo inchiodati per
