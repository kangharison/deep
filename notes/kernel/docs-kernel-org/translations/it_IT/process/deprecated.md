...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/deprecated.html
...
di \_\_deprecated in un file d’intestazione sia opportuno per segnare una
...
indesiderato, usare le funzioni della famiglia [`pr_warn()`](../../../core-api/printk-basics.html#c.pr_warn "pr_warn"). Chi
amministra il sistema potrebbe aver attivato l’opzione sysctl
*panic\_on\_warn* per essere sicuri che il sistema smetta di funzionare
...
Nello specifico, [`kmalloc()`](../../../core-api/mm-api.html#c.kmalloc "kmalloc") può essere sostituta da [`kmalloc_array()`](../../../core-api/mm-api.html#c.kmalloc_array "kmalloc_array"), e [`kzalloc()`](../../../core-api/mm-api.html#c.kzalloc "kzalloc")
da [`kcalloc()`](../../../core-api/mm-api.html#c.kcalloc "kcalloc").
...
Se per caso state usando [`struct_size()`](../../../core-api/kernel-api.html#c.struct_size "struct_size") su una struttura dati che
in coda contiene un array di lunghezza zero o uno, allora siete
invitati a riorganizzare il vostro codice usando il
[flexible array member](#zero-length-and-one-element-arrays).

Per altri calcoli, usate le funzioni [`size_mul()`](../../../core-api/kernel-api.html#c.size_mul "size_mul"), [`size_add()`](../../../core-api/kernel-api.html#c.size_add "size_add"), e [`size_sub()`](../../../core-api/kernel-api.html#c.size_sub "size_sub"). Per
esempio, al posto di:
...
> foo = krealloc(size\_add(current\_size,
> :   size\_mul(chunk\_size,
>     :   size\_sub(count, 3))), GFP\_KERNEL);

Per maggiori dettagli fate riferimento a [`array3_size()`](../../../core-api/kernel-api.html#c.array3_size "array3_size") e [`flex_array_size()`](../../../core-api/kernel-api.html#c.flex_array_size "flex_array_size"), ma
anche le funzioni della famiglia [`check_mul_overflow()`](../../../core-api/kernel-api.html#c.check_mul_overflow "check_mul_overflow"), [`check_add_overflow()`](../../../core-api/kernel-api.html#c.check_add_overflow "check_add_overflow"),
[`check_sub_overflow()`](../../../core-api/kernel-api.html#c.check_sub_overflow "check_sub_overflow"), e [`check_shl_overflow()`](../../../core-api/kernel-api.html#c.check_shl_overflow "check_shl_overflow").

## simple\_strtol(), simple\_strtoll(), simple\_strtoul(), simple\_strtoull()

Le funzioni [`simple_strtol()`](../../../core-api/kernel-api.html#c.simple_strtol "simple_strtol"), [`simple_strtoll()`](../../../core-api/kernel-api.html#c.simple_strtoll "simple_strtoll"),
[`simple_strtoul()`](../../../core-api/kernel-api.html#c.simple_strtoul "simple_strtoul"), e [`simple_strtoull()`](../../../core-api/kernel-api.html#c.simple_strtoull "simple_strtoull") ignorano volutamente
i possibili overflow, e questo può portare il chiamante a generare risultati
inaspettati. Le rispettive funzioni [`kstrtol()`](../../../core-api/kernel-api.html#c.kstrtol "kstrtol"), [`kstrtoll()`](../../../core-api/kernel-api.html#c.kstrtoll "kstrtoll"),
[`kstrtoul()`](../../../core-api/kernel-api.html#c.kstrtoul "kstrtoul"), e [`kstrtoull()`](../../../core-api/kernel-api.html#c.kstrtoull "kstrtoull") sono da considerarsi le corrette
...
La funzione [`strcpy()`](../../../core-api/kernel-api.html#c.strcpy "strcpy") non fa controlli agli estremi del buffer
...
CONFIG\_FORTIFY\_SOURCE=y e svariate opzioni del compilatore aiutano
a ridurne il rischio, non c’è alcuna buona ragione per continuare ad usare
questa funzione. La versione sicura da usare è [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy"), tuttavia va
prestata attenzione a tutti quei casi dove viene usato il valore di
ritorno di [`strcpy()`](../../../core-api/kernel-api.html#c.strcpy "strcpy"). La funzione [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy") non ritorna un puntatore
...
L’utilizzo di [`strncpy()`](../../../core-api/kernel-api.html#c.strncpy "strncpy") non fornisce alcuna garanzia sul fatto che
...
[`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy"), tuttavia va prestata attenzione a tutti quei casi dove
viene usato il valore di ritorno di [`strncpy()`](../../../core-api/kernel-api.html#c.strncpy "strncpy"). La funzione [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy")
...
terminazione con NUL dovrebbero usare [`strscpy_pad()`](../../../core-api/kernel-api.html#c.strscpy_pad "strscpy_pad").

Se il chiamate no usa stringhe terminate con NUL, allore [`strncpy()`](../../../core-api/kernel-api.html#c.strncpy "strncpy")
può continuare ad essere usata, ma i buffer di destinazione devono essere
marchiati con l’attributo [\_\_nonstring](https://gcc.gnu.org/onlinedocs/gcc/Common-Variable-Attributes.html)
...
terminata con NUL. La versione sicura da usare è [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy"), tuttavia
va prestata attenzione a tutti quei casi dove viene usato il valore di
ritorno di `strlcpy()`, dato che [`strscpy()`](../../../core-api/kernel-api.html#c.strscpy "strscpy") ritorna un valore di errno
...
aggiungete l’opzione di debug “[no\_hash\_pointers](https://git.kernel.org/linus/5ead723a20e0447bc7db33dc3070b420e5f80aa6)” alla
...
CONFIG\_THREAD\_INFO\_IN\_TASK=y), o sovrascrivere un pezzo di memoria adiacente
allo stack (quando il kernel è compilato senza CONFIG\_VMAP\_STACK=y).
...
STATE\_ONE è stato progettato apposta per eseguire anche STATE\_TWO:
...
\_\_attribute\_\_((fallthrough)) [Statement Attributes](https://gcc.gnu.org/onlinedocs/gcc/Statement-Attributes.html).
...
nel mezzo di una struttura dati e \_non\_ alla fine (potrebbe accadere
...
dimensioni degli array (attraverso sizeof(), CONFIG\_FORTIFY\_SOURCE,
e CONFIG\_UBSAN\_BOUNDS). Per esempio, non esiste alcun meccanismo in
...
[`struct_size()`](../../../core-api/kernel-api.html#c.struct_size "struct_size"), altrimenti avremmo --inavvertitamente-- allocato
...
combinazione con [`struct_size()`](../../../core-api/kernel-api.html#c.struct_size "struct_size") e [`flex_array_size()`](../../../core-api/kernel-api.html#c.flex_array_size "flex_array_size"):
...
Ci sono due casi speciali dove è necessario usare la macro [`DECLARE_FLEX_ARRAY()`](../../../driver-api/basics.html#c.DECLARE_FLEX_ARRAY "DECLARE_FLEX_ARRAY")
