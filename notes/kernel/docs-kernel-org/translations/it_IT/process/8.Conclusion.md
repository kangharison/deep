...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/8.Conclusion.html
...
Il file [process/howto.rst](howto.html#it-process-howto) è un punto di partenza
importante; [process/submitting-patches.rst](submitting-patches.html#it-submittingpatches) è
