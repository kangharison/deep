...
> 출처(원문): https://docs.kernel.org/translations/it_IT/process/submit-checklist.html
...
Original:
:   [Documentation/process/submit-checklist.rst](../../../process/submit-checklist.html#submitchecklist)
...
2. Controllate lo stile del codice della vostra patch secondo le direttive
   scritte in [Documentation/translations/it\_IT/process/coding-style.rst](coding-style.html#it-codingstyle).
...
1. Includete [kernel-doc](../../../doc-guide/kernel-doc.html#kernel-doc) per documentare API globali del
   kernel.
...
5. Tutte le nuove interfacce verso lo spazio utente sono documentate in
   :   `Documentation/ABI/`. Leggete [Linux ABI description](../../../admin-guide/abi.html)
