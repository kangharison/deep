...
> 출처(원문): https://docs.kernel.org/translations/it_IT/admin-guide/kernel-parameters.html
...
Original:
:   [Documentation/admin-guide/kernel-parameters.rst](../../../admin-guide/kernel-parameters.html#kernelparameters)
