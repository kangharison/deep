...
> 출처(원문): https://docs.kernel.org/translations/it_IT/doc-guide/kernel-doc.html
...
Generalmente il formato di un commento kernel-doc per struct, [`union ed`](../../../networking/ieee802154.html#c.ed "ed") enum è:
