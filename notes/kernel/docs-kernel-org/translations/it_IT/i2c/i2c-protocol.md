...
> 출처(원문): https://docs.kernel.org/translations/it_IT/i2c/i2c-protocol.html
...
Implementato da [`i2c_master_send()`](../../../driver-api/i2c.html#c.i2c_master_send "i2c_master_send"):
...
Implementato da [`i2c_master_recv()`](../../../driver-api/i2c.html#c.i2c_master_recv "i2c_master_recv"):
...
Implementato da [`i2c_transfer()`](../../../driver-api/i2c.html#c.i2c_transfer "i2c_transfer").
...
impostando questi flag per i messaggi I2C. Ad eccezione di I2C\_M\_NOSTART, sono
...
:   In una transazione combinata, potrebbe non essere generato alcun
    “S Addr Wr/Rd [A]”.
    Ad esempio, impostando I2C\_M\_NOSTART sul secondo messaggio parziale
    ...
    Se si imposta il flag I2C\_M\_NOSTART per il primo messaggio parziale,
