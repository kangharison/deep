...
> 출처(원문): https://docs.kernel.org/leds/leds-blinkm.html
...
Hue is controlled by the multi\_intensity file and lightness is controlled by
the brightness file.

The order in which to write the intensity values can be found in multi\_index.
Exactly three values between 0 and 255 must be written to multi\_intensity to
change the color:
