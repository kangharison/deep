...
> 출처(원문): https://docs.kernel.org/leds/leds-mt6370-rgb.html
...
a sink current up to 24mA and a CHG\_VIN power good indicator LED with sink
...
using the hw\_pattern attribute.
