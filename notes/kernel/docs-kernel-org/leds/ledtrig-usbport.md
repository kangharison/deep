...
> 출처(원문): https://docs.kernel.org/leds/ledtrig-usbport.html
...
[ABI file testing/sysfs-class-led-trigger-usbport](../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-class-led-trigger-usbport)
