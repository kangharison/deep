...
> 출처(원문): https://docs.kernel.org/leds/ledtrig-oneshot.html
...
[ABI file testing/sysfs-class-led-trigger-oneshot](../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-class-led-trigger-oneshot)
