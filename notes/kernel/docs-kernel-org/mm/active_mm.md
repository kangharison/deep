...
> 출처(원문): https://docs.kernel.org/mm/active_mm.html
...
Note, the mm\_count refcount may no longer include the “lazy” users
(running tasks with ->active\_mm == mm && ->mm == NULL) on kernels
with CONFIG\_MMU\_LAZY\_TLB\_REFCOUNT=n. Taking and releasing these lazy
