...
> 출처(원문): https://docs.kernel.org/mm/page_owner.html
...
can be matched with stacks later (show\_handles and show\_stacks\_handles).

page owner is disabled by default. So, if you’d like to use it, you need
to add “page\_owner=on” to your boot cmdline. If the kernel is built
...
1. Build user-space helper:
   ...
   ```
2. Enable page owner: add “page\_owner=on” to boot cmdline.
