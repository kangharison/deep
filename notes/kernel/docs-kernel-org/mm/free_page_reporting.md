...
> 출처(원문): https://docs.kernel.org/mm/free_page_reporting.html
...
it will allocate and initialize a page\_reporting\_dev\_info structure. The
...
handle at least PAGE\_REPORTING\_CAPACITY worth of scatterlist entries per
call to the function. A call to page\_reporting\_register will register the
...
is necessary to call page\_reporting\_unregister to have the
page\_reporting\_dev\_info structure that is currently in use by free page
