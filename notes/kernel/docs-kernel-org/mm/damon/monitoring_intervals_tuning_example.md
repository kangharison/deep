...
> 출처(원문): https://docs.kernel.org/mm/damon/monitoring_intervals_tuning_example.html
...
monitoring purpose. There is a [tuning guide](design.html#damon-design-monitoring-params-tuning-guide) for that. This document
...
regions detection. According to the [guide](design.html#damon-design-monitoring-params-tuning-guide), this is due to the too short
