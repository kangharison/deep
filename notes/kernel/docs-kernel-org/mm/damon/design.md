...
> 출처(원문): https://docs.kernel.org/mm/damon/design.html
...
[DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface) documentation.

## Overall Architecture

DAMON subsystem is configured with three layers including

* [Operations Set](#damon-operations-set): Implements fundamental
...
* [Core](#damon-core-logic): Implements core logics including monitoring
  overhead/accuracy control and access-aware system operations on top of the
  operations set layer, and
* [Modules](#damon-modules): Implements kernel modules for various
...
To know how user-space can do the configuration via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [operations](../../admin-guide/mm/damon/usage.html#sysfs-context) file part of the
documentation.
...
To know how user-space can set the attributes via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [monitoring\_attrs](../../admin-guide/mm/damon/usage.html#sysfs-monitoring-attrs)
...
[DAMOS tried regions](../../admin-guide/mm/damon/usage.html#sysfs-schemes-tried-regions) and [Tracepoints for Monitoring Results](../../admin-guide/mm/damon/usage.html#tracepoint),
respectively.
...
to converge regions with the [regions adjustment mechanism](#damon-design-adaptive-regions-adjustment) can be too long, depending on the
...
the feature](#damon-design-monitoring-intervals-autotuning) for detail.

Refer to below documents for an example tuning based on the above guide.

* [DAMON Moniting Interval Parameters Tuning Example](monitoring_intervals_tuning_example.html)

#### Monitoring Intervals Auto-tuning

DAMON provides automatic tuning of the `sampling interval` and `aggregation
interval` based on the [the tuning guide idea](#damon-design-monitoring-params-tuning-guide). The tuning mechanism allows
...
DAMON [region assumption](#damon-design-region-based-sampling). For
...
To know how user-space can use this feature via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [intervals\_goal](../../admin-guide/mm/damon/usage.html#damon-usage-sysfs-monitoring-intervals-goal) part of the documentation.
...
interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [apply\_interval\_us](../../admin-guide/mm/damon/usage.html#sysfs-scheme)
part of the documentation.
...
>   TRANSPARENT\_HUGEPAGE is disabled, the application of the action will just
>   fail.
...
To know how user-space can set the action via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [action](../../admin-guide/mm/damon/usage.html#sysfs-scheme) part of the
documentation.
...
interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [access\_pattern](../../admin-guide/mm/damon/usage.html#sysfs-access-pattern) part of the documentation.
...
To know how user-space can set the basic quotas via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [quotas](../../admin-guide/mm/damon/usage.html#sysfs-quotas) part of the
documentation.
...
interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [weights](../../admin-guide/mm/damon/usage.html#sysfs-quotas) part of
the documentation.
...
the current value via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to
[quota goals](../../admin-guide/mm/damon/usage.html#sysfs-schemes-quota-goals) part of the documentation.
...
To know how user-space can set the watermarks via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [watermarks](../../admin-guide/mm/damon/usage.html#sysfs-watermarks) part of the
documentation.
...
To know how user-space can set the filters via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to [filters](../../admin-guide/mm/damon/usage.html#sysfs-filters) part of the
documentation.
...
the region is eligible to apply the scheme’s [action](#damon-design-damos-action). The [access pattern](#damon-design-damos-access-pattern), [quotas](#damon-design-damos-quotas), [watermarks](#damon-design-damos-watermarks), and [filters](#damon-design-damos-filters) that handled on core logic could affect this.
The core logic will only ask the underlying [operation set](#damon-operations-set) to do apply the action to the region, so whether the
action is really applied or not is unclear. That’s why it is called “tried”.

“A scheme is applied to a region” means the [operation set](#damon-operations-set) has applied the action to at least a part of the
region. The [filters](#damon-design-damos-filters) that handled by the
operation set, and the types of the [action](#damon-design-damos-action)
...
To know how user-space can read the stats via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface), refer to :ref:s`stats <sysfs\_stats>` part of the
documentation.

#### Regions Walking

DAMOS feature allowing users access each region that a DAMOS action has just
applied. Using this feature, DAMON [API](#damon-design-api) allows users
...
[DAMON sysfs interface](../../admin-guide/mm/damon/usage.html#sysfs-interface) also allows users read the data
via special [files](../../admin-guide/mm/damon/usage.html#sysfs-schemes-tried-regions).
...
[document](api.html) for details of the interface.
...
available. Please refer to the ABI [doc](../../admin-guide/mm/damon/usage.html#sysfs-interface) for details of
the interfaces.
...
([Data Access Monitoring Results Stat](../../admin-guide/mm/damon/stat.html), [DAMON-based Reclamation](../../admin-guide/mm/damon/reclaim.html) and
