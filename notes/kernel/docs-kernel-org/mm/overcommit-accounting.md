...
> 출처(원문): https://docs.kernel.org/mm/overcommit-accounting.html
...
`/proc/meminfo` as CommitLimit and Committed\_AS respectively.
...
In mode 2 the MAP\_NORESERVE flag is ignored.
