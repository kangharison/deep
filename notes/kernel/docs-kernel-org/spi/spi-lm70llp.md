...
> 출처(원문): https://docs.kernel.org/spi/spi-lm70llp.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# spi\_lm70llp : LM70-LLP parport-to-SPI adapter
...
The bitbanger routine in this driver (lm70\_txrx) is called back from
the bound “hwmon/lm70” protocol driver through its sysfs hook, using a
[`spi_write_then_read()`](../driver-api/spi.html#c.spi_write_then_read "spi_write_then_read") call. It performs Mode 0 (SPI/Microwire) bitbanging.
