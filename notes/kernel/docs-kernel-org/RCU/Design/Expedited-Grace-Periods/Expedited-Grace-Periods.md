...
> 출처(원문): https://docs.kernel.org/RCU/Design/Expedited-Grace-Periods/Expedited-Grace-Periods.html
...
NEED\_RESCHED flag of the current task’s thread flag and the CPU preempt
...
workqueues (see [Workqueue](../../../core-api/workqueue.html)).
