...
> 출처(원문): https://docs.kernel.org/gpu/drm-usage-stats.html
...
in the [`struct drm_driver`](drm-internals.html#c.drm_driver "drm_driver") object registered with the DRM core.
...
* Driver-specific keys shall be prefixed with driver\_name-, where
  driver\_name should ideally be the same as the name field in
  [`struct drm_driver`](drm-internals.html#c.drm_driver "drm_driver"), although this is not mandatory.
...
[`struct drm_driver`](drm-internals.html#c.drm_driver "drm_driver") data structure.
...
to the in kernel representation of [`struct drm_file`](drm-internals.html#c.drm_file "drm_file") instances.
...
String optionally set by userspace using DRM\_IOCTL\_SET\_CLIENT\_NAME.
...
Drivers should use [`drm_show_fdinfo()`](drm-internals.html#c.drm_show_fdinfo "drm_show_fdinfo") in their `struct file_operations`, and
implement &drm\_driver.show\_fdinfo if they wish to provide any stats which
are not provided by [`drm_show_fdinfo()`](drm-internals.html#c.drm_show_fdinfo "drm_show_fdinfo"). But even driver specific stats should
be documented above and where possible, aligned with other drivers.

### Driver specific implementations

* [i915 DRM client usage stats implementation](i915.html#i915-usage-stats)
* [Panfrost DRM client usage stats implementation](panfrost.html#panfrost-usage-stats)
* [Panthor DRM client usage stats implementation](panthor.html#panthor-usage-stats)
* [Xe DRM client usage stats implementation](xe/xe-drm-usage-stats.html#xe-usage-stats)
