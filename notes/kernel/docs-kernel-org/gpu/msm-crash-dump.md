...
> 출처(원문): https://docs.kernel.org/gpu/msm-crash-dump.html
...
kernel
:   The kernel version that generated the dump (UTS\_RELEASE).
...
rbbm-status
:   The current value of RBBM\_STATUS which shows what top level GPU
