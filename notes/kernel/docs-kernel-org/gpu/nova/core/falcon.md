...
> 출처(원문): https://docs.kernel.org/gpu/nova/core/falcon.html
...
root of trust. For example, the FWSEC-FRTS command (see [FWSEC (Firmware Security)](fwsec.html)) runs on the
