...
> 출처(원문): https://docs.kernel.org/gpu/nova/core/fwsec.html
...
ROM (see [VBIOS](vbios.html) for more details). It contains different commands like FRTS
...
(see [Falcon (FAst Logic Controller)](falcon.html) for privilege levels).
...
it is extracted, see [VBIOS](vbios.html) and the vbios.rs source code.
