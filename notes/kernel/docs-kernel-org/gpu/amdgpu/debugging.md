...
> 출처(원문): https://docs.kernel.org/gpu/amdgpu/debugging.html
...
vm\_fault\_stop - If non-0, halt the GPU memory controller on a GPU page fault.

vm\_update\_mode - If non-0, use the CPU to update GPU page tables rather than
the GPU.
...
PERMISSION\_FAULTS describe what faults were encountered:
...
an invalid page (PERMISSION\_FAULTS = 0x3) at GPU virtual address
...
> tp\_printk trace\_event=amdgpu\_dm:amdgpu\_dm\_brightness:mod:amdgpu trace\_buf\_size=1M
