...
> 출처(원문): https://docs.kernel.org/gpu/amdgpu/gc/mes.html
...
If not, check [GFX, Compute, and SDMA Overall Behavior](../driver-core.html#pipes-and-queues-description)
and [drm/amdgpu - Graphics and Compute (GC)](index.html#amdgpu-gc).
