...
> 출처(원문): https://docs.kernel.org/gpu/amdgpu/display/mpo-overview.html
...
means, look at ‘[Display Core Next (DCN)](dcn-overview.html)’, section
...
be scaled and positioned for the desktop using the properties: CRTC\_X, CRTC\_Y,
CRTC\_W, and CRTC\_H. The primary plane should also have the color encoding and
