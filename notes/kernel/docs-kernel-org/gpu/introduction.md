...
> 출처(원문): https://docs.kernel.org/gpu/introduction.html
...
Also read the [guidelines for the kernel documentation at large](../doc-guide/index.html#doc-guide).
...
the [TODO list](todo.html#todo).

## Contribution Process

Mostly the DRM subsystem works like any other kernel subsystem, see [the
main process guidelines and documentation](../process/index.html#process-index) for how things work.
