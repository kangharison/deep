...
> 출처(원문): https://docs.kernel.org/admin-guide/laptops/toshiba_haps.html
...
provided to query such information, handled by the kernel module toshiba\_acpi
...
|  |  |
| --- | --- |
| protection\_level | The protection\_level is readable and writeable, and provides a way to let userspace query the current protection level, as well as set the desired protection level, the available protection levels are:  ``` ============   =======   ==========   ======== 0 - Disabled   1 - Low   2 - Medium   3 - High ============   =======   ==========   ======== ``` |
| reset\_protection | The reset\_protection entry is writeable only, being “1” the only parameter it accepts, it is used to trigger a reset of the protection interface. |
