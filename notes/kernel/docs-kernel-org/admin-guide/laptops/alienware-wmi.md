...
> 출처(원문): https://docs.kernel.org/admin-guide/laptops/alienware-wmi.html
...
WMI device documentation: [Dell AWCC WMI interface driver (alienware-wmi)](../../wmi/devices/alienware-wmi.html)
...
[sysfs-class-platform-profile](../abi-testing-files.html#abi-file-testing-sysfs-class-platform-profile)
...
The name of the hwmon class device exported by this driver is “alienware\_wmi”
...
[sysfs-class-hwmon](../abi-testing-files.html#abi-file-testing-sysfs-class-hwmon) for more
information.
