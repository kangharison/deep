...
> 출처(원문): https://docs.kernel.org/admin-guide/laptops/asus-laptop.html
...
This driver supersedes the old asus\_acpi driver.

## Requirements

> Kernel 2.6.X sources, configured for your computer, with ACPI support.
> You also need CONFIG\_INPUT and CONFIG\_ACPI.
...
> “acpi\_genl monitor” (part of the acpica project).
>
