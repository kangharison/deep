...
> 출처(원문): https://docs.kernel.org/admin-guide/acpi/ssdt-overlays.html
...
[Upgrading ACPI tables via initrd](initrd_table_override.html) for more details.
...
CONFIG\_EFI\_CUSTOM\_SSDT\_OVERLAYS should be chosen to y.
...
represent the attributes of the EFI variable (see EFI\_VARIABLE\_MASK in
...
interface. The CONFIG\_ACPI\_CONFIGFS option must be select and configfs must be
