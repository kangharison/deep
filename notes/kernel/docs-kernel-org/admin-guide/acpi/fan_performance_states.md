...
> 출처(원문): https://docs.kernel.org/admin-guide/acpi/fan_performance_states.html
...
Here use can look at fan performance states for a reference speed (speed\_rpm)
and set it by changing cooling device cur\_state. If the fine grain control
...
“fine\_grain\_control”. If fine grain control is present, this attribute
...
This speed is presented in the sysfs using the attribute “fan\_speed\_rpm”,
