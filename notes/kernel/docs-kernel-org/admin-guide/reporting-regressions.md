...
> 출처(원문): https://docs.kernel.org/admin-guide/reporting-regressions.html
...
for kernel developers are left to [Handling regressions](../process/handling-regressions.html).
...
2. Report your issue as outlined in [Reporting issues](reporting-issues.html),
...
[Reporting issues](reporting-issues.html), it already describes the
...
[Reporting issues](reporting-issues.html) and described in more detail by
[Bisecting a regression](bug-bisect.html). It might sound like a lot of work, but
...
[Handling regressions](../process/handling-regressions.html).
