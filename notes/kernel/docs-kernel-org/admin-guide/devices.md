...
> 출처(원문): https://docs.kernel.org/admin-guide/devices.html
...
[Documentation/process/submitting-patches.rst](../process/submitting-patches.html#submittingpatches) document).
