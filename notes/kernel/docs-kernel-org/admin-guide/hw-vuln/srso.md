...
> 출처(원문): https://docs.kernel.org/admin-guide/hw-vuln/srso.html
...
> /sys/devices/system/cpu/vulnerabilities/spec\_rstack\_overflow
...
>   >   around it PR\_SPEC\_DISABLE/\_ENABLE etc, see [Spectre Side Channels](spectre.html)
>   > + strict:
>   >
>   >   i.e., always on - by supplying spectre\_v2\_user=on on the kernel
>   >   command line
>
>   (spec\_rstack\_overflow=microcode)
> * ‘Mitigation: Safe RET’:
>
...
>
>   Selected by default or by spec\_rstack\_overflow=safe-ret
> * ‘Mitigation: IBPB’:
>
>   Similar protection as “safe RET” above but employs an IBPB barrier on
>   privilege domain crossings (User->Kernel, Guest->Host).
>
> > (spec\_rstack\_overflow=ibpb)
>
...
>   transitions only.
>
>   (spec\_rstack\_overflow=ibpb-vmexit)
...
>   SRSO\_USER\_KERNEL\_NO=1 CPUID bit. In that case, the code logic is to switch
...
disable the mitigation with spec\_rstack\_overflow=off.
...
retpoline sequence. To accomplish this, the \_\_x86\_return\_thunk forces
...
* PMC\_0xc8 - Count of RET/RET lw retired
* PMC\_0xc9 - Count of RET/RET lw retired mispredicted
...
vs the case when the mitigation is disabled (spec\_rstack\_overflow=off)
