...
> 출처(원문): https://docs.kernel.org/admin-guide/hw-vuln/l1tf.html
...
vulnerability file in sysfs. See [L1TF system information](#l1tf-sys-info).
...
> at the end of this document. See [Default mitigations](#default-mitigations).
...
> line and sysfs control files. See [Mitigation control on the kernel command line](#mitigation-control-command-line)
> and [Mitigation control for KVM - module parameter](#mitigation-control-kvm).
...
> [Mitigation control on the kernel command line](#mitigation-control-command-line).
...
The default is ‘flush’. For details about L1D flushing see [1. L1D flush on VMENTER](#l1d-flush).
...
> sysfs control files. See [Mitigation control on the kernel command line](#mitigation-control-command-line) and
> [Mitigation control for KVM - module parameter](#mitigation-control-kvm).
...
> [Mitigation control on the kernel command line](#mitigation-control-command-line) and [Mitigation control for KVM - module parameter](#mitigation-control-kvm).
...
>   [2. Guest VCPU confinement to dedicated physical cores](#guest-confinement).
> * Interrupt isolation:
>
...
>   [3. Interrupt affinity](#interrupt-isolation).
...
>   time with the matching sysfs control files. See [4. SMT control](#smt-control),
>   [Mitigation control on the kernel command line](#mitigation-control-command-line) and
>   [Mitigation control for KVM - module parameter](#mitigation-control-kvm).
> * Disabling EPT:
>
