...
> 출처(원문): https://docs.kernel.org/admin-guide/hw-vuln/mds.html
...
vulnerability file in sysfs. See [MDS system information](#mds-sys-info).
...
architecture section: [Documentation/arch/x86/mds.rst](../../arch/x86/mds.html#mds).
...
[Mitigation control on the kernel command line](#mds-mitigation-control-command-line).
...
>   [Documentation/admin-guide/hw-vuln//l1tf.rst](l1tf.html#mitigation-control-kvm).
...
> exception is XEON PHI, see [XEON PHI specific considerations](#xeon-phi).
>
> Disabling SMT can have a significant performance impact, but the impact
> depends on the type of workloads.
>
> See the relevant chapter in the L1TF mitigation documentation for details:
> [Documentation/admin-guide/hw-vuln/l1tf.rst](l1tf.html#smt-control).
...
> See [Virtualization mitigation](#virt-mechanism).
>
...
> for L1TF applies.
> See [Documentation/admin-guide/hw-vuln//l1tf.rst](l1tf.html#default-mitigations).
