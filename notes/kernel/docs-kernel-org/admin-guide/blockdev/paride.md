...
> 출처(원문): https://docs.kernel.org/admin-guide/blockdev/paride.html
...
PATA\_PARPORT (c) 2023 Ondrej Zary
...
To support such a wide range of devices, pata\_parport is actually structured
in two parts. There is a base pata\_parport module which provides an interface
...
## 2. Using pata\_parport subsystem

While configuring the Linux kernel, you may choose either to build
the pata\_parport drivers into your kernel, or to build them as modules.
...
You can actually select all the protocol modules, and allow the pata\_parport
...
The most common problems that people report with the pata\_parport drivers
...
multiple device environments, the pata\_parport drivers will not do it
...
your pata\_parport drivers as modules, and arrange to do the printer reset
before loading the pata\_parport drivers.
