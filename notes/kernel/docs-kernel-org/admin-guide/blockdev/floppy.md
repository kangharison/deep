...
> 출처(원문): https://docs.kernel.org/admin-guide/blockdev/floppy.html
...
>     (default)
>
> floppy=two\_fdc / floppy=<address>,two\_fdc
...
>     driver handles both.)
>
> floppy=unexpected\_interrupts
> :   Print a warning message when an unexpected interrupt is received.
>     (default)
>
> floppy=no\_unexpected\_interrupts / floppy=L40SX
