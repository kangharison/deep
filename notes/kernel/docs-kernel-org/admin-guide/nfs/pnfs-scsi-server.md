...
> 출처(원문): https://docs.kernel.org/admin-guide/nfs/pnfs-scsi-server.html
...
On a server built with CONFIG\_NFSD\_SCSI, the pNFS SCSI volume support is
...
On the client make sure the kernel has the CONFIG\_PNFS\_BLOCK option
...
> FENCE failed client[IP\_address] clid[#n] device[dev\_name]
>
> where:
>
> * IP\_address: refers to the IP address of the affected client.
> * #n: indicates the unique client identifier.
> * dev\_name: specifies the name of the block device related
