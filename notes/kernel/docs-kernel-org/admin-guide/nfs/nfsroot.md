...
> 출처(원문): https://docs.kernel.org/admin-guide/nfs/nfsroot.html
...
[Ramfs, rootfs and initramfs](../../filesystems/ramfs-rootfs-initramfs.html)), a ramdisk (see
[Using the initial RAM disk (initrd)](../initrd.html)) or a filesystem mounted via NFS. The
...
:   This parameter tells the kernel how to configure IP addresses of devices
    ...
    :   Value is exported to /proc/net/ipconfig/ntp\_servers, but is
    ...
    * /proc/net/ipconfig/ntp\_servers:
    ...
    (in /proc/net/ipconfig/ntp\_servers) are requested during autoconfiguration;
    ...
    /proc/net/ipconfig/ntp\_servers to an NTP client before mounting the real
...
:   To specify which file contains the program that starts system
    ...
    found in [Early userspace support](../../driver-api/early-userspace/early_userspace_support.html)
...
* Using pxelinux
  ...
  > see [Linux Serial Console](../serial-console.html) for more information.
  >
  > For more information on isolinux, including how to create bootdisks
  > for prebuilt kernels, see <https://syslinux.zytor.com/>
