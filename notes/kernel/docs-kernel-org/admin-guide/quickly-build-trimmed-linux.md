...
> 출처(원문): https://docs.kernel.org/admin-guide/quickly-build-trimmed-linux.html
...
>   archives](#sources-archive) *and* [a full git clone](#sources-full) *;
...
>   reference section explains](#sources-shallow) *.]*
>
...
> >   to simply not bother with this. [[details](#configmods-debugsymbols)]
> > * Are you running Debian? Then to avoid known problems by performing
> >   additional adjustments explained in the reference section.
> >   [[details](#configmods-distros)].
...
[[back to step-by-step guide](#backup-sbs)]
...
[[back to step-by-step guide](#secureboot-sbs)]
...
[[back to step-by-step guide](#buildrequires-sbs)]
...
reach the [section about configuration adjustments’](#configmods), as
ensuring debug symbols are disabled will reduce the consumed disk space by quite
a few gigabytes.

[[back to step-by-step guide](#diskspace-sbs)]
...
git clone. There is [more to tell about this method](#sources-shallow) and
two alternate ways worth describing: [packaged archives](#sources-archive)
and [a full git clone](#sources-full). And the aspects ‘[wouldn’t it
be wiser to use a proper pre-release than the latest mainline code](#sources-snapshot)’ and ‘[how to get an even fresher mainline codebase](#sources-fresher)’ need elaboration, too.
...
[[back to step-by-step guide](#sources-sbs)]
...
[[back to step-by-step guide](#sources-sbs)] [[back to section intro](#sources)]
...
[[back to step-by-step guide](#patching-sbs)]
...
[[back to step-by-step guide](#tagging-sbs)]

### Define the build configuration for your kernel

> *Create the build configuration for your kernel based on an existing
> configuration.* [[...](#configuration-sbs)]
...
>   in /boot/config-6.0.7-250.fc36.x86\_64’ or ‘using config:
>   ‘/boot/config-6.0.7-250.fc36.x86\_64’ tells you which file they picked. If
...
[[back to step-by-step guide](#configuration-sbs)]
...
failure messages’ in [Tainted kernels](tainted-kernels.html) in more
detail):
...
[[back to step-by-step guide](#configmods-sbs)]

#### Distro specific adjustments

> *Are you running* [[...](#configmods-sbs)]
...
> *Build the image and the modules of your kernel* [[...](#build-sbs)]
...
[[back to step-by-step guide](#build-sbs)]

### Install your kernel

> *Now install your kernel* [[...](#install-sbs)]
...
distribution’s installkernel executable ([see above](#install)) and its
...
[[back to step-by-step guide](#uninstall-sbs)]
...
document, as [described above](#submit-improvements-qbtl).
