...
> 출처(원문): https://docs.kernel.org/admin-guide/nvme-multipath.html
...
:   1. echo -n “round-robin” > /sys/module/nvme\_core/parameters/iopolicy
    2. or add the “nvme\_core.iopolicy=round-robin” to cmdline.
