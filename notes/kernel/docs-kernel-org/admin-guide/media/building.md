...
> 출처(원문): https://docs.kernel.org/admin-guide/media/building.html
...
distribution-specific source file or via the Kernel’s main git tree[[1]](#id2).
...
that receives and/or transmits CEC codes via HDMI interfaces[[3]](#id6).
...
[this table](cx231xx-cardlist.html), with modular media core modules, the
