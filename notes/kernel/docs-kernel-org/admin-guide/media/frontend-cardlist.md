...
> 출처(원문): https://docs.kernel.org/admin-guide/media/frontend-cardlist.html
...
| Driver | Name |
| --- | --- |
| au8522\_dig | Auvitek AU8522 based DTV demod |
| au8522\_decoder | Auvitek AU8522 based ATV demod |
...
| rtl2832\_sdr | Realtek RTL2832 SDR |
...
| Driver | Name |
| --- | --- |
| dvb\_dummy\_fe | Dummy frontend driver |
