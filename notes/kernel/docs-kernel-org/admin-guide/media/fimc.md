...
> 출처(원문): https://docs.kernel.org/admin-guide/media/fimc.html
...
The driver supports Media Controller API as defined at [Part IV - Media Controller API](../../userspace-api/media/mediactl/media-controller.html#media-controller).
...
[Interfaces](../../userspace-api/media/v4l/devices.html#devices).

At the capture and mem-to-mem video nodes only the multi-planar API is
supported. For more details see: [Single- and multi-planar APIs](../../userspace-api/media/v4l/planar-apis.html#planar-apis).
...
device. The entry path is: /sys/platform/devices/s5p-fimc-md/subdev\_conf\_mode.
...
If the driver is built as a loadable kernel module (CONFIG\_VIDEO\_SAMSUNG\_S5P\_FIMC=m)
