...
> 출처(원문): https://docs.kernel.org/admin-guide/media/cec.html
...
* RainShadow Tech. Note: this driver does not support the persistent\_config
...
* Extron DA HD 4K PLUS HDMI Distribution Amplifier. See
  [Extron DA HD 4K PLUS CEC Adapter driver](#extron-da-hd-4k-plus) for more information.
...
The documentation on how to use the error injection is here: [CEC Pin Framework Error Injection](../../userspace-api/media/cec/cec-pin-error-inj.html#cec-pin-error-inj).
