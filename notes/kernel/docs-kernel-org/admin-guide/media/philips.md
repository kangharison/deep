...
> 출처(원문): https://docs.kernel.org/admin-guide/media/philips.html
...
power\_save
:   When power\_save is enabled (set to 1), the module will try to shut down
...
:   A long standing problem with USB devices is their dynamic nature: you
    ...
    * If a camera does not match any dev\_hint, it will simply get assigned
