...
> 출처(원문): https://docs.kernel.org/admin-guide/media/pci-cardlist.html
...
ID equal to `1461:f01d` (see [Saa7134 card list](saa7134-cardlist.html)).
...
| hexium\_gemini | Hexium Gemini frame grabber |
| hexium\_orion | Hexium HV-PCI6 and Orion frame grabber |
