...
> 출처(원문): https://docs.kernel.org/admin-guide/media/ipu6-isys.html
...
configuration. intel\_ipu6\_isys implements V4L2, Media Controller and V4L2
...
See [Intel IPU6 Driver](../../driver-api/media/drivers/ipu6.html) for more
...
media-ctl [[1]](#f1) and yavta [[2]](#f2) to transmit frames to IPU6 ISYS.
