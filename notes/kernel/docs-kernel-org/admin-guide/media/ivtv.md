...
> 출처(원문): https://docs.kernel.org/admin-guide/media/ivtv.html
...
‘ivtv\_first\_minor’ module option can be used for that.
...
* /dev/video32
  ...
  is a 16x16 linear tiled NV12 format (V4L2\_PIX\_FMT\_NV12\_16L16)
