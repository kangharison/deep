...
> 출처(원문): https://docs.kernel.org/admin-guide/media/c3-isp.html
...
video device node using the [V4L2\_META\_FMT\_C3ISP\_PARAMS](../../userspace-api/media/v4l/metafmt-c3-isp.html#v4l2-meta-fmt-c3isp-params) as data format. The buffer structure is defined by
`c3_isp_params_cfg`.

Statistics are captured from the c3-isp-stats video device node using the
[V4L2\_META\_FMT\_C3ISP\_STATS](../../userspace-api/media/v4l/metafmt-c3-isp.html#v4l2-meta-fmt-c3isp-stats) data format.
