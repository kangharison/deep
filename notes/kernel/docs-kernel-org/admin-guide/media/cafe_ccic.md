...
> 출처(원문): https://docs.kernel.org/admin-guide/media/cafe_ccic.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# 7.3. The cafe\_ccic driver

Author: Jonathan Corbet <[corbet@lwn.net](mailto:corbet%40lwn.net)>

## 7.3.1. Introduction

“cafe\_ccic” is a driver for the Marvell 88ALP01 “cafe” CMOS camera
...
> * alloc\_bufs\_at\_load: Normally, the driver will not allocate any DMA
...
> * dma\_buf\_size: The size of DMA buffers to allocate. Note that this
...
>   camera settings.
> * n\_dma\_bufs: The controller can cycle through either two or three DMA
>   buffers. Normally, the driver tries to use three buffers; on faster
>   systems, however, it will work well with only two.
> * min\_buffers: The minimum number of streaming I/O buffers that the driver
...
>   value (like six).
> * max\_buffers: The maximum number of streaming I/O buffers; default is
