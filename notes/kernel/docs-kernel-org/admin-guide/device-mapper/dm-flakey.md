...
> 출처(원문): https://docs.kernel.org/admin-guide/device-mapper/dm-flakey.html
...
> :   > During <down interval>, replace <Nth\_byte> of the data of
...
>         ‘w’ is incompatible with drop\_writes.
>
>     <value>:
>     :   The value (from 0-255) to write.
>
>     <flags>:
>     :   Perform the replacement only if bio->bi\_opf has all the
>         selected flags set.
>
> random\_read\_corrupt <probability>
...
>
> random\_write\_corrupt <probability>
