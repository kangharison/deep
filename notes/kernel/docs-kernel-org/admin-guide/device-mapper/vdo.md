...
> 출처(원문): https://docs.kernel.org/admin-guide/device-mapper/vdo.html
...
The vdo driver has a numeric parameter ‘log\_level’ which controls the
verbosity of logging from the driver. The default setting is 6
(LOGLEVEL\_INFO and more severe messages).
