...
> 출처(원문): https://docs.kernel.org/admin-guide/device-mapper/dm-dust.html
...
“dmsetup status” displays “fail\_read\_on\_bad\_block”), reads of blocks
...
:   <device\_path>:
    ...
    <offset>:
    :   Offset to data area from start of device\_path
...
scsi\_debug has a “medium error” mode that can fail reads on one
