...
> 출처(원문): https://docs.kernel.org/admin-guide/gpio/gpio-mockup.html
...
This module has been obsoleted by the more flexible [Configfs GPIO Simulator](gpio-sim.html).
...
> >
> > Example: gpio\_mockup\_ranges=-1,8,-1,16,405,409
> >
> > The line above creates three chips. The first one will expose 8 lines,
> > the second 16 and the third 4. The base GPIO for the third chip is set
> > to 405 while for two first chips it will be assigned automatically.
>
> gpio\_mockup\_named\_lines
>
