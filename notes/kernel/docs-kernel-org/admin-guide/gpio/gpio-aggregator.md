...
> 출처(원문): https://docs.kernel.org/admin-guide/gpio/gpio-aggregator.html
...
a new gpio\_chip. This supports the following use cases.
...
aggregating them into a new gpio\_chip, which can be assigned to a group or user
...
> >     aggregate to the “new\_device” file, using the format
> >
> >     ```
...
> >     “e6050000.gpio” into a new gpio\_chip:
> >
> >     ```
...
lines, you must use the “delete\_device” interface to tear down the
...
gpio-aggregator driver, or by writing to the “driver\_override” file in Sysfs.
...
2. Binding manually using “driver\_override”:
