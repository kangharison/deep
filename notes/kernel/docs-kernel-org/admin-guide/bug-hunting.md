...
> 출처(원문): https://docs.kernel.org/admin-guide/bug-hunting.html
...
[Tainted kernels](tainted-kernels.html), “being loaded” is
...
3. Use Kdump (see [Documentation for Kdump - The kexec-based Crash Dumping Solution](kdump/kdump.html)),
...
Please do read
[Documentation/process/submitting-patches.rst](../process/submitting-patches.html#submittingpatches) though
