...
> 출처(원문): https://docs.kernel.org/admin-guide/sysctl/index.html
...
‘Why’, I hear you ask, ‘would anyone even \_want\_ documentation
...
But of course, if you \_do\_ manage to screw up your system using
...
| fs/ | specific filesystems filehandle, inode, dentry and quota tuning binfmt\_misc <[Kernel Support for miscellaneous Binary Formats (binfmt\_misc)](../binfmt-misc.html)> |
| kernel/ | global kernel info / tuning miscellaneous stuff some architecture-specific controls security (LSM) stuff |
...
* [Documentation for /proc/sys/abi/](abi.html)
* [/proc/sys/crypto/](crypto.html)
* [/proc/sys/debug/](debug.html)
* [Documentation for /proc/sys/fs/](fs.html)
* [Documentation for /proc/sys/kernel/](kernel.html)
* [Documentation for /proc/sys/net/](net.html)
* [Documentation for /proc/sys/sunrpc/](sunrpc.html)
* [Documentation for /proc/sys/user/](user.html)
* [Documentation for /proc/sys/vm/](vm.html)
* [/proc/sys/xen/](xen.html)
