...
> 출처(원문): https://docs.kernel.org/admin-guide/pnp.html
...
:   use this function to add a PnP device to the PnP layer
    ...
    only call this function when all wanted values are set in the pnp\_dev
    structure
...
2. Optionally define probe and remove functions. It may make sense not to
   ...
   the resources, such as the parport\_pc driver.
