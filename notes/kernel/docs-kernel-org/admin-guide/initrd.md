...
> 출처(원문): https://docs.kernel.org/admin-guide/initrd.html
...
discussion of the boot process can be found in [[1]](#f1).
...
*[pivot\_root(2)](https://man7.org/linux/man-pages/man2/pivot_root.2.html)* man page.
...
can try the experimental newlib environment [[2]](#f2) to create a small
initrd.
...
is also available via the `pivot_root` utility (see *[pivot\_root(8)](https://man7.org/linux/man-pages/man8/pivot_root.8.html)*
man page; `pivot_root` is distributed with util-linux version 2.10h or higher
[[3]](#f3)). `pivot_root` moves the current root to a directory under the new
...
*[pivot\_root(8)](https://man7.org/linux/man-pages/man8/pivot_root.8.html)* man page for details.
...
## Mixed change\_root and pivot\_root mechanism

In case you did not want to use `root=/dev/ram0` to trigger the pivot\_root
