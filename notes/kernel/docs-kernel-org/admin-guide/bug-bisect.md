...
> 출처(원문): https://docs.kernel.org/admin-guide/bug-bisect.html
...
kernel, better follow [How to verify bugs and bisect regressions](verify-bugs-and-bisect-regressions.html)
...
in a safe place (the following example assumes ‘~/prepared\_kernel\_.config’) to
