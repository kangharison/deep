...
> 출처(원문): https://docs.kernel.org/admin-guide/thermal/intel_thermal_throttle.html
...
MSR\_IA32\_THERM\_STATUS for core level and MSR\_IA32\_PACKAGE\_THERM\_STATUS for
package level.
...
It is possible that when user reads MSR\_IA32\_THERM\_STATUS or
MSR\_IA32\_PACKAGE\_THERM\_STATUS, TM1/TM2 is not active. In this case,
...
“/sys/devices/system/cpu/cpuX/thermal\_throttle/”, where “X” is the CPU number.
