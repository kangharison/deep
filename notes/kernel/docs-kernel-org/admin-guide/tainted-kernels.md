...
> 출처(원문): https://docs.kernel.org/admin-guide/tainted-kernels.html
...
>      scsi/snic on something else than x86\_64, scsi/ips on non
>      x86/x86\_64/itanium, have broken firmware settings for the
>      irqchip/irq-gic on arm64 ...).
>    * x86/x86\_64: Microcode late loading is dangerous and will result in
...
> 19. `J` if userspace opened /dev/fwctl/\* and performed a FWTCL\_RPC\_DEBUG\_WRITE
