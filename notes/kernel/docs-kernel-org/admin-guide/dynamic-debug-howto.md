...
> 출처(원문): https://docs.kernel.org/admin-guide/dynamic-debug-howto.html
...
class
:   The given class\_name is validated against each module, which may
    have declared a list of known class\_names. If the class\_name is
...
processed, as part of the early\_initcall. Thus you can enable debug
messages in all code run after this early\_initcall via this boot
parameter.
