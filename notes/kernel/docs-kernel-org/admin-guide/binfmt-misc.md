...
> 출처(원문): https://docs.kernel.org/admin-guide/binfmt-misc.html
...
For java support see [Java(tm) Binary Kernel Support for Linux v1.03](java.html)
...
See [Documentation/admin-guide/java.rst](java.html) for an example.
