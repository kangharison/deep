...
> 출처(원문): https://docs.kernel.org/admin-guide/mm/idle_page_tracking.html
...
It is enabled by CONFIG\_IDLE\_PAGE\_TRACKING=y.
...
See [Examining Process Page Tables](pagemap.html) for more information about
