...
> 출처(원문): https://docs.kernel.org/admin-guide/mm/shrinker_debugfs.html
...
unique id: e.g. *kfree\_rcu-0* or *sb-xfs:vda1-36*.
...
>
> If the shrinker is not memcg-aware or CONFIG\_MEMCG is off, 0 is printed
