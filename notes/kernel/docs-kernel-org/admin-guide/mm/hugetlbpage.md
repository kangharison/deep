...
> 출처(원문): https://docs.kernel.org/admin-guide/mm/hugetlbpage.html
...
First the Linux kernel needs to be built with the CONFIG\_HUGETLBFS
...
:   is the total amount of memory (in kB), consumed by huge
    ...
    will exceed HugePages\_Total \* Hugepagesize. To get more
...
[Using Huge Pages](#using-huge-pages), below.
...
page size may be selected with the “default\_hugepagesz=<size>” boot parameter.
...
:   Specify the number of huge pages to preallocate. This typically
    follows a valid hugepagesz or default\_hugepagesz parameter. However,
...
:   Specify the default huge page size. This parameter can
    only be specified once on the command line. default\_hugepagesz can
...
:   When CONFIG\_HUGETLB\_PAGE\_OPTIMIZE\_VMEMMAP is set, this enables HugeTLB
...
[discussion below](#mem-policy-and-hp-alloc)
...
demote\_size) function as described above for the default huge page-sized case.
...
2. One or more nodes may be specified with the bind or interleave policy.
   ...
   the task is running at the time the nodes\_allowed mask is constructed.
...
migrate\_pages and move\_pages), [`alloc_contig_range()`](../../core-api/mm-api.html#c.alloc_contig_range "alloc_contig_range") and [`alloc_contig_pages()`](../../core-api/mm-api.html#c.alloc_contig_pages "alloc_contig_pages").
...
The size is rounded down to HPAGE\_SIZE boundary.
...
MAP\_HUGETLB. For an example of how to use mmap with MAP\_HUGETLB see
[map\_hugetlb](#map-hugetlb) below.
...
filesystem will be required for using mmap calls without MAP\_HUGETLB.
...
`map_hugetlb`
:   see tools/testing/selftests/mm/map\_hugetlb.c
