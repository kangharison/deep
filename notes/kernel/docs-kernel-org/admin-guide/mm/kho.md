...
> 출처(원문): https://docs.kernel.org/admin-guide/mm/kho.html
...
[concepts](../../core-api/kho/index.html#kho-concepts). If you have not read
...
:   Physical locations of KHO scratch regions. Kexec user space tools
    can use this file in conjunction to scratch\_phys to determine where
