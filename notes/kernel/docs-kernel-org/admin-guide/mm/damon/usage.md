...
> 출처(원문): https://docs.kernel.org/admin-guide/mm/damon/usage.html
...
* *Special-purpose DAMON modules.*
  [This](../../../mm/damon/design.html#damon-modules-special-purpose) is for people who are building,
...
* *sysfs interface.*
  [This](#sysfs-interface) is for privileged user space programmers who
...
* *Kernel Space Programming Interface.*
  [This](../../../mm/damon/api.html) is for kernel space programmers. Using this,
  users can utilize every feature of DAMON most flexibly and efficiently by
  writing kernel space DAMON application programs for you. You can even extend
  DAMON for various address spaces. For detail, please refer to the interface
  [document](../../../mm/damon/api.html).
...
[design](../../../mm/damon/design.html#damon-design-execution-model-and-data-structures) for more
...
* `commit`: Read the user inputs in the sysfs files except `state` file
  again. Monitoring [target region](#sysfs-regions) inputs are also be
...
* `update_tuned_intervals`: Update the contents of `sample_us` and
  ...
  [intervals\_goal section](#damon-usage-sysfs-monitoring-intervals-goal)
  for more details.
* `commit_schemes_quota_goals`: Read the DAMON-based operation schemes’
  [quota goals](#sysfs-schemes-quota-goals).
* `update_schemes_stats`: Update the contents of stats files for each
  DAMON-based operation scheme of the kdamond. For details of the stats,
  please refer to [stats section](#sysfs-schemes-stats).
* `update_schemes_tried_regions`: Update the DAMON-based operation scheme
  ...
  [tried\_regions section](#sysfs-schemes-tried-regions).
...
* `update_schemes_effective_quotas`: Update the contents of
  ...
  kdamond. For more details, refer to [quotas directory](#sysfs-quotas).
...
DAMON supports multiple types of [monitoring operations](../../../mm/damon/design.html#damon-design-configurable-operations-set), including those for virtual address
...
list different available operation sets. Please refer to the [design](../../../mm/damon/design.html#damon-operations-set) for the list of all available operation sets and their
brief explanations.
...
`addr_unit` file is for setting and getting the [address unit](../../../mm/damon/design.html#damon-design-addr-unit) parameter of the operations set.
...
to the Design document ([Design](../../../mm/damon/design.html)).

### contexts/<N>/monitoring\_attrs/intervals/intervals\_goal/
...
Please refer to the [design document of the feature](../../../mm/damon/design.html#damon-design-monitoring-intervals-autotuning) for the internal of the tuning
...
:ref:design doc <damon\_design\_monitoring\_intervals\_autotuning>` with the same
...
monitoring region to specific address ranges. Please refer to the [design](../../../mm/damon/design.html#damon-design-vaddr-target-regions-construction) for more details.
...
`commit` to `state` file of [kdamond](#sysfs-kdamond)), the commit
...
The directory for DAMON-based Operation Schemes ([DAMOS](../../../mm/damon/design.html#damon-design-damos)). Users can get and set the schemes by reading from and
...
The `action` file is for setting and getting the scheme’s [action](../../../mm/damon/design.html#damon-design-damos-action). The keywords that can be written to and read
from the file and their meaning are same to those of the list on
[design doc](../../../mm/damon/design.html#damon-design-damos-action).
...
[apply\_interval](../../../mm/damon/design.html#damon-design-damos) in microseconds.

### schemes/<N>/access\_pattern/

The directory for the target access [pattern](../../../mm/damon/design.html#damon-design-damos-access-pattern) of the given DAMON-based operation scheme.
...
The directory for the [quotas](../../../mm/damon/design.html#damon-design-damos-quotas) of the given
...
quota limits unless at least one [goal](#sysfs-schemes-quota-goals) is
set.
...
[automatic quota tuning goals](../../../mm/damon/design.html#damon-design-damos-quotas-auto-tuning) for
the background design of the feature and the name of the selectable algorithms.
Refer to [goals directory](#sysfs-schemes-quota-goals) for the goals
setup.

The time quota is internally transformed to a size quota. Between the
transformed size quota and user-specified size quota, smaller one is applied.
Based on the user-specified [goal](#sysfs-schemes-quota-goals), the
...
You can set the [prioritization weights](../../../mm/damon/design.html#damon-design-damos-quotas-prioritization) for size, access frequency, and age
in per-thousand unit by writing the values to the three files under the
`weights` directory.

### schemes/<N>/quotas/goals/

The directory for the [automatic quota tuning goals](../../../mm/damon/design.html#damon-design-damos-quotas-auto-tuning) of the given DAMON-based operation
scheme.
...
[design doc](../../../mm/damon/design.html#damon-design-damos-quotas-auto-tuning) by writing to and
reading from each of the files. Note that users should further write
`commit_schemes_quota_goals` to the `state` file of the [kdamond
directory](#sysfs-kdamond) to pass the feedback to DAMON.

### schemes/<N>/watermarks/

The directory for the [watermarks](../../../mm/damon/design.html#damon-design-damos-watermarks) of the
...
> * free\_mem\_rate: System’s free memory rate (per thousand)

The `interval` should written in microseconds unit.

### schemes/<N>/{core\_,ops\_,}filters/

Directories for [filters](../../../mm/damon/design.html#damon-design-damos-filters) of the given
DAMON-based operation scheme.
...
Refer to [the design doc](../../../mm/damon/design.html#damon-design-damos-filters) for available type
...
Refer to the [DAMOS filters design documentation](../../../mm/damon/design.html#damon-design-damos-filters) for more details including how multiple filters
...
online analysis or tuning of the schemes. Refer to [design doc](../../../mm/damon/design.html#damon-design-damos-stat) for more details about the stats.
...
relevant `kdamonds/<N>/state` file. Refer to [kdamond directory](#sysfs-kdamond) for more details.

### schemes/<N>/tried\_regions/
...
this directory, during next [apply interval](../../../mm/damon/design.html#damon-design-damos) of the
...
Users can get the monitoring results via the [tried\_regions](#sysfs-schemes-tried-regions). The interface is useful for getting a
...
Scheme ([DAMOS](../../../mm/damon/design.html#damon-design-damos)) is gonna be applied. Hence,
`damon:damos_before_apply` is more useful for recording internal behavior of
DAMOS, or DAMOS target access
[pattern](../../../mm/damon/design.html#damon-design-damos-access-pattern) based query-like efficient
...
[design](../../../mm/damon/design.html#damon-design-region-based-sampling) for more details of the
counter). Finally the tenth field (`X`) shows the `age` of the region
(refer to [design](../../../mm/damon/design.html#damon-design-age-tracking) for more details of the
counter).
