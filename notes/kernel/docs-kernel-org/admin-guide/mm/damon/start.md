...
> 출처(원문): https://docs.kernel.org/admin-guide/mm/damon/start.html
...
Because DAMO is using the sysfs interface (refer to [Detailed Usages](usage.html) for the
detail) of DAMON, you should ensure [sysfs](../../../filesystems/sysfs.html) is
mounted.
