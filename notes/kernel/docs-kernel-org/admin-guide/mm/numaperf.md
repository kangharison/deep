...
> 출처(원문): https://docs.kernel.org/admin-guide/mm/numaperf.html
...
The “line\_size” is the number of bytes accessed from the next cache
level on a miss.

The “size” is the number of bytes provided by this cache level.

The “write\_policy” will be 0 for write-back, and non-zero for
