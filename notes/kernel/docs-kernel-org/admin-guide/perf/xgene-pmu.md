...
> 출처(원문): https://docs.kernel.org/admin-guide/perf/xgene-pmu.html
...
in sysfs, see /sys/bus/event\_source/devices/<l3cX/iobX/mcbX/mcX>/.

The “format” directory describes format of the config (event ID),
config1 (agent ID) fields of the perf\_event\_attr structure. The “events”
