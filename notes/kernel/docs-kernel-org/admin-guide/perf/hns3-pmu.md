...
> 출처(원문): https://docs.kernel.org/admin-guide/perf/hns3-pmu.html
...
config1 (filter options) fields of the perf\_event\_attr structure.

The “identifier” file shows version of PMU hardware device.

The “bdf\_min” and “bdf\_max” files show the supported bdf range of each
pmu device.

The “hw\_clk\_freq” file shows the hardware clock frequency of each pmu
device.
