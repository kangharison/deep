...
> 출처(원문): https://docs.kernel.org/admin-guide/perf/arm-ccn.html
...
in sysfs, see /sys/bus/event\_source/devices/ccn\*.

The “format” directory describes format of the config, config1
and config2 fields of the perf\_event\_attr structure. The “events”
directory provides configuration templates for all documented
events, that can be used with perf tool. For example “xp\_valid\_flit”
...
“dir” (transmit/receive direction), comparator values (“cmp\_l”
and “cmp\_h”) and “mask”, being index of the comparator mask.

Masks are defined separately from the event description
(due to limited number of the config values) in the “cmp\_mask”
...
request the events on this processor (if not, the perf\_event->cpu value
