...
> 출처(원문): https://docs.kernel.org/admin-guide/perf/dwc_pcie_pmu.html
...
the PMU device name for this Root Port is dwc\_rootport\_13018.

The DWC PCIe PMU driver registers a perf PMU driver, which provides
description of available events and configuration options in sysfs, see
/sys/bus/event\_source/devices/dwc\_rootport\_{sbdf}.

The “format” directory describes format of the config fields of the
perf\_event\_attr structure. The “events” directory provides configuration
templates for all documented events. For example,
“rx\_pcie\_tlp\_data\_payload” is an equivalent of “eventid=0x21,type=0x0”.
...
> PCIe RX Bandwidth = rx\_pcie\_tlp\_data\_payload / Measure\_Time\_Window
> PCIe TX Bandwidth = tx\_pcie\_tlp\_data\_payload / Measure\_Time\_Window
