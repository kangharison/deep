...
> 출처(원문): https://docs.kernel.org/admin-guide/perf/mrvl-pem-pmu.html
...
/sys/bus/event\_source/devices/mrvl\_pcie\_rc\_pmu\_<>/events/
/sys/bus/event\_source/devices/mrvl\_pcie\_rc\_pmu\_<>/format/
