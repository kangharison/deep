...
> 출처(원문): https://docs.kernel.org/admin-guide/perf/thunderx2-pmu.html
...
The thunderx2\_pmu driver registers per-socket perf PMUs for the DMC and
L3C devices. Each PMU can be used to count up to 4 (DMC/L3C) or up to 8
(CCPI2) events simultaneously. The PMUs provide a description of their
available events and configuration options under sysfs, see
/sys/bus/event\_source/devices/uncore\_<l3c\_S/dmc\_S/ccpi2\_S/>; S is the socket id.
