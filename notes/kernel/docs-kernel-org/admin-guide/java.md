...
> 출처(원문): https://docs.kernel.org/admin-guide/java.html
...
2. You have to compile BINFMT\_MISC either as a module or into
...
3. Add the following configuration items to binfmt\_misc
