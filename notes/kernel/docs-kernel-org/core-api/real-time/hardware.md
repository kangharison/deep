...
> 출처(원문): https://docs.kernel.org/core-api/real-time/hardware.html
...
For details, see [User Interface for Resource Control feature (resctrl)](../../filesystems/resctrl.html).
...
threads (such as SCHED\_OTHER), which may then receive no CPU time. This can
