...
> 출처(원문): https://docs.kernel.org/core-api/min_heap.html
...
use min-heaps. Users should not directly call functions with **\_\_min\_heap\_\*()**
...
**\_inline** suffix. For example, **\_\_min\_heap\_init\_inline** and its
corresponding macro wrapper **min\_heap\_init\_inline**. The inline versions allow
...
when CONFIG\_MITIGATION\_RETPOLINE is enabled, as indirect function calls become
...
**MIN\_HEAP\_PREALLOCATED** and **DEFINE\_MIN\_HEAP** macros. These macros allow
...
heap storage using **MIN\_HEAP\_PREALLOCATED**.
...
**Inline Version:** min\_heap\_init\_inline(heap, data, size)
...
**Inline Version:** min\_heap\_peek\_inline(heap)
...
**Inline Version:** min\_heap\_push\_inline(heap, element, callbacks, args)
...
**Inline Version:** min\_heap\_pop\_inline(heap, callbacks, args)
...
**Inline Version:** min\_heap\_sift\_down\_inline(heap, pos, callbacks, args)
...
**Inline Version:** min\_heap\_sift\_up\_inline(heap, idx, callbacks, args)
...
**Inline Version:** min\_heapify\_all\_inline(heap, callbacks, args)
...
**Inline Version:** min\_heap\_del\_inline(heap, idx, callbacks, args)

## Other Utilities

* **min\_heap\_full(heap)**: Checks whether the heap is full.
  Complexity: **O(1)**.
...
**Inline Version:** min\_heap\_full\_inline(heap)

* **min\_heap\_empty(heap)**: Checks whether the heap is empty.
  Complexity: **O(1)**.
...
**Inline Version:** min\_heap\_empty\_inline(heap)
