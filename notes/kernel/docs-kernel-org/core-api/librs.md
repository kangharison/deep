...
> 출처(원문): https://docs.kernel.org/core-api/librs.html
...
struct [rs\_control](#c.rs_control "rs_control") \*init\_rs(int symsize, int gfpoly, int fcr, int prim, int nroots)
...
void free\_rs(struct [rs\_control](#c.rs_control "rs_control") \*rs)
...
struct [rs\_control](#c.rs_control "rs_control") \*init\_rs\_gfp(int symsize, int gfpoly, int fcr, int prim, int nroots, gfp\_t gfp)
:   Create a RS control `struct and` initialize it
...
struct [rs\_control](#c.rs_control "rs_control") \*init\_rs\_non\_canonical(int symsize, int (\*gffunc)(int), int fcr, int prim, int nroots)
...
int encode\_rs8(struct [rs\_control](#c.rs_control "rs_control") \*rsc, uint8\_t \*data, int len, uint16\_t \*par, uint16\_t invmsk)
...
int decode\_rs8(struct [rs\_control](#c.rs_control "rs_control") \*rsc, uint8\_t \*data, uint16\_t \*par, int len, uint16\_t \*s, int no\_eras, int \*eras\_pos, uint16\_t invmsk, uint16\_t \*corr)
...
The rs\_control struct **rsc** contains buffers which are used for
...
int encode\_rs16(struct [rs\_control](#c.rs_control "rs_control") \*rsc, uint16\_t \*data, int len, uint16\_t \*par, uint16\_t invmsk)
...
int decode\_rs16(struct [rs\_control](#c.rs_control "rs_control") \*rsc, uint16\_t \*data, uint16\_t \*par, int len, uint16\_t \*s, int no\_eras, int \*eras\_pos, uint16\_t invmsk, uint16\_t \*corr)
