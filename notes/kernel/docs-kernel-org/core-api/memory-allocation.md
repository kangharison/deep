...
> 출처(원문): https://docs.kernel.org/core-api/memory-allocation.html
...
For large allocations you can use [`vmalloc()`](mm-api.html#c.vmalloc "vmalloc") and [`vzalloc()`](mm-api.html#c.vzalloc "vzalloc"), or directly
