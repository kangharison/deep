...
> 출처(원문): https://docs.kernel.org/core-api/union_find.html
...
Linux’s union-find implementation resides in the file “lib/union\_find.c”.
To use it, “#include <linux/union\_find.h>”.
