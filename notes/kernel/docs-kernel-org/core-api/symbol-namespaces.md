...
> 출처(원문): https://docs.kernel.org/core-api/symbol-namespaces.html
...
documentation purposes (think of the SUBSYSTEM\_DEBUG namespace) as well as for
...
changing the way EXPORT\_SYMBOL and friends are instrumented to create ksymtab
entries.

### Using the EXPORT\_SYMBOL macros
...
### Using the DEFAULT\_SYMBOL\_NAMESPACE define

Defining namespaces for all symbols of a subsystem can be very verbose and may
become hard to maintain. Therefore a default define (DEFAULT\_SYMBOL\_NAMESPACE)
...
export all symbols defined in usb-common into the namespace USB\_COMMON, add a
...
### Using the EXPORT\_SYMBOL\_FOR\_MODULES() macro
...
load the module. The module code is required to use the macro MODULE\_IMPORT\_NS
for the namespaces it uses symbols from. E.g. a module using the
usb\_stor\_suspend symbol from above, needs to import the namespace USB\_STORAGE
...
option is available: Setting MODULE\_ALLOW\_MISSING\_NAMESPACE\_IMPORTS=y will
enable loading regardless, but will emit a warning.

## Automatically creating MODULE\_IMPORT\_NS statements
