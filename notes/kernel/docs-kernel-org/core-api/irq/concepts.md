...
> 출처(원문): https://docs.kernel.org/core-api/irq/concepts.html
...
interrupt source. Typically, this is an index into the global irq\_desc
array or sparse\_irqs tree. But except for what linux/interrupt.h
