...
> 출처(원문): https://docs.kernel.org/dev-tools/kunit/running_tips.html
...
documented in [Using gcov with the Linux kernel](../gcov.html).
...
See [Using gcov with the Linux kernel](../gcov.html) for details on how to do this.
...
module\_param `kunit.action=list_attr`.
...
“slow”, or “very\_slow”. The assumed default speed for tests is “normal”. This
...
this could be marked as “slow” or “very\_slow”.
