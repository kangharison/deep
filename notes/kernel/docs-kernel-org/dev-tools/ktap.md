...
> 출처(원문): https://docs.kernel.org/dev-tools/ktap.html
...
by a number of projects. Its website and specification are found at this [link](https://testanything.org/). The Linux Kernel largely uses TAP output for test
...
The test “test\_case\_name” passed.

```
not ok 1 test_case_name
```

The test “test\_case\_name” failed.
...
Diagnostic lines are formatted as “# <diagnostic\_description>”, where the
...
A single test called “main\_test”, which fails, and has three subtests:

* “example\_test\_1”, which passes, and has one subtest:

  > + “test\_1”, which passes, and outputs the diagnostic message “test\_1: initializing test\_1”
* “example\_test\_2”, which passes, and has two subtests:

  > + “test\_1”, which is skipped, with the explanation “test\_1 skipped”
  > + “test\_2”, which passes
* “example\_test\_3”, which fails, and has three subtests

  > + “test\_1”, which passes
  > + “test\_2”, which outputs the diagnostic line “test\_2: FAIL”, and fails.
  > + “test\_3”, which is skipped with the explanation “test\_3 skipped”
...
makes sense for a test to be marked skipped if \_all\_ of its subtests have been
skipped).
