...
> 출처(원문): https://docs.kernel.org/dev-tools/kmsan.html
...
Now configure and build the kernel with CONFIG\_KMSAN enabled.
...
function in the file or directory. Most users won’t need KMSAN\_SANITIZE, unless
...
The runtime library only supports x86\_64 at the moment.
...
Every task\_struct has an associated KMSAN task state that holds the KMSAN
