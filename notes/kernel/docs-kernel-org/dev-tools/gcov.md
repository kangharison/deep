...
> 출처(원문): https://docs.kernel.org/dev-tools/gcov.html
...
## Appendix A: gather\_on\_build.sh

Sample script to gather coverage meta files on the build machine
(see [Separated build and test machines a.](#gcov-test)):
...
## Appendix B: gather\_on\_test.sh

Sample script to gather coverage data files on the test machine
(see [Separated build and test machines b.](#gcov-build)):
