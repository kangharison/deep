# Familynl80211netlink specification

> 출처(원문): https://docs.kernel.org/netlink/specs/nl80211.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# [Family `nl80211` netlink specification](#id8)
...
attribute-set:
:   [nl80211-attrs](#nl80211-attribute-set-nl80211-attrs)
...
nested-attributes:
:   [wiphy-bands](#nl80211-attribute-set-wiphy-bands)
...
nested-attributes:
:   [supported-iftypes](#nl80211-attribute-set-supported-iftypes)
...
enum:
:   [channel-type](#nl80211-definition-channel-type)
...
enum:
:   [commands](#nl80211-definition-commands)
...
struct:
:   [sta-flag-update](#nl80211-definition-sta-flag-update)
...
nested-attributes:
:   [iftype-attrs](#nl80211-attribute-set-iftype-attrs)
...
nested-attributes:
:   [wowlan-triggers-attrs](#nl80211-attribute-set-wowlan-triggers-attrs)
...
nested-attributes:
:   [if-combination-attributes](#nl80211-attribute-set-if-combination-attributes)
...
enum:
:   [feature-flags](#nl80211-definition-feature-flags)
...
enum:
:   [protocol-features](#nl80211-definition-protocol-features)
...
nested-attributes:
:   [txq-stats-attrs](#nl80211-attribute-set-txq-stats-attrs)
...
nested-attributes:
:   [sar-attributes](#nl80211-attribute-set-sar-attributes)
...
nested-attributes:
:   [band-attrs](#nl80211-attribute-set-band-attrs)
...
nested-attributes:
:   [frequency-attrs](#nl80211-attribute-set-frequency-attrs)
...
nested-attributes:
:   [bitrate-attrs](#nl80211-attribute-set-bitrate-attrs)
...
nested-attributes:
:   [iftype-data-attrs](#nl80211-attribute-set-iftype-data-attrs)
...
nested-attributes:
:   [wmm-attrs](#nl80211-attribute-set-wmm-attrs)
...
### [if-combination-attributes](#id28)
...
nested-attributes:
:   [iface-limit-attributes](#nl80211-attribute-set-iface-limit-attributes)
...
nested-attributes:
:   [frame-type-attrs](#nl80211-attribute-set-frame-type-attrs)
...
nested-attributes:
:   [sar-specs](#nl80211-attribute-set-sar-specs)
