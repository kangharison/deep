# Familynet-shapernetlink specification

> 출처(원문): https://docs.kernel.org/netlink/specs/net_shaper.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# [Family `net-shaper` netlink specification](#id4)
...
attribute-set:
:   [net-shaper](#net-shaper-attribute-set-net-shaper)
...
do:
:   **pre**
    :   net-shaper-nl-pre-doit-write

    **post**
    :   net-shaper-nl-post-doit-write
...
attribute-set:
:   [caps](#net-shaper-attribute-set-caps)
...
nested-attributes:
:   [handle](#net-shaper-attribute-set-handle)
...
enum:
:   [metric](#net-shaper-definition-metric)
...
nested-attributes:
:   [leaf-info](#net-shaper-attribute-set-leaf-info)
...
enum:
:   [scope](#net-shaper-definition-scope)
