...
> 출처(원문): https://docs.kernel.org/i2c/instantiating-devices.html
...
which is currently located at [ACPI Based Device Enumeration](../firmware-guide/acpi/enumeration.html).
...
[`struct i2c_board_info`](../driver-api/i2c.html#c.i2c_board_info "i2c_board_info") which is registered by calling
[`i2c_register_board_info()`](../driver-api/i2c.html#c.i2c_register_board_info "i2c_register_board_info").
...
a [`struct i2c_board_info`](../driver-api/i2c.html#c.i2c_board_info "i2c_board_info") and calling [`i2c_new_client_device()`](../driver-api/i2c.html#c.i2c_new_client_device "i2c_new_client_device").
...
`i2c_new_scanned_device()` instead of [`i2c_new_client_device()`](../driver-api/i2c.html#c.i2c_new_client_device "i2c_new_client_device").
...
it on cleanup. This is done by calling [`i2c_unregister_device()`](../driver-api/i2c.html#c.i2c_unregister_device "i2c_unregister_device") on the
pointer that was earlier returned by [`i2c_new_client_device()`](../driver-api/i2c.html#c.i2c_new_client_device "i2c_new_client_device") or
...
Example:
See lm90\_driver and `lm90_detect()` in drivers/hwmon/lm90.c
...
This interface is a replacement for the force\_\* module parameters some I2C
