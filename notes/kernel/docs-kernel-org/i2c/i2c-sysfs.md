...
> 출처(원문): https://docs.kernel.org/i2c/i2c-sysfs.html
...
[Naming and data format standards for sysfs files](../hwmon/sysfs-interface.html)

### Instantiate I2C Devices in I2C Sysfs

Refer to section “Method 4: Instantiate from user-space” of [How to instantiate I2C devices](instantiating-devices.html)
