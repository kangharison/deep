...
> 출처(원문): https://docs.kernel.org/i2c/muxes/i2c-mux-gpio.html
...
platform_device` with the platform\_data pointing to a `struct
i2c_mux_gpio_platform_data` with the I2C adapter number of the master
bus, the number of bus segments to create and the GPIO pins used
to control it. See include/linux/platform\_data/i2c-mux-gpio.h for details.
...
you can instead provide a chip name (.chip\_name) and relative GPIO pin
...
pass PLATFORM\_DEVID\_AUTO as the device ID, and the platform core will
