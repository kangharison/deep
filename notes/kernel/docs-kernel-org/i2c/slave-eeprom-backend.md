...
> 출처(원문): https://docs.kernel.org/i2c/slave-eeprom-backend.html
...
:   # echo slave-24c02 0x1064 > /sys/bus/i2c/devices/i2c-1/new\_device

24c512, read-only, address 0x42:
:   # echo slave-24c512ro 0x1042 > /sys/bus/i2c/devices/i2c-1/new\_device
