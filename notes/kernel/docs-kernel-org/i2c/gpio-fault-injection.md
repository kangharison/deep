...
> 출처(원문): https://docs.kernel.org/i2c/gpio-fault-injection.html
...
Once the Kconfig option I2C\_GPIO\_FAULT\_INJECTOR is enabled, there will be an
