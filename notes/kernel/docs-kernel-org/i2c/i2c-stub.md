...
> 출처(원문): https://docs.kernel.org/i2c/i2c-stub.html
...
:   Functionality override, to disable some commands. See I2C\_FUNC\_\*
    constants in <linux/i2c.h> for the suitable values. For example,
    value 0x1f0000 would only enable the quick, byte and byte data
    commands.

u8 bank\_reg[10], u8 bank\_mask[10], u8 bank\_start[10], u8 bank\_end[10]:
