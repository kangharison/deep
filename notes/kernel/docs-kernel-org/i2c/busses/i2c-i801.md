...
> 출처(원문): https://docs.kernel.org/i2c/busses/i2c-i801.html
...
function asus\_hides\_smbus\_hostbridge.) If the SMBus device is missing,
...
names for the bridge ID and the subvendor ID in include/linux/pci\_ids.h,
...
Note: There’s a useful script in lm\_sensors 2.10.2 and later, named
unhide\_ICH\_SMBus (in prog/hotplug), which uses the fakephp driver to
...
The lm\_sensors project gratefully acknowledges the support of Texas
Instruments in the initial development of this driver.

The lm\_sensors project gratefully acknowledges the support of Intel in the
