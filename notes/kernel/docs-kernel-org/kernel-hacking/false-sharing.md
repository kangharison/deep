...
> 출처(원문): https://docs.kernel.org/kernel-hacking/false-sharing.html
...
academic definition for it is in [[1]](#id4). Consider a `struct with` a
...
Member ‘refcount’(A) and ‘name’(B) \_share\_ one cache line like below:
...
false sharing. One of these is a rw\_semaphore ‘mmap\_lock’ inside
mm\_struct struct, whose cache line layout change triggered a
regression and Linus analyzed in [[2]](#id5).
...
When running above during testing will-it-scale’s tlb\_flush1 case,
...
A nice introduction for perf-c2c is [[3]](#id6).
...
* Separate hot global data in its own dedicated cache line, even if it
  ...
  + [Commit 91b6d3256356](https://git.kernel.org/torvalds/c/91b6d3256356) (“net: cache align tcp\_memory\_allocated, tcp\_sockets\_allocated”)
* Reorganize the data structure, separate the interfering members to
  different cache lines. One downside is it may introduce new false
  sharing of other members.

  + [Commit 802f1d522d5f](https://git.kernel.org/torvalds/c/802f1d522d5f) (“mm: page\_counter: re-layout structure to reduce false sharing”)
* Replace ‘write’ with ‘read’ when possible, especially in loops.
  ...
  instead of directly “set\_bit(XXX);”, similarly for atomic\_t data:
  ...
  + [Commit 292648ac5cf1](https://git.kernel.org/torvalds/c/292648ac5cf1) (“mm: gup: allow FOLL\_PIN to scale in SMP”)
* Turn hot global data to ‘per-cpu data + global data’ when possible,
  or reasonably increase the threshold for syncing per-cpu data to
  global data, to reduce or postpone the ‘write’ to that global data.

  + [Commit 520f897a3554](https://git.kernel.org/torvalds/c/520f897a3554) (“ext4: use percpu\_counters for extent\_status cache hits/misses”)
  + [Commit 56f3547bfa4d](https://git.kernel.org/torvalds/c/56f3547bfa4d) (“mm: adjust vm\_committed\_as\_batch according to vm overcommit policy”)
