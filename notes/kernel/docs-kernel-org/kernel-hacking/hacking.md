...
> 출처(원문): https://docs.kernel.org/kernel-hacking/hacking.html
...
[bottom half lock](#local-bh-disable) is held.
...
[`printk()`](../core-api/printk-basics.html#c.printk "printk") feeds kernel messages to the console, dmesg, and
...
[`printk()`](../core-api/printk-basics.html#c.printk "printk") internally uses a 1K buffer and does not catch
...
[`put_user()`](../core-api/mm-api.html#c.put_user "put_user") and [`get_user()`](../core-api/mm-api.html#c.get_user "get_user") are used to get
...
Unlike [`put_user()`](../core-api/mm-api.html#c.put_user "put_user") and [`get_user()`](../core-api/mm-api.html#c.get_user "get_user"), they
...
[`kmalloc()`](../core-api/mm-api.html#c.kmalloc "kmalloc") takes an extra flag word. Important values:
...
[`vmalloc()`](../core-api/mm-api.html#c.vmalloc "vmalloc"). It’ll allocate virtual memory in the kernel
...
The [`udelay()`](../timers/delay_sleep_functions.html#c.udelay "udelay") and [`ndelay()`](../timers/delay_sleep_functions.html#c.ndelay "ndelay") functions can be
used for small pauses. Do not use large values with them as you risk
overflow - the helper function [`mdelay()`](../timers/delay_sleep_functions.html#c.mdelay "mdelay") is useful here, or
consider [`msleep()`](../timers/delay_sleep_functions.html#c.msleep "msleep").
...
### \_\_initcall()/module\_init()

Defined in `include/linux/init.h` / `include/linux/module.h`

Many parts of the kernel are well served as a module
(dynamically-loadable parts of the kernel). Using the
[`module_init()`](../driver-api/basics.html#c.module_init "module_init") and [`module_exit()`](../driver-api/basics.html#c.module_exit "module_exit") macros it
is easy to write code without #ifdefs which can operate both as a module
or built into the kernel.

The [`module_init()`](../driver-api/basics.html#c.module_init "module_init") macro defines which function is to be
...
[`module_init()`](../driver-api/basics.html#c.module_init "module_init") macro becomes equivalent to
...
[`try_module_get()`](../driver-api/basics.html#c.try_module_get "try_module_get") on that module: if it fails, then the
module is being removed and you should act as if it wasn’t there.
Otherwise, you can safely enter the module, and call
[`module_put()`](../driver-api/basics.html#c.module_put "module_put") when you’re finished.
...
macro to do this: [`wait_event_interruptible()`](../driver-api/basics.html#c.wait_event_interruptible "wait_event_interruptible")
...
[`wait_event()`](../driver-api/basics.html#c.wait_event "wait_event") version ignores signals.
...
[`atomic_read()`](../driver-api/basics.html#c.atomic_read "atomic_read") and [`atomic_set()`](../driver-api/basics.html#c.atomic_set "atomic_set") get and set
the counter, [`atomic_add()`](../driver-api/basics.html#c.atomic_add "atomic_add"), [`atomic_sub()`](../driver-api/basics.html#c.atomic_sub "atomic_sub"),
[`atomic_inc()`](../driver-api/basics.html#c.atomic_inc "atomic_inc"), [`atomic_dec()`](../driver-api/basics.html#c.atomic_dec "atomic_dec"), and
[`atomic_dec_and_test()`](../driver-api/basics.html#c.atomic_dec_and_test "atomic_dec_and_test") (returns true if it was
decremented to zero).
...
number: 0 is the least significant bit. [`set_bit()`](../core-api/kernel-api.html#c.set_bit "set_bit"),
[`clear_bit()`](../core-api/kernel-api.html#c.clear_bit "clear_bit") and [`change_bit()`](../core-api/kernel-api.html#c.change_bit "change_bit") set, clear,
and flip the given bit. [`test_and_set_bit()`](../core-api/kernel-api.html#c.test_and_set_bit "test_and_set_bit"),
[`test_and_clear_bit()`](../core-api/kernel-api.html#c.test_and_clear_bit "test_and_clear_bit") and
[`test_and_change_bit()`](../core-api/kernel-api.html#c.test_and_change_bit "test_and_change_bit") do the same thing, except return
...
In particular, [`list_for_each_entry()`](../core-api/list.html#c.list_for_each_entry "list_for_each_entry") is useful.
...
Using [`ERR_PTR()`](../core-api/kernel-api.html#c.ERR_PTR "ERR_PTR") (`include/linux/err.h`) to encode a
negative error number into a pointer, and [`IS_ERR()`](../core-api/kernel-api.html#c.IS_ERR "IS_ERR") and
[`PTR_ERR()`](../core-api/kernel-api.html#c.PTR_ERR "PTR_ERR") to get it back out again: avoids a separate
...
* Usually you want a configuration option for your kernel hack. Edit
  ...
  [Kconfig Language](../kbuild/kconfig-language.html).
...
* Edit the `Makefile`: the CONFIG variables are exported here so you
  ...
  is documented in [Linux Kernel Makefiles](../kbuild/makefiles.html).
...
for giving me a great summary of [`disable_irq()`](../core-api/genericirq.html#c.disable_irq "disable_irq"), and Jes
