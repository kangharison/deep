...
> 출처(원문): https://docs.kernel.org/accounting/delay-accounting.html
...
counter (say cpu\_delay\_total) for a task will give the delay
...
been done. Alternatively, use sysctl kernel.task\_delayacct to switch the state
...
Note: PSI support requires CONFIG\_PSI=y and psi=1 for full functionality.
