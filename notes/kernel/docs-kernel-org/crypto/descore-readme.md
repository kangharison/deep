...
> 출처(원문): https://docs.kernel.org/crypto/descore-readme.html
...
>   > in full gory detail (ALT\_ECB is a libdes variant):
>   >
>   > | compiler | machine | desCore libdes | ALT\_ECB slower by |
>   > | --- | --- | --- | --- |
...
2. if your machine has less than 12 32-bit registers i doubt your compiler will
   ...
   des\_keymap, i.e., now the sbox # is the high part of the index and
