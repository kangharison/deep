...
> 출처(원문): https://docs.kernel.org/maintainer/maintainer-entry-profile.html
...
* [LIBNVDIMM Maintainer Entry Profile](../nvdimm/maintainer-entry-profile.html)
* [arch/riscv maintenance guidelines for developers](../arch/riscv/patch-acceptance.html)
* [2. SoC Subsystem](../process/maintainer-soc.html)
* [3. SoC Platforms with DTS Compliance Requirements](../process/maintainer-soc-clean-dts.html)
* [1. Media Subsystem Profile](../driver-api/media/maintainer-entry-profile.html)
* [1. Networking subsystem (netdev)](../process/maintainer-netdev.html)
* [Acceptance criteria for vfio-pci device specific driver variants](../driver-api/vfio-pci-device-specific-driver-acceptance.html)
* [1. Linux NVMe feature and quirk policy](../nvme/feature-and-quirk-policy.html)
* [NFSD Maintainer Entry Profile](../filesystems/nfs/nfsd-maintainer-entry-profile.html)
* [2. XFS Maintainer Entry Profile](../filesystems/xfs/xfs-maintainer-entry-profile.html)
* [DAMON Maintainer Entry Profile](../mm/damon/maintainer-profile.html)
