...
> 출처(원문): https://docs.kernel.org/filesystems/hpfs.html
...
uid=xxx,gid=xxx,umask=xxx (default uid=gid=0 umask=default\_system\_umask)
...
uid=luser\_uid, the file will be still owned by root! If you chmod file to 444,
...
| 1.98 | Fixed a deadlock when using old\_readdir Better directory handling; workaround for “unbalanced tree” bug in OS/2 |
