...
> 출처(원문): https://docs.kernel.org/filesystems/ext4/atomic_writes.html
...
See [Hardware Support](#atomic-write-bdev-support) for more details.
...
* [Bigalloc](bigalloc.html) - Documentation on the bigalloc feature
* [Block and Inode Allocation Policy](allocators.html) - Documentation on block allocation in ext4
