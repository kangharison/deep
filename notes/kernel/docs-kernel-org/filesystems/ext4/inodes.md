...
> 출처(원문): https://docs.kernel.org/filesystems/ext4/inodes.html
...
| --- | --- | --- | --- |
| 0x0 | \_\_le16 | i\_mode | File mode. See the table [i\_mode](#i-mode) below. |
...
| 0x20 | \_\_le32 | i\_flags | Inode flags. See the table [i\_flags](#i-flags) below. |
| 0x24 | 4 bytes | i\_osd1 | See the table [i\_osd1](#i-osd1) for more details. |
...
| 0x74 | 12 bytes | i\_osd2 | See the table [i\_osd2](#i-osd2) for more details. |
