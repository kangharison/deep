...
> 출처(원문): https://docs.kernel.org/filesystems/ext4/directory.html
...
| 0x7 | \_\_u8 | file\_type | File type code, see [ftype](#ftype) table below. |
| 0x8 | char | name[EXT4\_NAME\_LEN] | File name. |
...
| 0x1C | u8 | `struct dx_root_info`.hash\_version | Hash type, see [dirhash](#dirhash) table below. |
