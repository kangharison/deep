...
> 출처(원문): https://docs.kernel.org/filesystems/nfs/rpc-server-gss.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# rpcsec\_gss support for kernel RPC servers
...
The gss\_proxy RPC protocol is currently documented [here](https://fedorahosted.org/gss-proxy/wiki/ProtocolDocumentation).
