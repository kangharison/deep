...
> 출처(원문): https://docs.kernel.org/filesystems/automount-support.html
...
See section “Mount Traps” of [autofs - how it works](autofs.html)
...
>    hung.
> 2. When a new mountpoint is created in the ->d\_automount method, add
>    the mnt to the list using [`mnt_set_expiry()`](api-summary.html#c.mnt_set_expiry "mnt_set_expiry"):
>
>    ```
...
rootfs for example). It does this by passing the MNT\_EXPIRE flag to
`umount()`. This flag is considered incompatible with MNT\_FORCE and MNT\_DETACH.
