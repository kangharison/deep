...
> 출처(원문): https://docs.kernel.org/filesystems/mmap_prepare.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# mmap\_prepare callback HOWTO
...
hook, which itself should be set by the >mmap\_prepare hook.
...
* `vma_desc_test_any(desc, ...)` - Specify a comma-separated list of flags
  you wish to test for (whether \_any\_ are set), e.g. - `vma_desc_test_any(
...
* [`mmap_action_remap()`](../core-api/mm-api.html#c.mmap_action_remap "mmap_action_remap") - Remaps a range consisting only of PFNs for a specific
  range starting a virtual address and PFN number of a set size.
* [`mmap_action_remap_full()`](../core-api/mm-api.html#c.mmap_action_remap_full "mmap_action_remap_full") - Same as [`mmap_action_remap()`](../core-api/mm-api.html#c.mmap_action_remap "mmap_action_remap"), only remaps the
  entire mapping from `start_pfn` onward.
* [`mmap_action_ioremap()`](../core-api/mm-api.html#c.mmap_action_ioremap "mmap_action_ioremap") - Same as [`mmap_action_remap()`](../core-api/mm-api.html#c.mmap_action_remap "mmap_action_remap"), only performs an I/O
  remap.
* [`mmap_action_ioremap_full()`](../core-api/mm-api.html#c.mmap_action_ioremap_full "mmap_action_ioremap_full") - Same as [`mmap_action_ioremap()`](../core-api/mm-api.html#c.mmap_action_ioremap "mmap_action_ioremap"), only remaps
  the entire mapping from `start_pfn` onward.
* [`mmap_action_simple_ioremap()`](../core-api/mm-api.html#c.mmap_action_simple_ioremap "mmap_action_simple_ioremap") - Sets up an I/O remap from a specified
  physical address and over a specified length.
* [`mmap_action_map_kernel_pages()`](../core-api/mm-api.html#c.mmap_action_map_kernel_pages "mmap_action_map_kernel_pages") - Maps a specified array of `struct page`
  pointers in the VMA from a specific offset.
* [`mmap_action_map_kernel_pages_full()`](../core-api/mm-api.html#c.mmap_action_map_kernel_pages_full "mmap_action_map_kernel_pages_full") - Maps a specified array of `struct
