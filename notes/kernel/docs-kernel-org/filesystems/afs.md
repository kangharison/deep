...
> 출처(원문): https://docs.kernel.org/filesystems/afs.html
...
The first module is the AF\_RXRPC network protocol driver. This provides the
RxRPC remote operation protocol and may also be accessed from userspace. See:

> [RxRPC Network Protocol](../networking/rxrpc.html)
...
passed to a process that doesn’t have that key (perhaps over an AF\_UNIX
...
“<arch>\_linux\_26”, amd64 being the name for x86\_64.
