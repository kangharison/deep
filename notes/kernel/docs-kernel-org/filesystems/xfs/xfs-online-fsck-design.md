...
> 출처(원문): https://docs.kernel.org/filesystems/xfs/xfs-online-fsck-design.html
...
## [4.1. 1. What is a Filesystem Check?](#id4)
...
### [4.1.1. TLDR; Show Me the Code!](#id5)
...
This allocation of responsibilities will be [revisited](#scrubcheck)
later in this document.

### [4.2.3. Steps for Each Scrub Item](#id11)
...
#### [4.2.4.2. Secondary Metadata](#id14)
...
#### [4.2.4.3. Summary Information](#id15)
...
### [4.3.1. Integrated Testing with fstests](#id18)
...
### [4.3.2. General Fuzz Testing of Metadata Blocks](#id19)
...
### [4.3.3. Targeted Fuzz Testing of Metadata Records](#id20)
...
(as of systemd 249) to ensure that the xfs\_scrub processes have as little
...
## [4.5. 5. Kernel Algorithms and Data Structures](#id26)
...
### [4.5.1. Self Describing Metadata](#id27)
...
[XFS Self Describing Metadata](xfs-self-describing-metadata.html)

### [4.5.2. Reverse Mapping](#id28)
...
### [4.5.3. Checking and Cross-Referencing](#id29)
...
#### [4.5.3.1. Metadata Buffer Verification](#id30)
...
#### [4.5.3.2. Internal Consistency Checks](#id31)
...
#### [4.5.3.3. Validation of Userspace-Controlled Record Attributes](#id32)
...
#### [4.5.3.4. Cross-Referencing Space Metadata](#id33)
...
#### [4.5.3.5. Checking Extended Attributes](#id34)
...
#### [4.5.3.6. Checking and Cross-Referencing Directories](#id35)
...
Checking operations involving [parents](#dirparent) and
[file link counts](#nlinks) are discussed in more detail in later
sections.

##### [4.5.3.6.1. Checking Directory/Attribute Btrees](#id36)
...
#### [4.5.3.7. Cross-Referencing Summary Counters](#id37)
...
[more detail](#fscounters) later.

[Quota usage](#quotacheck) and [file link count](#nlinks)
checking are sufficiently complicated to warrant separate sections.

#### [4.5.3.8. Post-Repair Reverification](#id38)
...
### [4.5.4. Eventual Consistency vs. Online Fsck](#id39)
...
[next section](#chain-coordination), and details about the solution
are presented [after that](#intent-drains).

#### [4.5.4.1. Discovery of the Problem](#id40)
...
#### [4.5.4.3. Static Keys (aka Jump Label Patching)](#id42)
...
filesystem operations when xfs\_scrub is not running, the intended usage
...
[Static Keys](../../staging/static-keys.html).

### [4.5.5. Pageable Kernel Memory](#id43)
...
#### [4.5.5.1. xfile Access Models](#id44)
...
The fifth use case is discussed in the [realtime summary](#rtsummary) case
study.
...
[sorting](#xfarray-sort) algorithms and the [in-memory
btrees](#xfbtree).

#### [4.5.5.2. xfile Access Coordination](#id45)
...
#### [4.5.5.3. Arrays of Fixed-Sized Records](#id46)
...
##### [4.5.5.3.1. Array Access Patterns](#id47)
...
##### [4.5.5.3.2. Iterating Array Elements](#id48)
...
##### [4.5.5.3.3. Sorting Array Elements](#id49)
...
###### [4.5.5.3.3.1. Case Study: Sorting xfarrays](#id50)
...
#### [4.5.5.5. In-Memory B+Trees](#id52)

The chapter about [secondary metadata](#secondary-metadata) mentioned that
...
Recall that the [xfile](#xfile) abstraction represents memory pages as a
...
##### [4.5.5.5.1. Using xfiles as a Buffer Cache Target](#id53)
...
##### [4.5.5.5.2. Space Management with an xfbtree](#id54)
...
##### [4.5.5.5.3. Populating an xfbtree](#id55)
...
5. Pass the btree cursor to the regular btree functions to make queries against
   ...
   See the [next section](#xfbtree-commit) for information on dealing with
...
##### [4.5.5.5.4. Committing Logged xfbtree Buffers](#id56)
...
### [4.5.6. Bulk Loading of Ondisk B+Trees](#id57)
...
#### [4.5.6.1. Geometry Computation](#id58)
...
#### [4.5.6.2. Reserving New B+Tree Blocks](#id59)
...
next section and the section about [reaping](#reaping) for more details.

#### [4.5.6.3. Writing the New Tree](#id60)
...
subsequent [section](#reaping) after a few case studies of bulk loading.

##### [4.5.6.3.1. Case Study: Rebuilding the Inode Index](#id61)
...
##### [4.5.6.3.2. Case Study: Rebuilding the Space Reference Counts](#id62)
...
[xfarray access patterns](#xfarray-access-patterns) section.
...
##### [4.5.6.3.3. Case Study: Rebuilding File Fork Mapping Indices](#id63)
...
### [4.5.7. Reaping Old Metadata Blocks](#id64)
...
#### [4.5.7.1. Case Study: Reaping After a Regular Btree Repair](#id65)
...
#### [4.5.7.2. Case Study: Rebuilding the Free Space Indices](#id66)
...
#### [4.5.7.3. Case Study: Reaping After Repairing Reverse Mapping Btrees](#id67)
...
[live rebuilds of rmap data](#rmap-repair), but a crucial point from that
...
in a separate [case study](#rmap-repair).

#### [4.5.7.4. Case Study: Rebuilding the AGFL](#id68)
...
See [fs/xfs/scrub/agheader\_repair.c](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/fs/xfs/scrub/agheader_repair.c) for more details.

### [4.5.8. Inode Record Repairs](#id69)
...
### [4.5.9. Quota Record Repairs](#id70)
...
section about [live quotacheck](#quotacheck).

### [4.5.10. Freezing to Fix Summary Counters](#id71)
...
#### [4.5.11.1. Coordinated Inode Scans](#id73)
...
#### [4.5.11.2. Inode Management](#id74)
...
##### [4.5.11.2.1. iget and irele During a Scrub](#id75)
...
##### [4.5.11.2.2. Locking Inodes](#id76)
...
##### [4.5.11.2.3. Case Study: Finding a Directory Parent](#id77)
...
#### [4.5.11.3. Filesystem Hooks](#id78)
...
filesystem operations: filesystem hooks and [static keys](#jump-labels).
...
#### [4.5.11.4. Live Updates During a Scan](#id79)

The code paths of the online fsck scanning code and the [hooked](#fshooks)
...
##### [4.5.11.4.1. Case Study: Quota Counter Checking](#id80)
...
##### [4.5.11.4.2. Case Study: File Link Count Checking](#id81)
...
shadow information.
If no parents are found, the file must be [reparented](#orphanage) to the
orphanage to prevent the file from being lost forever.

##### [4.5.11.4.3. Case Study: Rebuilding Reverse Mapping Records](#id82)
...
and use an [in-memory array](#xfarray) to store the gathered observations.
...
It combines a [coordinated inode scanner](#iscan), [live update hooks](#liveupdate), and an [in-memory rmap btree](#xfbtree) to complete the
...
5. For each space mapping found in either fork of each file scanned,
   ...
   3. Use the [special commit function](#xfbtree-commit) to write the
...
11. Reap the old rmap btree blocks as discussed in the case study about how
    to [reap after rmap btree repair](#rmap-reap).
12. Free the xfbtree now that it not needed.

### [4.5.12. Staging Repairs with Temporary Files on Disk](#id83)
...
#### [4.5.12.1. Using a Temporary File](#id84)
...
xrep\_tempfile\_ilock\*\_nowait lock helpers.
...
### [4.5.13. Logged File Content Exchanges](#id85)
...
This new functionality is called the file contents exchange (xfs\_exchrange)
code.
The underlying implementation exchanges file fork mappings (xfs\_exchmaps).
...
#### [4.5.13.1. Mechanics of a Logged File Content Exchange](#id86)
...
#### [4.5.13.2. Preparation for File Content Exchanges](#id87)
...
#### [4.5.13.3. Special Features for Exchanging Metadata File Contents](#id88)
...
#### [4.5.13.4. Exchanging Temporary File Contents](#id89)
...
##### [4.5.13.4.1. Case Study: Repairing the Realtime Summary File](#id90)
...
##### [4.5.13.4.2. Case Study: Salvaging Extended Attributes](#id91)
...
### [4.5.14. Fixing Directories](#id92)
...
The [file link count fsck](#nlinks) code takes care of fixing link counts
and moving orphans to the `/lost+found` directory.

#### [4.5.14.1. Case Study: Salvaging Directories](#id93)
...
##### [4.5.14.2.1. Case Study: Repairing Directories with Parent Pointers](#id95)

Directory rebuilding uses a [coordinated inode scan](#iscan) and
a [directory entry live update hook](#liveupdate) as follows:
...
##### [4.5.14.2.2. Case Study: Repairing Parent Pointers](#id96)
...
##### [4.5.14.2.3. Digression: Offline Checking of Parent Pointers](#id97)
   ...
   2. For each inode in the AG,
      ...
      5. Iterate the two cursors in lockstep, comparing the `parent_ino`,
         ...
         3. Otherwise, both cursors point at the same parent pointer.
            Update the parent\_gen component if necessary.
...
challenging because xfs\_repair currently uses two single-pass scans of the
...
##### [4.5.14.2.4. Case Study: Directory Tree Structure](#id98)
...
## [4.6. 6. Userspace Algorithms and Data Structures](#id100)
...
### [4.6.1. Checking Metadata](#id101)

Recall the [phases of fsck work](#scrubphases) outlined earlier.
...
### [4.6.2. Parallel Inode Scans](#id102)
...
### [4.6.3. Scheduling Repairs](#id103)
...
The [data dependencies](#scrubcheck) outlined earlier still apply, which
...
### [4.6.4. Checking Names for Confusable Unicode Sequences](#id104)
...
### [4.6.5. Media Verification of File Data Extents](#id105)
...
## [4.7. 7. Conclusion and Future Work](#id106)
...
### [4.7.1. XFS\_IOC\_EXCHANGE\_RANGE](#id107)
...
#### [4.7.1.1. File Content Exchanges with Regular User Files](#id108)
...
### [4.7.2. Vectorized Scrub](#id109)

As it turns out, the [refactoring](#scrubrepair) of repair items mentioned
...
### [4.7.3. Quality of Service Targets for Scrub](#id110)
...
### [4.7.4. Defragmenting Free Space](#id111)
...
cleared, and uses `FIEDEUPRANGE` (or the [atomic file content exchanges](#exchrange-if-unchanged) feature) to change the target file’s data extent
...
### [4.7.5. Shrinking Filesystems](#id112)
