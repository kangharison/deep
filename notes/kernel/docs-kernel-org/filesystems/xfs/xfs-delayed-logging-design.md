...
> 출처(원문): https://docs.kernel.org/filesystems/xfs/xfs-delayed-logging-design.html
...
across the formatting of the objects into memory buffers (i.e. while [`memcpy()`](../../core-api/kernel-api.html#c.memcpy "memcpy")s
