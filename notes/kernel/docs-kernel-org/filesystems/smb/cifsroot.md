...
> 출처(원문): https://docs.kernel.org/filesystems/smb/cifsroot.html
...
The CONFIG\_CIFS\_ROOT option enables experimental root file system
...
[Mounting the root filesystem via NFS (nfsroot)](../../admin-guide/nfs/nfsroot.html).
...
Test it under QEMU on a kernel built with CONFIG\_CIFS\_ROOT and
CONFIG\_IP\_PNP options enabled:
