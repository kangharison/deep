...
> 출처(원문): https://docs.kernel.org/filesystems/befs.html
...
The largest part of the code written by Will Dyson <[will\_dyson@pobox.com](mailto:will_dyson%40pobox.com)>
He has been working on the code since Aug 13, 2001. See the changelog for
details.

Original Author: Makoto Kato <[m\_kato@ga2.so-net.ne.jp](mailto:m_kato%40ga2.so-net.ne.jp)>
...
(Will Dyson <[will\_dyson@pobox.com](mailto:will_dyson%40pobox.com)>) for help.
