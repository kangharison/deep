...
> 출처(원문): https://docs.kernel.org/filesystems/caching/fscache.html
...
If CONFIG\_NETFS\_DEBUG is enabled, the FS-Cache facility and NETFS support can
