...
> 출처(원문): https://docs.kernel.org/filesystems/ubifs-authentication.html
...
This document describes an approach to get file contents \_and\_ full metadata
...
LEB type and amount of free and *dirty* (old, obsolete content) space [[1]](#id2) on
