...
> 출처(원문): https://docs.kernel.org/filesystems/iomap/porting.html
...
>    convert the old buffer\_head path to use them.
...
>    No ->`write_begin()`, ->`write_end()` or direct\_IO
>    address\_space\_operations are required to be implemented by
>    filesystem using iomap.

## [3.2. How Do I Convert a Filesystem?](#id2)
