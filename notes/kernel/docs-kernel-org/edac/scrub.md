...
> 출처(원문): https://docs.kernel.org/edac/scrub.html
...
CXL spec r3.1 [[1]](#id5) section 8.2.9.9.11.1 describes the memory device patrol
...
CXL spec r3.1 [[1]](#id5) section 8.2.9.9.11.2 describes Error Check Scrub (ECS)
...
ACPI spec 6.5 [[2]](#id6) section 5.2.21 ACPI RAS2 describes an ACPI RAS2 table
...
ACPI spec 6.5 [[2]](#id6) section 9.19.7.2 describes Address Range Scrubbing (ARS).
...
[ABI file testing/sysfs-edac-scrub](../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-edac-scrub)

[ABI file testing/sysfs-edac-ecs](../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-edac-ecs)
