...
> 출처(원문): https://docs.kernel.org/edac/memory_repair.html
...
For example, for CXL memory devices, see CXL spec rev 3.1 [[1]](#id3) sections
...
See CXL spec 3.1 [[1]](#id3) section 8.2.9.7.1.4 Memory Sparing Maintenance
...
accessed in the /sys/bus/edac/devices/<dev-name>/mem\_repairX/

## sysfs

Sysfs files are documented in
[ABI file testing/sysfs-edac-memory-repair](../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-edac-memory-repair).
