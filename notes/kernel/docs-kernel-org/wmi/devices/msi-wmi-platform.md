# 6.MSI WMI Platform Features driver (msi-wmi-platform)

> 출처(원문): https://docs.kernel.org/wmi/devices/msi-wmi-platform.html
...
## 6.3. Reverse-Engineering the MSI WMI Platform interface
