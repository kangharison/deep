...
> 출처(원문): https://docs.kernel.org/wmi/devices/alienware-wmi.html
...
exposes Thermal\_Information and Thermal\_Control methods through the Platform
...
### 1.2.2. WMI method Thermal\_Information([in] uint32 arg2, [out] uint32 argr)
...
### 1.2.3. WMI method Thermal\_Control([in] uint32 arg2, [out] uint32 argr)
...
Thermal\_Information does not list it.
...
See [Acknowledgements](#acknowledgements) for more information on this MCU.
