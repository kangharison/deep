# 3.Dell DDV WMI interface driver (dell-wmi-ddv)

> 출처(원문): https://docs.kernel.org/wmi/devices/dell-wmi-ddv.html
...
## 3.2. Dell ePPID (electronic Piece Part Identification)
...
### 3.3.5. WMI method BatterySerialNumber()

Returns the serial number of the battery as an u16.

### 3.3.6. WMI method BatteryChemistryValue()
...
### 3.3.15. WMI method BatteryeRawAnalytics()
...
### 3.3.16. WMI method BatteryDesignVoltage()

Returns the design voltage of the battery in mV as an u16.

### 3.3.17. WMI method BatteryeRawAnalyticsABlock()
...
### 3.3.18. WMI method ReturnVersion()

Returns the WMI interface version as an u32.

### 3.3.19. WMI method FanSensorInformation()
...
### 3.3.20. WMI method ThermalSensorInformation()
...
## 3.4. ACPI battery matching algorithm
...
## 3.5. Reverse-Engineering the DDV WMI interface
...
See [Reporting issues](../../admin-guide/reporting-issues.html) for further information.
