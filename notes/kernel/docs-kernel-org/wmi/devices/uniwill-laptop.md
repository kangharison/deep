# 7.Uniwill Notebook driver (uniwill-laptop)

> 출처(원문): https://docs.kernel.org/wmi/devices/uniwill-laptop.html
...
## 7.2. EC WMI interface description
...
### 7.2.5. WMI method GetButton()

This WMI method is not implemented on all machines and has an unknown purpose.

## 7.3. Reverse-Engineering the EC WMI interface

Warning

Randomly poking the EC can potentially cause damage to the machine and other unwanted
...
are not obfuscated. In this case [dnSpy](https://github.com/dnSpy/dnSpy) could also be helpful.
...
## 7.4. WMI event interface description
...
## 7.6. EC ACPI interface description
...
[qc71\_laptop](https://github.com/pobrn/qc71_laptop) driver on which this driver is partly based.
The same is true for Tuxedo Computers, which developed the
[tuxedo-drivers](https://gitlab.com/tuxedocomputers/development/packages/tuxedo-drivers) package
