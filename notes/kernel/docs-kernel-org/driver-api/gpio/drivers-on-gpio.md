...
> 출처(원문): https://docs.kernel.org/driver-api/gpio/drivers-on-gpio.html
...
* gpio-keys: drivers/input/keyboard/gpio\_keys.c is used when your GPIO line
  can generate interrupts in response to a key press. Also supports debounce.
* gpio-keys-polled: drivers/input/keyboard/gpio\_keys\_polled.c is used when your
  GPIO line cannot generate interrupts, so it needs to be periodically polled
  by a timer.
* gpio\_mouse: drivers/input/mouse/gpio\_mouse.c is used to provide a mouse with
...
* spi\_gpio: drivers/spi/spi-gpio.c is used to drive an SPI bus (variable number
  ...
  to this SPI by using the mmc\_spi host from the MMC/SD card subsystem.
...
* gpio-wdt: drivers/watchdog/gpio\_wdt.c is used to provide a watchdog timer
