...
> 출처(원문): https://docs.kernel.org/driver-api/gpio/using-gpio.html
...
help to refine it, see [Submitting patches: the essential guide to getting your code into the kernel](../../process/submitting-patches.html).
