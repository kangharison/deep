...
> 출처(원문): https://docs.kernel.org/driver-api/cxl/platform/device-hotplug.html
...
reported in [CEDT](acpi/cedt.html). That CFMWS may match the size of the
...
[CEDT](acpi/cedt.html). If a device is removed and a new device hotplugged,
...
in the [CEDT](acpi/cedt.html). When this occurs, hot-add is not possible.
...
[CEDT](acpi/cedt.html). To apply cross-host-bridge interleave, a CFMWS entry
...
See the [Flexible CEDT Configuration](example-configurations/flexible.html)
