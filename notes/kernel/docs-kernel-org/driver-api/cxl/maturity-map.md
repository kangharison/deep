...
> 출처(원문): https://docs.kernel.org/driver-api/cxl/maturity-map.html
...
* [2] CXL Window Enumeration
  ...
  + [2] [Extended-linear memory-side cache](#extended-linear)
  + [0] Low Memory-hole
  + [X] Hetero-interleave
...
* [0] [RCH link status](#rch-link-status)
...
* [3] Firmware update
* [3] Health / Alerts
* [1] [Background commands](#background-commands)
* [3] Sanitization
* [3] Security commands
