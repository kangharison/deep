...
> 출처(원문): https://docs.kernel.org/driver-api/w1.html
...
`read_byte`
:   Reads a byte. Same as 8 touch\_bit(1) calls.
...
:   Combines two reads and a smart write for ROM searches
    **return** bit0=Id bit1=comp\_id bit2=dir\_taken
...
void w1\_search(struct [w1\_master](#c.w1_master "w1_master") \*dev, u8 search\_type, w1\_slave\_found\_callback cb)
...
int w1\_process\_callbacks(struct [w1\_master](#c.w1_master "w1_master") \*dev)
:   execute each dev->async\_list callback entry
...
int w1\_register\_family(struct [w1\_family](#c.w1_family "w1_family") \*newf)
...
void w1\_unregister\_family(struct [w1\_family](#c.w1_family "w1_family") \*fent)
...
int w1\_add\_master\_device(struct [w1\_bus\_master](#c.w1_bus_master "w1_bus_master") \*master)
...
void w1\_remove\_master\_device(struct [w1\_bus\_master](#c.w1_bus_master "w1_bus_master") \*bm)
...
:   Request bundling replies into fewer messagse. Be prepared
    to handle multiple `struct cn_msg`, [`struct w1_netlink_msg`](#c.w1_netlink_msg "w1_netlink_msg"), and
    [`struct w1_netlink_cmd`](#c.w1_netlink_cmd "w1_netlink_cmd") in one packet.
...
`type`
:   one of [`enum w1_netlink_message_types`](#c.w1_netlink_message_types "w1_netlink_message_types")
...
The netlink connector data sequence is, [`struct nlmsghdr`](../userspace-api/netlink/intro.html#c.nlmsghdr "nlmsghdr"), `struct cn_msg`,
then one or more [`struct w1_netlink_msg`](#c.w1_netlink_msg "w1_netlink_msg") (each with optional data).
...
`cmd`
:   one of [`enum w1_commands`](#c.w1_commands "w1_commands")
...
One or more [`struct w1_netlink_cmd`](#c.w1_netlink_cmd "w1_netlink_cmd") is placed starting at w1\_netlink\_msg.data
...
u8 w1\_touch\_bit(struct [w1\_master](#c.w1_master "w1_master") \*dev, int bit)
...
void w1\_write\_8(struct [w1\_master](#c.w1_master "w1_master") \*dev, u8 byte)
:   Writes 8 bits.
...
u8 w1\_triplet(struct [w1\_master](#c.w1_master "w1_master") \*dev, int bdir)
...
u8 w1\_read\_8(struct [w1\_master](#c.w1_master "w1_master") \*dev)
:   Reads 8 bits.
...
void w1\_write\_block(struct [w1\_master](#c.w1_master "w1_master") \*dev, const u8 \*buf, int len)
...
void w1\_touch\_block(struct [w1\_master](#c.w1_master "w1_master") \*dev, u8 \*buf, int len)
:   Touches a series of bytes.
...
u8 w1\_read\_block(struct [w1\_master](#c.w1_master "w1_master") \*dev, u8 \*buf, int len)
...
int w1\_reset\_bus(struct [w1\_master](#c.w1_master "w1_master") \*dev)
...
int w1\_reset\_select\_slave(struct [w1\_slave](#c.w1_slave "w1_slave") \*sl)
...
int w1\_reset\_resume\_command(struct [w1\_master](#c.w1_master "w1_master") \*dev)
...
void w1\_next\_pullup(struct [w1\_master](#c.w1_master "w1_master") \*dev, int delay)
...
void w1\_write\_bit(struct [w1\_master](#c.w1_master "w1_master") \*dev, int bit)
...
void w1\_pre\_write(struct [w1\_master](#c.w1_master "w1_master") \*dev)
...
void w1\_post\_write(struct [w1\_master](#c.w1_master "w1_master") \*dev)
:   post-write options
...
u8 w1\_read\_bit(struct [w1\_master](#c.w1_master "w1_master") \*dev)
