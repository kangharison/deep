...
> 출처(원문): https://docs.kernel.org/driver-api/surface_aggregator/overview.html
...
([`struct ssam_device`](client-api.html#c.ssam_device "ssam_device")) has been implemented.
...
See [Surface Serial Hub Protocol](ssh.html) for a
more technical protocol documentation and
[Core Driver Internals](internal.html) for an
