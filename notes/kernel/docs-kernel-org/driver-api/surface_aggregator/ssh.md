...
> 출처(원문): https://docs.kernel.org/driver-api/surface_aggregator/ssh.html
...
([`struct ssh_frame`](client-api.html#c.ssh_frame "ssh_frame")). A frame consists of the following
...
([`enum ssh_frame_type`](client-api.html#c.ssh_frame_type "ssh_frame_type")):
...
`0x80` ([`SSH_PLD_TYPE_CMD`](client-api.html#c.ssh_payload_type "ssh_payload_type")).

The command-type payload ([`struct ssh_command`](client-api.html#c.ssh_command "ssh_command"))
