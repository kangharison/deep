...
> 출처(원문): https://docs.kernel.org/driver-api/surface_aggregator/client.html
...
* [Client Driver API Documentation](client-api.html)
  + [Serial Hub Communication](client-api.html#serial-hub-communication)
  + [Controller and Core Interface](client-api.html#controller-and-core-interface)
  + [Client Bus and Client Device API](client-api.html#client-bus-and-client-device-api)
...
All communication with the SAM EC is handled via the [`struct ssam_controller`](internal-api.html#c.ssam_controller "ssam_controller")
representing that EC to the kernel. Drivers targeting a non-SSAM device (and
thus not being a [`struct ssam_device_driver`](client-api.html#c.ssam_device_driver "ssam_device_driver")) need to explicitly establish a
connection/relation to that controller. This can be done via the
[`ssam_client_bind()`](client-api.html#c.ssam_client_bind "ssam_client_bind") function. Said function returns a reference to the SSAM
...
[`ssam_client_link()`](client-api.html#c.ssam_client_link "ssam_client_link")). It is important to do this, as it, first, guarantees
...
The controller may be separately obtained via [`ssam_get_controller()`](client-api.html#c.ssam_get_controller "ssam_get_controller") and its
lifetime be guaranteed via [`ssam_controller_get()`](client-api.html#c.ssam_controller_get "ssam_controller_get") and [`ssam_controller_put()`](client-api.html#c.ssam_controller_put "ssam_controller_put").
...
means, it should be provided as [`struct ssam_device`](client-api.html#c.ssam_device "ssam_device") via the SSAM client device
...
[`ssam_device_alloc()`](client-api.html#c.ssam_device_alloc "ssam_device_alloc"), subsequently to which they have to be added via
[`ssam_device_add()`](client-api.html#c.ssam_device_add "ssam_device_add") and eventually removed via [`ssam_device_remove()`](client-api.html#c.ssam_device_remove "ssam_device_remove"). By
...
necessary, by use of [`ssam_client_link()`](client-api.html#c.ssam_client_link "ssam_client_link") as is done for non-SSAM client
...
via [`ssam_client_link()`](client-api.html#c.ssam_client_link "ssam_client_link"), causing it to unbind before the controller driver
...
driver types. They are represented via [`struct ssam_device_driver`](client-api.html#c.ssam_device_driver "ssam_device_driver") and bind to a
[`struct ssam_device`](client-api.html#c.ssam_device "ssam_device") via its UID ([`struct ssam_device.uid`](client-api.html#c.ssam_device "ssam_device"))
member and the match table
([`struct ssam_device_driver.match_table`](client-api.html#c.ssam_device_driver "ssam_device_driver")),
which should be set when declaring the driver `struct instance`. Refer to the
[`SSAM_DEVICE()`](client-api.html#c.SSAM_DEVICE "SSAM_DEVICE") macro documentation for more details on how to define members
...
([`SSAM_DOMAIN_SERIALHUB`](client-api.html#c.ssam_device_domain "ssam_device_domain")), i.e. devices that can
be accessed via the Surface Serial Hub, and virtual ones
([`SSAM_DOMAIN_VIRTUAL`](client-api.html#c.ssam_device_domain "ssam_device_domain")), such as client-device
...
A driver instance can be registered via [`ssam_device_driver_register()`](client-api.html#c.ssam_device_driver_register "ssam_device_driver_register") and
unregistered via [`ssam_device_driver_unregister()`](client-api.html#c.ssam_device_driver_unregister "ssam_device_driver_unregister"). For convenience, the
[`module_ssam_device_driver()`](client-api.html#c.module_ssam_device_driver "module_ssam_device_driver") macro may be used to define module init- and
exit-functions registering the driver.

The controller associated with a SSAM client device can be found in its
[`struct ssam_device.ctrl`](client-api.html#c.ssam_device "ssam_device") member. This reference is
...
Note that [`ssam_request_do_sync()`](client-api.html#c.ssam_request_do_sync "ssam_request_do_sync") in its essence is a wrapper over lower-level
...
* [`SSAM_DEFINE_SYNC_REQUEST_N()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_N "SSAM_DEFINE_SYNC_REQUEST_N") for requests without return value and
  without argument.
* [`SSAM_DEFINE_SYNC_REQUEST_R()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_R "SSAM_DEFINE_SYNC_REQUEST_R") for requests with return value but no
  argument.
* [`SSAM_DEFINE_SYNC_REQUEST_W()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_W "SSAM_DEFINE_SYNC_REQUEST_W") for requests without return value but
  with argument.
...
* [`SSAM_DEFINE_SYNC_REQUEST_MD_N()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_MD_N "SSAM_DEFINE_SYNC_REQUEST_MD_N")
* [`SSAM_DEFINE_SYNC_REQUEST_MD_R()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_MD_R "SSAM_DEFINE_SYNC_REQUEST_MD_R")
* [`SSAM_DEFINE_SYNC_REQUEST_MD_W()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_MD_W "SSAM_DEFINE_SYNC_REQUEST_MD_W")
...
[`struct ssam_device`](client-api.html#c.ssam_device "ssam_device"), are also provided. These can, for example, be used as
follows:
...
* [`SSAM_DEFINE_SYNC_REQUEST_CL_N()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_CL_N "SSAM_DEFINE_SYNC_REQUEST_CL_N")
* [`SSAM_DEFINE_SYNC_REQUEST_CL_R()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_CL_R "SSAM_DEFINE_SYNC_REQUEST_CL_R")
* [`SSAM_DEFINE_SYNC_REQUEST_CL_W()`](client-api.html#c.SSAM_DEFINE_SYNC_REQUEST_CL_W "SSAM_DEFINE_SYNC_REQUEST_CL_W")

## Handling Events

To receive events from the SAM EC, an event notifier must be registered for
the desired event via [`ssam_notifier_register()`](client-api.html#c.ssam_notifier_register "ssam_notifier_register"). The notifier must be
unregistered via [`ssam_notifier_unregister()`](client-api.html#c.ssam_notifier_unregister "ssam_notifier_unregister") once it is not required any
more. For [`struct ssam_device`](client-api.html#c.ssam_device "ssam_device") type clients, the [`ssam_device_notifier_register()`](client-api.html#c.ssam_device_notifier_register "ssam_device_notifier_register") and
[`ssam_device_notifier_unregister()`](client-api.html#c.ssam_device_notifier_unregister "ssam_device_notifier_unregister") wrappers should be preferred as they properly
...
providing an event mask (see [`enum ssam_event_mask`](client-api.html#c.ssam_event_mask "ssam_event_mask")).
