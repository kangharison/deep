...
> 출처(원문): https://docs.kernel.org/driver-api/device_link.html
...
[`device_add()`](infrastructure.html#c.device_add "device_add") has been called for the supplier and
[`device_initialize()`](infrastructure.html#c.device_initialize "device_initialize") has been called for the consumer.
...
set) are expected to be removed by whoever called [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add")
to add them with the help of either [`device_link_del()`](infrastructure.html#c.device_link_del "device_link_del") or
[`device_link_remove()`](infrastructure.html#c.device_link_remove "device_link_remove").

Passing `DL_FLAG_RPM_ACTIVE` along with `DL_FLAG_STATELESS` to
[`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add") may cause the PM-runtime usage counter of the
supplier device to remain nonzero after a subsequent invocation of either
[`device_link_del()`](infrastructure.html#c.device_link_del "device_link_del") or [`device_link_remove()`](infrastructure.html#c.device_link_remove "device_link_remove") to remove the
device link returned by it. This happens if [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add") is
...
it with PM-runtime disabled, between the [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add") and
[`device_link_del()`](infrastructure.html#c.device_link_del "device_link_del") or [`device_link_remove()`](infrastructure.html#c.device_link_remove "device_link_remove") calls.]
...
* An MMU device exists alongside a busmaster device, both are in the same
  ...
  suggest usage of a [`struct dev_pm_domain`](pm/types.html#c.dev_pm_domain "dev_pm_domain") or `struct generic_pm_domain`,
...
* A [`struct dev_pm_domain`](pm/types.html#c.dev_pm_domain "dev_pm_domain") can be used to override the bus,
...
from [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add").)
...
(Call to `device_is_dependent()` from [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add").)
If that constraint is violated, [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add") will return
...
* The initial state of a device link is automatically determined by
  [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add") based on the driver presence on the supplier
...
* Before a consumer device is probed, presence of supplier drivers is
  verified by checking the consumer device is not in the wait\_for\_suppliers
  ...
  (Call to [`wait_for_device_probe()`](infrastructure.html#c.wait_for_device_probe "wait_for_device_probe") from
...
See [`device_link_add()`](infrastructure.html#c.device_link_add "device_link_add"), [`device_link_del()`](infrastructure.html#c.device_link_del "device_link_del") and [`device_link_remove()`](infrastructure.html#c.device_link_remove "device_link_remove").
