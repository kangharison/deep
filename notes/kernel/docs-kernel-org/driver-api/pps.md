...
> 출처(원문): https://docs.kernel.org/driver-api/pps.html
...
to usb\_serial\_handle\_dcd\_change after checking the DCD status (see
...
PPS source, “default\_params” tells the system what the initial default
...
Where the use\_system\_clock states if the generator uses the system
...
current parport PPS generator implementation (pps\_gen\_parport module) is
...
The delay can be selected using ‘delay’ pps\_gen\_parport module parameter.
