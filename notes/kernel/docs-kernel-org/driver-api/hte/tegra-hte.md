...
> 출처(원문): https://docs.kernel.org/driver-api/hte/tegra-hte.html
...
See [`gpiod_enable_hw_timestamp_ns()`](../gpio/index.html#c.gpiod_enable_hw_timestamp_ns "gpiod_enable_hw_timestamp_ns") and [`gpiod_disable_hw_timestamp_ns()`](../gpio/index.html#c.gpiod_disable_hw_timestamp_ns "gpiod_disable_hw_timestamp_ns").

For userspace consumers, GPIO\_V2\_LINE\_FLAG\_EVENT\_CLOCK\_HTE flag must be
