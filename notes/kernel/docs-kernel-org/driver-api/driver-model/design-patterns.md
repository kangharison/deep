...
> 출처(원문): https://docs.kernel.org/driver-api/driver-model/design-patterns.html
...
1. State Container
2. [`container_of()`](../basics.html#c.container_of "container_of")
...
[`container_of()`](../basics.html#c.container_of "container_of") is a macro defined in <linux/container\_of.h>

What [`container_of()`](../basics.html#c.container_of "container_of") does is to obtain a pointer to the containing `struct from`
