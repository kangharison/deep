...
> 출처(원문): https://docs.kernel.org/driver-api/driver-model/platform.html
...
macro that passes THIS\_MODULE as owner parameter:
...
You can use [`platform_device_alloc()`](../infrastructure.html#c.platform_device_alloc "platform_device_alloc") to dynamically allocate a device, which
you will then initialize with resources and [`platform_device_register()`](../infrastructure.html#c.platform_device_register "platform_device_register").
...
You can use [`platform_device_register_simple()`](../infrastructure.html#c.platform_device_register_simple "platform_device_register_simple") as a one-step call to allocate
...
These are concatenated, so name/id “serial”/0 indicates bus\_id “serial.0”, and
...
should use early\_platform\_init(“earlyprintk”, &platform\_driver).
...
For further information, see <linux/platform\_device.h>.
