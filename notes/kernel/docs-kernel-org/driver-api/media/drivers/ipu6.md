# 10.1.16.Intel IPU6 Driver

> 출처(원문): https://docs.kernel.org/driver-api/media/drivers/ipu6.html
...
### 10.1.16.2.1. ISYS and PSYS Power flow
...
irqreturn\_t ipu6\_buttress\_isr(int irq, ...)

### 10.1.16.2.3. Security and firmware authentication
...
int ipu6\_buttress\_authenticate(...)

### 10.1.16.2.4. Global timer sync
...
int ipu6\_buttress\_start\_tsc\_sync(...)

## 10.1.16.3. DMA and MMU
...
## 10.1.16.4. Firmware file format
...
### 10.1.16.6.1. D-PHYs and CSI-2 ports lane mapping
...
### 10.1.16.6.2. ISYS firmware ABIs
...
See [Examples](../../../admin-guide/media/ipu6-isys.html#ipu6-isys-capture-examples) about how to do
