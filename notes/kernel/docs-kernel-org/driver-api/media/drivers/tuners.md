# 10.1.11.Tuner drivers

> 출처(원문): https://docs.kernel.org/driver-api/media/drivers/tuners.html
...
## 10.1.11.1. Simple tuner Programming
...
* TSBE1 has extra API 05,02,08 Control\_byte=0xCB Source:[[1]](#f1)
