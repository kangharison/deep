# 10.1.8.The Rockchip Image Signal Processor Driver (rkisp1)

> 출처(원문): https://docs.kernel.org/driver-api/media/drivers/rkisp1.html
...
## 10.1.8.1. Versions and their differences
...
## 10.1.8.2. Changes from V10 to V12
...
## 10.1.8.3. Changes from V12 to V13
