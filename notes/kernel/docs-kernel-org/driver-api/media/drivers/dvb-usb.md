# 10.2.1.Idea behind the dvb-usb-framework

> 출처(원문): https://docs.kernel.org/driver-api/media/drivers/dvb-usb.html
...
> 2005-01-13
>
> * moved the mirrored pid\_filter\_table back to dvb-dibusb
...
> 2004-11-23
>
> * merged changes from DiB3000MC\_ver2.1
...
> * merged my changes (for dib3000mb/dibusb) to the FE\_REFACTORING, because it became HEAD
> * moved transfer control (pid filter, fifo control) from usb driver to frontend, it seems
>   better settled there (added xfer\_ops-struct)
...
### 10.2.1.2.3. Loading the drivers
...
## 10.2.1.3. Known problems and bugs

* Don’t remove the USB device while running an DVB application, your system
  will go crazy or die most likely.

### 10.2.1.3.1. Adding support for devices

TODO

### 10.2.1.3.2. USB1.1 Bandwidth limitation
