# 10.1.1.The bttv driver

> 출처(원문): https://docs.kernel.org/driver-api/media/drivers/bttv-devel.html
...
## 10.1.1.1. bttv and sound mini howto
...
example. The file [BTTV cards list](../../../admin-guide/media/bttv-cardlist.html) has a list
...
### 10.1.1.1.1. How sound works in detail
...
> |  |  |
> | --- | --- |
> | bttv\_gpio=0/1 | enable/disable gpio debug messages |
