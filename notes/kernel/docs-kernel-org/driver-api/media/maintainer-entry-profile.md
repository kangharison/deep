...
> 출처(원문): https://docs.kernel.org/driver-api/media/maintainer-entry-profile.html
...
> * include/media
> * Documentation/devicetree/bindings/media/[[1]](#id2)
...
* **Media Subsystem Maintainers**:
  :   Media Core Maintainers who are also responsible for the subsystem as a
      ...
      Maintainers[[2]](#id4). Media Maintainers may include API/ABI changes in
...
described in [Working with the kernel development community](../../process/index.html) and with the Kernel development
...
update [Patchwork](https://patchwork.linuxtv.org/project/linux-media/list/)
...
found here: [Media Committers](media-committers.html#media-committers).

## 1.5. Media development sites

The [LinuxTV](https://linuxtv.org/) web site hosts news about the subsystem,
together with:

* [Wiki pages](https://www.linuxtv.org/wiki/index.php/Main_Page);
* [Patchwork](https://patchwork.linuxtv.org/project/linux-media/list/);
* [Linux Media documentation](https://linuxtv.org/docs.php);
* and more.
...
[linux-media@vger.kernel.org](mailto:linux-media%40vger.kernel.org) (aka: LMML). While subscription is not mandatory,
...
[linux-media@vger.kernel.org](mailto:linux-media%40vger.kernel.org) mailing list shall have:
...
See [Working with the kernel development community](../../process/index.html) for more details about e-mail submission.

Once a patch is submitted, it may follow either one of the following
workflows:

1. Media Maintainers’ workflow: Media Maintainers post the Pull Requests,
...
2. Media Committers’ workflow: patches are handled by Media Maintainers with
   commit rights:
...
[linux-media@vger.kernel.org](mailto:linux-media%40vger.kernel.org) (LMML) before being merged in
...
If it doesn’t automatically appear there after some time [[3]](#id14), then
probably something went wrong on your submission. Please check if the
email is in plain text[[4]](#id16) only and if your emailer is not mangling
...
It usually takes a few minutes for the patch to arrive, but
...
at some moment. See: [Using the kernel.org web of trust repository](../../process/maintainer-pgp-guide.html#kernel-org-trust-repository).
...
[Media Committer’s agreement](media-committers.html#media-committer-agreement).

For more details about PGP signing, please read
[Kernel Maintainer PGP guide](../../process/maintainer-pgp-guide.html).

## 1.6. Maintaining media maintainer status

See [Maintaining Media Maintainer or Committer status](media-committers.html#maintain-media-status).
...
:   * Mauro Carvalho Chehab <[mchehab@kernel.org](mailto:mchehab%40kernel.org)>
    * Hans Verkuil <[hverkuil@kernel.org](mailto:hverkuil%40kernel.org)>
...
:   * Nicolas Dufresne <[nicolas.dufresne@collabora.com](mailto:nicolas.dufresne%40collabora.com)>

      + Codec drivers
      + M2M driver not otherwise delegated
    * Bryan O’Donoghue <[bryan.odonoghue@linaro.org](mailto:bryan.odonoghue%40linaro.org)>
...
| Type | Utility |
| --- | --- |
| V4L2 drivers[[5]](#id18) | `v4l2-compliance` |
| V4L2 virtual drivers | `contrib/test/test-media` |
| CEC drivers | `cec-compliance` |

[[5](#id17)]

The `v4l2-compliance` utility also covers the media controller usage
inside V4L2 drivers.
...
Please see [Media development workflow](#media-development-workflow) for e-mail submission rules.
...
[Patchwork](https://patchwork.linuxtv.org/project/linux-media/list/), it
