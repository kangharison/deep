...
> 출처(원문): https://docs.kernel.org/driver-api/media/media-committers.html
...
patches to the
[media-committers](https://gitlab.freedesktop.org/linux-media/media-committers)
tree.
...
3. If patches are fixing bugs against already released Kernels, including
   ...
   tags. Please see [Media development workflow](maintainer-entry-profile.html#media-development-workflow) for more details.
...
## 2.2. Becoming a Media Committer
...
## 2.3. Media Committer’s agreement
...
an e-mail to [media-committers@linuxtv.org](mailto:media-committers%40linuxtv.org), with a declaration of intent
...
[Authentication for pull and merge requests](maintainer-entry-profile.html#media-developers-gpg), the PGP signature, together with the gitlab user
...
[media-committers tree](https://gitlab.freedesktop.org/linux-media/media-committers),
...
## 2.4. Media Core Committers

A Media Core Committer is a Media Core Maintainer with commit rights.

As described in [Media Subsystem Profile](maintainer-entry-profile.html),
...
The Media Committer workflow is described at [Media development workflow](maintainer-entry-profile.html#media-development-workflow).

## 2.6. Maintaining Media Maintainer or Committer status
...
as documented at the [Media development workflow](maintainer-entry-profile.html#media-development-workflow).
...
* [WebKit](https://webkit.org/commit-and-review-policy/);
* [Mozilla](https://www.mozilla.org/hacking/committer/).
