...
> 출처(원문): https://docs.kernel.org/driver-api/tty/moxa-smartio.html
...
> | close\_delay | set the amount of time (in 1/100 of a second) that DTR should be kept low while being closed. |
> | closing\_wait | set the amount of time (in 1/100 of a second) that the serial port should wait for data to be drained while being closed, before the receiver is disabled. |
> | spd\_hi | Use 57.6kb when the application requests 38.4kb. |
> | spd\_vhi | Use 115.2kb when the application requests 38.4kb. |
> | spd\_shi | Use 230.4kb when the application requests 38.4kb. |
> | spd\_warp | Use 460.8kb when the application requests 38.4kb. |
> | spd\_normal | Use 38.4kb when the application requests 38.4kb. |
> | spd\_cust | Use the custom divisor to set the speed when the application requests 38.4kb. |
> | divisor | This option sets the custom division. |
> | baud\_base | This option sets the base baud rate. |
