...
> 출처(원문): https://docs.kernel.org/driver-api/rapidio/rio_cm.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# RapidIO subsystem Channelized Messaging character device driver (rio\_cm.c)
...
This driver (RIO\_CM) provides to user-space applications shared access to
...
When loaded this device driver creates a single file system node named rio\_cm
...
* RIO\_CM\_CHAN\_RECEIVE:
  :   Receives a data message through a connected channel.
      ...
      defined by MAX\_SCHEDULE\_TIMEOUT.
* RIO\_CM\_CHAN\_CLOSE:
...
user-space applications are defined in ‘include/uapi/linux/rio\_cm\_cdev.h’.
...
* ‘dbg\_level’
  :   + This parameter allows to control amount of debug information
        ...
        For mask definitions see ‘drivers/rapidio/devices/rio\_cm.c’
