...
> 출처(원문): https://docs.kernel.org/driver-api/serial/serial-iso7816.html
...
> The Linux kernel provides the serial\_iso7816 structure (see [1]) to handle
> ISO7816 communications. This data structure is used to set and configure
> ISO7816 parameters in ioctls.
>
> Any driver for devices capable of working both as RS232 and ISO7816 should
> implement the iso7816\_config callback in the uart\_port structure. The
> serial\_core calls iso7816\_config to do the device specific part in response
> to TIOCGISO7816 and TIOCSISO7816 ioctls (see below). The iso7816\_config
