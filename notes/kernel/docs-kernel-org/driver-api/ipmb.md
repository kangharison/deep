...
> 출처(원문): https://docs.kernel.org/driver-api/ipmb.html
...
CONFIG\_IPMB\_DEVICE\_INTERFACE=y
...
described in ‘[How to instantiate I2C devices](../i2c/instantiating-devices.html)’.
