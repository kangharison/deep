...
> 출처(원문): https://docs.kernel.org/driver-api/dmaengine/dmatest.html
...
capability of the following: DMA\_MEMCPY (memory-to-memory), DMA\_MEMSET
(const-to-memory or memory-to-memory, when emulated), DMA\_XOR, DMA\_PQ.
...
section [Part 2 - When dmatest is built as a module](#part-2-when-dmatest-is-built-as-a-module).
...
At any point during the test configuration, reading the “test\_list” parameter will
