...
> 출처(원문): https://docs.kernel.org/driver-api/pm/types.html
...
:   The principal role of this callback is to prevent new children of
    ...
    **`poweroff()`**. If the transition is a suspend to memory or standby (that
    ...
    substantial amounts of memory from **`prepare()`** in the GFP\_KERNEL mode.
...
:   Undo the changes made by **`prepare()`**. This method is executed for
    ...
    **`complete()`** can check the power.direct\_complete flag of the device to
...
Refer to [Runtime Power Management Framework for I/O Devices](../../power/runtime_pm.html) for more information about the
