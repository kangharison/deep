...
> 출처(원문): https://docs.kernel.org/driver-api/pm/notifiers.html
...
resume/restore, but they cannot do it by calling [`request_firmware()`](../firmware/request_firmware.html#c.request_firmware "request_firmware")
