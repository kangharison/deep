...
> 출처(원문): https://docs.kernel.org/driver-api/soundwire/bra.html
...
In addition, the ‘sdw\_msg’ structure hard-codes support for 16-bit
...
‘sdw\_bpt\_msg’ makes more sense.
...
> > * sdw\_bpt\_send\_async(bpt\_message)
> >
...
>   > codec driver in the ‘send\_async’ stage. Intermediate status for
...
>    COMMAND\_IGNORED responses that will be wired-ORed with
...
> 3. The stream concept relies on a set of master\_rt and slave\_rt
