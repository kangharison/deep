...
> 출처(원문): https://docs.kernel.org/driver-api/soundwire/locking.html
...
(sdw\_bus) which is used for every Bus instance. This lock is used to
...
Bus data structure (sdw\_bus). This lock is used to serialize the message
