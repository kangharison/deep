...
> 출처(원문): https://docs.kernel.org/driver-api/mtd/spi-intel.html
...
passing “spi\_intel.writeable=1”.
...
>    name “mtd-utils”.
> 3. Add “spi\_intel.writeable=1” to the kernel command line and reboot
