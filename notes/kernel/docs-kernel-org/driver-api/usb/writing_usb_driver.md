...
> 출처(원문): https://docs.kernel.org/driver-api/usb/writing_usb_driver.html
...
information is passed to the USB subsystem in the [`usb_driver`](usb.html#c.usb_driver "usb_driver")
structure. The skeleton driver declares a [`usb_driver`](usb.html#c.usb_driver "usb_driver") as:
...
[`usb_device_id`](../basics.html#c.usb_device_id "usb_device_id") for drivers that support a whole class of USB
drivers. See [usb.h](usb.html#usb-header) for more information on this.

## Device operation

When a device is plugged into the USB bus that matches the device ID
pattern that your driver registered with the USB core, the probe
function is called. The [`usb_device`](usb.html#c.usb_device "usb_device") structure, interface number and
...
[`usb_fill_bulk_urb()`](usb.html#c.usb_fill_bulk_urb "usb_fill_bulk_urb") function, we point the urb’s completion callback
