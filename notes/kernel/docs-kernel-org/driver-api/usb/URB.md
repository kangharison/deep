...
> 출처(원문): https://docs.kernel.org/driver-api/usb/URB.html
...
The USB subsystem now has a substantial section at [The Linux-USB Host Side API](usb.html#usb-hostside-api)
...
* Execution of an URB is inherently an asynchronous operation, i.e. the
  [`usb_submit_urb()`](usb.html#c.usb_submit_urb "usb_submit_urb") call returns immediately after it has successfully
  queued the requested action.
* Transfers for one URB can be canceled with [`usb_unlink_urb()`](usb.html#c.usb_unlink_urb "usb_unlink_urb")
  at any time.
...
Some of the fields in [`struct urb`](usb.html#c.urb "urb") are:
...
URBs are allocated by calling [`usb_alloc_urb()`](usb.html#c.usb_alloc_urb "usb_alloc_urb"):
...
To free an URB, use [`usb_free_urb()`](usb.html#c.usb_free_urb "usb_free_urb"):
...
[`usb_fill_control_urb()`](usb.html#c.usb_fill_control_urb "usb_fill_control_urb"), [`usb_fill_bulk_urb()`](usb.html#c.usb_fill_bulk_urb "usb_fill_bulk_urb") and
[`usb_fill_int_urb()`](usb.html#c.usb_fill_int_urb "usb_fill_int_urb"). In general, they need the usb device pointer,
...
* For ASAP set `URB_ISO_ASAP` in transfer\_flags.
...
Just call [`usb_submit_urb()`](usb.html#c.usb_submit_urb "usb_submit_urb"):
...
[`usb_unlink_urb()`](usb.html#c.usb_unlink_urb "usb_unlink_urb"):
...
that the URB will not normally have finished when [`usb_unlink_urb()`](usb.html#c.usb_unlink_urb "usb_unlink_urb")
returns; you must still wait for the completion handler to be called.

To cancel an URB synchronously, call [`usb_kill_urb()`](usb.html#c.usb_kill_urb "usb_kill_urb"):

```
void usb_kill_urb(struct urb *urb)
```

It does everything [`usb_unlink_urb()`](usb.html#c.usb_unlink_urb "usb_unlink_urb") does, and in addition it waits
until after the URB has been returned and the completion handler
has finished. It also marks the URB as temporarily unusable, so
that if the completion handler or anyone else tries to resubmit it
they will get a `-EPERM` error. Thus you can be sure that when
[`usb_kill_urb()`](usb.html#c.usb_kill_urb "usb_kill_urb") returns, the URB is totally idle.

There is a lifetime issue to consider. An URB may complete at any
time, and the completion handler may free the URB. If this happens
while [`usb_unlink_urb()`](usb.html#c.usb_unlink_urb "usb_unlink_urb") or [`usb_kill_urb()`](usb.html#c.usb_kill_urb "usb_kill_urb") is running, it will
...
decrement the reference count by calling [`usb_free_urb()`](usb.html#c.usb_free_urb "usb_free_urb"). Of course,
...
you specify. You can use the [`usb_fill_int_urb()`](usb.html#c.usb_fill_int_urb "usb_fill_int_urb") macro to fill
most ISO transfer fields.

For ISO transfers you also have to fill a `usb_iso_packet_descriptor`
structure, allocated at the end of the URB by [`usb_alloc_urb()`](usb.html#c.usb_alloc_urb "usb_alloc_urb"), for
each packet you want to schedule.

The [`usb_submit_urb()`](usb.html#c.usb_submit_urb "usb_submit_urb") call modifies `urb->interval` to the implemented
...
You can use the [`usb_fill_int_urb()`](usb.html#c.usb_fill_int_urb "usb_fill_int_urb") macro to fill INT transfer fields.
