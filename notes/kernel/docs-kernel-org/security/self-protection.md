...
> 출처(원문): https://docs.kernel.org/security/self-protection.html
...
explicitly [`memset()`](../core-api/kernel-api.html#c.memset "memset"), this will require changes to the compiler to make
...
the buffer is destined for userspace (e.g. seq\_file backed `/proc` files),
