...
> 출처(원문): https://docs.kernel.org/security/siphash.html
...
as a replacement for some uses of: jhash, md5\_transform, sha1\_transform,
and so forth.
...
random numbers, either using get\_random\_bytes or get\_random\_once:
...
and to use [`offsetofend()`](../driver-api/basics.html#c.offsetofend "offsetofend") instead of sizeof() for getting the size. For
