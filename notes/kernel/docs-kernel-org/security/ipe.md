...
> 출처(원문): https://docs.kernel.org/security/ipe.html
...
[IPE admin guide](../admin-guide/LSM/ipe.html).
...
Initially, IPE’s policy can have a policy\_version that states the
