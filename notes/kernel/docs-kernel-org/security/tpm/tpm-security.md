...
> 출처(원문): https://docs.kernel.org/security/tpm/tpm-security.html
...
tpm\_chip for every in-kernel use of the TPM. Currently, because of a
...
TPM2\_MakeCredential. The TPM then runs TPM2\_ActivateCredential which
...
exported. Since TPM2\_MakeCredential/ActivateCredential are somewhat
...
/sys/class/tpm/tpm0/null\_name. If the names do not match, the TPM is
