...
> 출처(원문): https://docs.kernel.org/security/snp-tdx-threat-model.html
...
[Intel Trust Domain Extensions (TDX)](../arch/x86/tdx.html) and
...
## [Existing Linux kernel threat model](#id4)
...
## [Confidential Computing threat model and its security objectives](#id5)
