...
> 출처(원문): https://docs.kernel.org/tee/qtee.html
...
* QCOM\_SCM\_SMCINVOKE\_INVOKE: Used for direct invocation. It can return either
  a result or initiate a callback request.
* QCOM\_SCM\_SMCINVOKE\_CB\_RSP: Used to submit a response to a callback request
...
[3] drivers/firmware/qcom/qcom\_scm.c

[4] drivers/tee/qcomtee/qcomtee\_msg.h
