...
> 출처(원문): https://docs.kernel.org/PCI/controller/rcar-pcie-firmware.html
...
The firmware file “104\_PCIe\_fw\_addr\_data\_ver1.05.txt” (note that the file name
...
The resulting binary file called “rcar\_gen4\_pcie.bin” should be placed in the
