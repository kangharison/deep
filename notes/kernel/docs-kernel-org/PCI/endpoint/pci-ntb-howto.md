...
> 출처(원문): https://docs.kernel.org/PCI/endpoint/pci-ntb-howto.html
...
[PCI NTB Function](pci-ntb-function.html)
...
be probed by pci\_epf\_ntb driver.
...
### 9.7.2.2. Using ntb\_hw\_epf Device
