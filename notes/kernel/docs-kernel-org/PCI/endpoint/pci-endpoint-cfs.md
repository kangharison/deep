...
> 출처(원문): https://docs.kernel.org/PCI/endpoint/pci-endpoint-cfs.html
...
The PCI Endpoint Core exposes configfs entry (pci\_ep) to configure the
...
The PCI Endpoint Core layer creates pci\_ep directory in the mounted configfs
...
The pci\_ep configfs has two directories at its root: controllers and
...
[1] [Introduction](pci-endpoint.html)
