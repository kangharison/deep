...
> 출처(원문): https://docs.kernel.org/PCI/tph.html
...
To support TPH, the kernel must be built with the CONFIG\_PCIE\_TPH option
enabled.
...
[`pcie_enable_tph()`](../driver-api/pci/pci.html#c.pcie_enable_tph "pcie_enable_tph") checks whether the requested mode is actually
...
return value of [`pcie_enable_tph()`](../driver-api/pci/pci.html#c.pcie_enable_tph "pcie_enable_tph").
...
written into. [`pcie_tph_set_st_entry()`](../driver-api/pci/pci.html#c.pcie_tph_set_st_entry "pcie_tph_set_st_entry") will figure out the proper
