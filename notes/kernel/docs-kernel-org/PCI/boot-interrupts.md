...
> 출처(원문): https://docs.kernel.org/PCI/boot-interrupts.html
...
interrupt messages (Assert\_INTx/Deassert\_INTx). The integrated IO-APIC in a
...
:   Coherent Interface Protocol Interrupt Control
    :   dis\_intx\_route2pch/dis\_intx\_route2ich/dis\_intx\_route2dmi2:
...
line due to excessive unhandled counts. [[2]](#id5)

The config option X86\_REROUTE\_FOR\_BROKEN\_BOOT\_IRQS exists to enable (or
disable) the redirection of the interrupt handler to the PCH interrupt
line. The option can be overridden by either pci=ioapicreroute or
pci=noioapicreroute. [[3]](#id6)
