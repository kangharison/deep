...
> 출처(원문): https://docs.kernel.org/hwmon/nzxt-smart2.html
...
| update\_interval | The interval at which all inputs are updated (in milliseconds). The default is 1000ms. Minimum is 250ms. |
