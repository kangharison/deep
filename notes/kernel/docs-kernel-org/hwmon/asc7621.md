...
> 출처(원문): https://docs.kernel.org/hwmon/asc7621.html
...
:   |  |  |
    | --- | --- |
    | 0 | (default) peci\_legacy = 0, Remote 1 Temperature peci\_legacy = 1, PECI Processor Temperature 0 |
...
:   |  |  |
    | --- | --- |
    | 0 | (default) peci\_legacy = 0, PECI Processor Temperature 0 peci\_legacy = 1, Remote 1 Temperature |
    | 1 | Remote 1 Temperature |
    | 2 | Remote 2 Temperature |
    | 3 | Internal Temperature |
    | 4 | PECI Processor Temperature 0 |
...
temp[1-4]\_smoothing\_enable / temp[1-4]\_smoothing\_time
