...
> 출처(원문): https://docs.kernel.org/hwmon/emc2305.html
...
|  |  |  |
| --- | --- | --- |
| cur\_state | RW | file for the current cooling state of the cooling device (0..max\_state) |
| max\_state | RO | file for the maximum cooling state of the cooling device |
