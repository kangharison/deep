...
> 출처(원문): https://docs.kernel.org/hwmon/qnap-mcu-hwmon.html
...
The fan rotation speed returned via the optional ‘fan1\_input’ is calculated
...
| temp1\_input | ro | Measured temperature in millicelsius |
