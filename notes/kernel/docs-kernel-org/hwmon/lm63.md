...
> 출처(원문): https://docs.kernel.org/hwmon/lm63.html
...
the update\_interval sysfs attribute; reading them more often will do no harm,
but will return ‘old’ values. Values in the automatic fan control lookup table
(attributes pwm1\_auto\_\*) have their own independent lifetime of 5 seconds.
