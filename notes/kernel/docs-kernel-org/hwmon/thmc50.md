...
> 출처(원문): https://docs.kernel.org/hwmon/thmc50.html
...
many processors), and a controllable fan/analog\_out DAC. For the temperature
...
the mode with additional remote temperature with adm1022\_temp3 parameter.
...
The value of 0 for pwm1 also forces FAN\_OFF signal from the chip,
so it stops fans even if the value 0 into the ANALOG\_OUT register does not.
