...
> 출처(원문): https://docs.kernel.org/hwmon/ds1621.html
...
userspace, via the device ‘update\_interval’ sysfs attribute. This attribute
...
As shown, the ds1621 driver automatically adjusts the ‘update\_interval’
user input, via a step function. Reading back the ‘update\_interval’ value
after a write operation provides the conversion time used by the device.

Mathematically, the resolution can be derived from the conversion time
via the following function:

> g(x) = 0.5 \* [minimum\_conversion\_time/x]
