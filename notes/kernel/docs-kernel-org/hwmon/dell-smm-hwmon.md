...
> 출처(원문): https://docs.kernel.org/hwmon/dell-smm-hwmon.html
...
| pwm[1-4]\_enable | RW/WO | Enable or disable automatic BIOS fan control (not supported on all laptops, see below for details). |
