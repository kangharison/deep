...
> 출처(원문): https://docs.kernel.org/hwmon/tmp401.html
...
[Naming and data format standards for sysfs files](sysfs-interface.html) under Temperatures).
...
* Reset of historical minimum/maximum temperature measurements
  ...
  Exported via sysfs attribute temp\_reset\_history. Writing 1 to this
