...
> 출처(원문): https://docs.kernel.org/hwmon/yogafan.html
...
Author: Sergio Melas <[sergiomelas@gmail.com](mailto:sergiomelas%40gmail.com)>
...
The driver utilizes the boottime clock ([`ktime_get_boottime()`](../core-api/timekeeping.html#c.ktime_get_boottime "ktime_get_boottime")) to calculate the
...
| fanX\_input | Filtered fan speed in RPM. |
...
3. **Linux Kernel Timekeeping API:** Documentation for [`ktime_get_boottime()`](../core-api/timekeeping.html#c.ktime_get_boottime "ktime_get_boottime") and
