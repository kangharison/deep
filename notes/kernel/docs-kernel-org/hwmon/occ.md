...
> 출처(원문): https://docs.kernel.org/hwmon/occ.html
...
>     of a string, delimited by underscores, i.e. “0\_15\_1”.
...
>     delimited by an underscore, i.e. “0\_system”. Sensor
...
>     microwatts.
>
> power[1-n]\_cap\_min Minimum power cap that the OCC can enforce in
> :   microwatts.
>
