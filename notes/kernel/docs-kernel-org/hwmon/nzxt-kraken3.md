...
> 출처(원문): https://docs.kernel.org/hwmon/nzxt-kraken3.html
...
Possible pwm\_enable values are:
...
| fan2\_input | Fan speed (in rpm) |
| temp1\_input | Coolant temperature (in millidegrees Celsius) |
| pwm1 | Pump duty (value between 0-255) |
| pwm1\_enable | Pump duty control mode (0: disabled, 1: manual, 2: curve) |
| pwm2 | Fan duty (value between 0-255) |
| pwm2\_enable | Fan duty control mode (0: disabled, 1: manual, 2: curve) |
| temp[1-2]\_auto\_point[1-40]\_pwm | Temp-PWM duty curves (for pump and fan), related to coolant temp |
