...
> 출처(원문): https://docs.kernel.org/hwmon/vexpress.html
...
The configuration devices are \_not\_ memory mapped and must be accessed
via a custom interface, abstracted by the “vexpress\_config” API.
