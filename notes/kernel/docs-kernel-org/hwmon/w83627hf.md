...
> 출처(원문): https://docs.kernel.org/hwmon/w83627hf.html
...
The w83627\_HF\_ uses pins 110-106 as VID0-VID4. The w83627\_THF\_ uses the
same pins as GPIO[0:4]. Technically, the w83627\_THF\_ does not support a
...
doesn’t work, first see doc/vid in the lm\_sensors package[1]. If that still
...
The driver used to have a module parameter named force\_addr, which could
