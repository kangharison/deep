...
> 출처(원문): https://docs.kernel.org/hwmon/w83793.html
...
* force\_subclients=bus,caddr,saddr1,saddr2
  :   This is used to force the i2c addresses for subclients of
      a certain chip. Typical usage is force\_subclients=0,0x2f,0x4a,0x4b
...
* SmartFan/PWM control
  :   If you want to set a pwm fan to manual mode, you just need to make sure it
      ...
      to manual mode, you need to check the value of temp[1-6]\_fan\_map, make
      ...
      corresponding bit in tempX\_fan\_map), you can set the temperature channel
      mode using temp[1-6]\_pwm\_enable, 2 is Thermal Cruise mode and 3
      ...
      predefined value, within a tolerance margin. So if tempX\_input >
      thermal\_cruiseX + toleranceX, the chip will increase the PWM value,
      if tempX\_input < thermal\_cruiseX - toleranceX, the chip will decrease
...
* Chassis
  :   If the case open alarm triggers, it will stay in this state unless cleared
      by writing 0 to the sysfs file “intrusion0\_alarm”.
* VID and VRM
