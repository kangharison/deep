...
> 출처(원문): https://docs.kernel.org/hwmon/submitting-patches.html
...
* If your patch (or the driver) is affected by configuration options such as
  CONFIG\_SMP, make sure it compiles for all configuration variants.

## 2. Adding functionality to existing drivers

* Make sure the documentation in Documentation/hwmon/<driver\_name>.rst is up to
  date.
...
* Use devres functions whenever possible to allocate resources. For rationale
  and supported functions, please see [Devres - Managed Device Resource](../driver-api/driver-model/devres.html).
...
* Do not create non-standard attributes unless really needed. If you have to use
  ...
  Standard attributes are specified in [Naming and data format standards for sysfs files](sysfs-interface.html).
