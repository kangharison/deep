...
> 출처(원문): https://docs.kernel.org/hwmon/f71805f.html
...
| in2 | VIN2 | VRAM | 100K | 100K | 2.00 | ~1.25 V [[1]](#id6) |
| in3 | VIN3 | VCHIPSET | 47K | 100K | 1.47 | 2.24 V [[2]](#id7) |
| in4 | VIN4 | VCC5V | 200K | 47K | 5.25 | 0.95 V |
| in5 | VIN5 | +12V | 200K | 20K | 11.00 | 1.05 V |
| in6 | VIN6 | VCC1.5V | 10K |  | 1.00 | 1.50 V |
| in7 | VIN7 | VCORE | 10K |  | 1.00 | ~1.40 V [[1]](#id6) |
| in8 | VIN8 | VSB5V | 200K | 47K | 1.00 | 0.95 V |
| in10 | VSB | VSB3.3V | int. | int. | 2.00 | 1.65 V [[3]](#id8) |
| in9 | VBAT | VBATTERY | int. | int. | 2.00 | 1.50 V [[3]](#id8) |
...
* 2: Temperature mode
  ...
  pwm<n>\_auto\_point<m>\_temp and \_fan files. These define a staircase
  ...
  is below auto\_point1\_temp the fan is switched off.
* 3: Fan speed mode
