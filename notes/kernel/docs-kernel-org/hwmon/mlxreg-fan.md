...
> 출처(원문): https://docs.kernel.org/hwmon/mlxreg-fan.html
...
|  |  |  |
| --- | --- | --- |
| cur\_state | RW | file for current cooling state of the cooling device (0..max\_state) |
| max\_state | RO | file for maximum cooling state of the cooling device |
