...
> 출처(원문): https://docs.kernel.org/hwmon/max31730.html
...
| temp[1-4]\_max\_alarm | RW | Maximum temperature alarm |
| temp[1-4]\_min | RW | Minimum temperature. Common for all channels. Only temp1\_min is writeable. |
| temp[1-4]\_min\_alarm | RO | Minimum temperature alarm |
