...
> 출처(원문): https://docs.kernel.org/hwmon/aquacomputer_d5next.html
...
| fan1\_min | Minimal fan speed (in RPM) |
| fan1\_max | Maximal fan speed (in RPM) |
| fan1\_target | Target fan speed (in RPM) |
| fan5\_pulses | Quadro flow sensor pulses |
| fan9\_pulses | Octo flow sensor pulses |
...
| firmware\_version | Version of installed firmware |
| power\_cycles | Count of how many times the device was powered on |
