...
> 출처(원문): https://docs.kernel.org/hwmon/adt7475.html
...
minimum (i.e. auto\_point1\_pwm). This behaviour can be configured using the
pwm[1-\*]\_stall\_disable sysfs attribute. A value of 0 means the fans will shut
off. A value of 1 means the fans will run at auto\_point1\_pwm.
