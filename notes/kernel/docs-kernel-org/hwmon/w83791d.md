...
> 출처(원문): https://docs.kernel.org/hwmon/w83791d.html
...
* force\_subclients=bus,caddr,saddr,saddr
  :   This is used to force the i2c addresses for subclients of
      a certain chip. Example usage is force\_subclients=0,0x2f,0x4a,0x4b
...
The sysfs interface to the global enable is via the sysfs beep\_enable file.
This file is used for both legacy and new code.

The sysfs interface to the beep bitmask has migrated from the original legacy
method of a single sysfs beep\_mask file to a newer method using multiple
\*\_beep files as described in [Naming and data format standards for sysfs files](sysfs-interface.html).
...
responsible for handling the fact that the alarms and beep\_mask bitmaps
...
## Alarms bitmap vs. beep\_mask bitmask

For legacy code using the alarms and beep\_mask files:

| Signal | Alarms | beep\_mask | Obs |
| --- | --- | --- | --- |
...
| case\_open | 0x001000 | 0x001000 |  |
| global\_enable |  | 0x800000 | (modified via beep\_enable) |
