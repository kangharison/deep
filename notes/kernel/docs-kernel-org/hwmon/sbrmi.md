...
> 출처(원문): https://docs.kernel.org/hwmon/sbrmi.html
...
| --- | --- | --- |
| power1\_input | RO | Current Power consumed |
| power1\_cap | RW | Power limit can be set between 0 and power1\_cap\_max |
| power1\_cap\_max | RO | Maximum powerlimit calculated and reported by the SMU FW |
...
:   # cat /sys/class/hwmon/hwmon1/power1\_cap\_max
    225000000

    # echo 180000000 > /sys/class/hwmon/hwmon1/power1\_cap
    # cat /sys/class/hwmon/hwmon1/power1\_cap
    180000000
