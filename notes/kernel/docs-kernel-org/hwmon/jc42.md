...
> 출처(원문): https://docs.kernel.org/hwmon/jc42.html
...
temp1\_crit\_hyst. Other hysteresis attributes are read-only.
...
| temp1\_min | Minimum temperature (RO or RW) |
| temp1\_max | Maximum temperature (RO or RW) |
| temp1\_crit | Critical high temperature (RO or RW) |
| temp1\_crit\_hyst | Critical hysteresis temperature (RO or RW) |
| temp1\_max\_hyst | Maximum hysteresis temperature (RO) |
