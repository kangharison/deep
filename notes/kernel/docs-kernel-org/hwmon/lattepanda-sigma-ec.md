...
> 출처(원문): https://docs.kernel.org/hwmon/lattepanda-sigma-ec.html
...
Author: Mariano Abad <[weimaraner@gmail.com](mailto:weimaraner%40gmail.com)>
...
|  |  |
| --- | --- |
| `fan1_input` | Fan speed in RPM (EC registers 0x2E:0x2F, 16-bit big-endian) |
| `fan1_label` | “CPU Fan” |
| `temp1_input` | Board/ambient temperature in millidegrees Celsius (EC register 0x60, unsigned) |
| `temp1_label` | “Board Temp” |
| `temp2_input` | CPU proximity temperature in millidegrees Celsius (EC register 0x70, unsigned) |
