...
> 출처(원문): https://docs.kernel.org/hwmon/max6697.html
...
|  |  |  |
| --- | --- | --- |
| tempX\_input | RO | temperature |
| tempX\_max | RW | temperature maximum threshold |
| tempX\_max\_alarm | RO | temperature maximum threshold alarm |
| tempX\_crit | RW | temperature critical threshold |
| tempX\_crit\_alarm | RO | temperature critical threshold alarm |
| tempX\_fault | RO | temperature diode fault (remote sensors only) |
