...
> 출처(원문): https://docs.kernel.org/scheduler/sched-debug.html
...
numa\_balancing directory is used to hold files to control NUMA
...
controlled by the scan\_period\_min\_ms, scan\_delay\_ms,
scan\_period\_max\_ms, scan\_size\_mb files.
