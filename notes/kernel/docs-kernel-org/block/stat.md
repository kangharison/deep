...
> 출처(원문): https://docs.kernel.org/block/stat.html
...
| in\_flight | requests | number of I/Os currently in flight |
| io\_ticks | milliseconds | total time this block device has been active |
...
## read sectors, write sectors, discard\_sectors
