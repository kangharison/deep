...
> 출처(원문): https://docs.kernel.org/devicetree/bindings/submitting-patches.html
...
>    [Submitting patches: the essential guide to getting your code into the kernel](../../process/submitting-patches.html) applies.
...
>    ```
>
>    See [Writing Devicetree Bindings in json-schema](writing-schema.html) for more details
...
>
>    and Cc: the DT maintainers. Use scripts/get\_maintainer.pl to identify
...
>    [SoC Subsystem](../../process/maintainer-soc.html)).

## III. Notes

> 0. Please see [Devicetree (DT) ABI](ABI.html) for details
