...
> 출처(원문): https://docs.kernel.org/iio/ad7380.html
...
ext\_scan\_type feature to allow changing the scan\_type at runtime. Unfortunately
...
mode is currently supported by the driver (see [SPI wiring modes](#spi-wiring-modes)).
...
See [Industrial IIO device buffers](iio_devbuf.html) for more information.
