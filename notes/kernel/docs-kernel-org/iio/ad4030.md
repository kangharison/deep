...
> 출처(원문): https://docs.kernel.org/iio/ad4030.html
...
As such the wiring is the same as [One lane mode](#one-lane-mode).
...
The [AD4630-FMC HDL project](https://analogdevicesinc.github.io/hdl/projects/ad4630_fmc/index.html), for example, can be configured to sample AD4030
...
datasheet. This is due to the [Differential data + common-mode](#differential-data-common-mode) encoding
