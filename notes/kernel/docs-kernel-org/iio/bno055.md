...
> 출처(원문): https://docs.kernel.org/iio/bno055.html
...
When “fusion\_enable” sysfs attribute is set to 1, orientation (both Euler
...
disabled by writing 0 in the sysfs in\_magn\_calibration\_fast\_enable attribute.
...
serial\_number) is searched for; this is useful when there is more than one
