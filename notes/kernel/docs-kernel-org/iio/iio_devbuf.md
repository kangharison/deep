...
> 출처(원문): https://docs.kernel.org/iio/iio_devbuf.html
...
Please see [ABI file testing/sysfs-bus-iio](../admin-guide/abi-testing-files.html#abi-file-testing-sysfs-bus-iio) for a complete
