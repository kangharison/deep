...
> 출처(원문): https://docs.kernel.org/iio/adxl380.html
...
| in\_accel\_filter\_high\_pass\_3db\_frequency | Low pass filter bandwidth. |
| in\_accel\_filter\_high\_pass\_3db\_frequency\_available | Available low pass filter bandwidth configurations. |
| in\_accel\_filter\_low\_pass\_3db\_frequency | High pass filter bandwidth. |
| in\_accel\_filter\_low\_pass\_3db\_frequency\_available | Available high pass filter bandwidth configurations. |
...
| in\_temp\_raw | Raw temperature channel value. |
| in\_temp\_offset | Offset for the temperature sensor channel. |
| in\_temp\_scale | Scale for the temperature sensor channel. |

|  |  |
| --- | --- |
| Miscellaneous device files | Description |
| name | Name of the IIO device. |
| sampling\_frequency | Currently selected sample rate. |
| sampling\_frequency\_available | Available sampling frequency configurations. |
...
* X-axis acceleration = in\_accel\_x\_raw \* in\_accel\_scale = −8.683788575 m/s^2
* Y-axis acceleration = in\_accel\_y\_raw \* in\_accel\_scale = 1.38273765 m/s^2
* Z-axis acceleration = in\_accel\_z\_raw \* in\_accel\_scale = -7.467763975 m/s^2
