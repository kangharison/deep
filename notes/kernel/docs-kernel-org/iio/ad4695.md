...
> 출처(원문): https://docs.kernel.org/iio/ad4695.html
...
[SPI offload support](#spi-offload-support)
...
[SPI offload wiring](#spi-offload-wiring)
...
Also see [Industrial IIO device buffers](iio_devbuf.html) for more general information.
