...
> 출처(원문): https://docs.kernel.org/iio/adxl313.html
...
| in\_accel\_scale | Scale for the accelerometer channels. |
...
|  |  |
| --- | --- |
| in\_accel\_mag\_adaptive\_falling\_period | AC coupled inactivity time. |
...
| in\_accel\_mag\_falling\_period | Inactivity time. |
| in\_accel\_mag\_falling\_value | Inactivity threshold. |
| in\_accel\_mag\_rising\_value | Activity threshold. |
| in\_accel\_x&y&z\_mag\_adaptive\_falling\_en | Enable or disable AC coupled inactivity events. |
| in\_accel\_x|y|z\_mag\_adaptive\_rising\_en | Enable or disable AC coupled activity events. |
| in\_accel\_x&y&z\_mag\_falling\_en | Enable or disable inactivity events. |
| in\_accel\_x|y|z\_mag\_rising\_en | Enable or disable activity events. |
...
* X-axis acceleration = in\_accel\_x\_raw \* in\_accel\_scale = 0.0191536 m/s^2
* Y-axis acceleration = in\_accel\_y\_raw \* in\_accel\_scale = -0.5458779 m/s^2
* Z-axis acceleration = in\_accel\_z\_raw \* in\_accel\_scale = 0.0191536 m/s^2
