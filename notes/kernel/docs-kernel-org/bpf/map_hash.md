...
> 출처(원문): https://docs.kernel.org/bpf/map_hash.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# BPF\_MAP\_TYPE\_HASH, with PERCPU and LRU Variants
...
to the max\_entries limit that you specify. Hash maps use pre-allocation
...
| --- | --- | --- |
| **BPF\_F\_NO\_COMMON\_LRU** | Per-CPU LRU, global map | Per-CPU LRU, per-cpu map |
| **!BPF\_F\_NO\_COMMON\_LRU** | Global LRU, global map | Global LRU, per-cpu map |
...
#### bpf\_map\_lookup\_percpu\_elem()
...
cur\_key is the last key in the hash, or negative error in case of
failure.
