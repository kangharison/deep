...
> 출처(원문): https://docs.kernel.org/bpf/drgn.html
...
[bpf\_inspect.py](https://github.com/osandov/drgn/blob/master/tools/bpf_inspect.py) is a tool intended to inspect BPF programs and maps. It can
...
The main use-case [bpf\_inspect.py](https://github.com/osandov/drgn/blob/master/tools/bpf_inspect.py) covers is to show BPF programs of types
