...
> 출처(원문): https://docs.kernel.org/bpf/map_of_maps.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# BPF\_MAP\_TYPE\_ARRAY\_OF\_MAPS and BPF\_MAP\_TYPE\_HASH\_OF\_MAPS
...
the max\_entries limit that you specify. Hash maps use pre-allocation of hash
