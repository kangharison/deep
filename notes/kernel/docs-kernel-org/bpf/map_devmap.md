...
> 출처(원문): https://docs.kernel.org/bpf/map_devmap.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# BPF\_MAP\_TYPE\_DEVMAP and BPF\_MAP\_TYPE\_DEVMAP\_HASH
...
* The key is ignored if BPF\_F\_BROADCAST is set.
...
More information about redirection can be found [Redirect](redirect.html)
...
of how to attach/use xdp\_devmap progs can be found in the kernel selftests:
...
int bpf\_map\_lookup\_elem(int fd, const void \*key, void \*value);
...
int bpf\_map\_delete\_elem(int fd, const void \*key);
...
The following code snippet shows a simple xdp\_redirect\_map program. This program
...
The following code snippet shows how to update a hash\_devmap called `forward_map`.
