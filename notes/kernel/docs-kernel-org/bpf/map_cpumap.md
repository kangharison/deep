...
> 출처(원문): https://docs.kernel.org/bpf/map_cpumap.html
...
call `bpf_redirect_map()` and XDP\_REDIRECT action, like ‘devmap’.
...
The following code snippet shows how to dynamically set the max\_entries for a
