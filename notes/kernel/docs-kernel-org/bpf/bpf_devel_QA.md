...
> 출처(원문): https://docs.kernel.org/bpf/bpf_devel_QA.html
...
[Submitting patches: the essential guide to getting your code into the kernel](../process/submitting-patches.html). This document only describes
additional specifics related to BPF.

## [Reporting bugs](#id1)

### [Q: How do I report bugs for BPF kernel code?](#id2)
...
## [Submitting patches](#id3)

### [Q: How do I run BPF CI on my changes before sending them out for review?](#id4)
...
* Push the local branch to your fork and create a pull request against
  kernel-patches/bpf’s bpf-next\_base or bpf\_base branch, respectively
...
Note furthermore that both base branches (bpf-next\_base and bpf\_base) will be
...
### [Q: To which mailing list do I need to submit my BPF patches?](#id5)
...
### [Q: Where can I find patches currently under discussion for BPF subsystem?](#id6)
...
### [Q: How do the changes make their way into Linux?](#id7)
...
[Networking subsystem (netdev)](../process/maintainer-netdev.html).
...
### [Q: How do I indicate which tree (bpf vs. bpf-next) my patch should be applied to?](#id8)

A: The process is the very same as described in the netdev subsystem
documentation at [Networking subsystem (netdev)](../process/maintainer-netdev.html),
...
### [Q: What does it mean when a patch gets applied to bpf or bpf-next tree?](#id9)
...
[Networking subsystem (netdev)](../process/maintainer-netdev.html) for additional information
e.g. on how often they are merged to mainline.

### [Q: How long do I need to wait for feedback on my BPF patches?](#id10)
...
### [Q: How often do you send pull requests to major kernel trees like net or net-next?](#id11)
...
### [Q: Are patches applied to bpf-next when the merge window is open?](#id12)

A: For the time when the merge window is open, bpf-next will not be
processed. This is roughly analogous to net-next patch processing,
so feel free to read up on the netdev docs at
[Networking subsystem (netdev)](../process/maintainer-netdev.html) about further details.
...
### [Q: Verifier changes and test cases](#id13)
...
In particular, test\_verifier.c is tracking a high number of BPF test
...
behavior that is not tracked in test\_verifier.c could potentially
be subject to change.

### [Q: samples/bpf preference vs selftests?](#id14)
...
### [Q: When should I add code to the bpftool?](#id15)
...
### [Q: When should I add code to iproute2’s BPF loader?](#id16)
...
### [Q: Do you accept patches as well for iproute2’s BPF loader?](#id17)
...
### [Q: What is the minimum requirement before I submit my BPF patches?](#id18)
...
### [Q: Features changing BPF JIT and/or LLVM](#id19)
...
Also always make sure to add BPF test cases (e.g. test\_bpf.c and
test\_verifier.c) for new instructions, so that they can receive
...
end. See [LLVM](#llvm) section below for further information.

### [Q: What “BPF\_INTERNAL” symbol namespace is for?](#id20)

A: Symbols exported as BPF\_INTERNAL can only be used by BPF infrastructure
like preload kernel modules with light skeleton. Most symbols outside
of BPF\_INTERNAL are not expected to be used by code outside of BPF either.
Symbols may lack the designation because they predate the namespaces,
or due to an oversight.

## [Stable submission](#id21)

### [Q: I need a specific BPF commit in stable kernels. What should I do?](#id22)
...
### [Q: Do you also backport to kernels not currently maintained as stable?](#id23)
...
### [Q: The BPF patch I am about to submit needs to go to stable as well](#id24)

What should I do?

A: The same rules apply as with netdev patch submissions in general, see
the netdev docs at [Networking subsystem (netdev)](../process/maintainer-netdev.html).
...
## [Testing patches](#id26)

### [Q: How to run BPF selftests](#id27)
...
See [kernel selftest documentation](../dev-tools/kselftest.html)
for details.
...
discussed in [BPF Type Format (BTF)](btf.html) - pahole version 1.16
is required for kernels built with CONFIG\_DEBUG\_INFO\_BTF=y.
...
### [Q: Which BPF kernel selftests version should I run my kernel against?](#id28)
...
In particular, test\_bpf.c and test\_verifier.c have a large number of
...
### [Q: Where do I find LLVM with BPF support?](#id30)
...
### [Q: Got it, so how do I build LLVM manually anyway?](#id31)
...
### [Q: Reporting LLVM BPF issues](#id32)
...
### [Q: New BPF instruction for kernel and LLVM](#id33)
...
### [Q: clang flag for target bpf?](#id34)
...
* When compiled without `-g`, additional elf sections, e.g.,
  .eh\_frame and .rela.eh\_frame, may be present in the object file
...
* Your program uses data structures with pointer or long / unsigned long
  ...
  BPF\_PROG\_TYPE\_SK\_MSG require `--target=bpf`
