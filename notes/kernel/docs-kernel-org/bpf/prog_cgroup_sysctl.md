...
> 출처(원문): https://docs.kernel.org/bpf/prog_cgroup_sysctl.html
...
See [linux/bpf.h](../../include/uapi/linux/bpf.h) for more details on how context field can be accessed.
...
See [linux/bpf.h](../../include/uapi/linux/bpf.h) for more details on helpers described here.

## 5. Examples

See [test\_sysctl\_prog.c](../../tools/testing/selftests/bpf/progs/test_sysctl_prog.c) for an example of BPF program in C that access
...
Since task\_dfl\_cgroup(current) is called at sys\_read / sys\_write time it
may return results different from that at sys\_open time, i.e. process that
