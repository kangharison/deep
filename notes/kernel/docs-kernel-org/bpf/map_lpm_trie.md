...
> 출처(원문): https://docs.kernel.org/bpf/map_lpm_trie.html
...
> Note
>
> The flags parameter must be one of BPF\_ANY, BPF\_NOEXIST or BPF\_EXIST,
> but the value is ignored, giving BPF\_ANY semantics.
