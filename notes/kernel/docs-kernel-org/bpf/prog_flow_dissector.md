...
> 출처(원문): https://docs.kernel.org/bpf/prog_flow_dissector.html
...
The return code of the BPF program is either BPF\_OK to indicate successful
dissection, or BPF\_DROP to indicate parsing error.
...
jmp\_table is used instead to handle multiple levels of encapsulation (and
IPv6 options).
