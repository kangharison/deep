...
> 출처(원문): https://docs.kernel.org/bpf/map_cgrp_storage.html
> 자동 미러링: docs.kernel.org · 정본은 출처 URL (영문 원문 자동 변환본)

---

# BPF\_MAP\_TYPE\_CGRP\_STORAGE
...
A BPF program example with BPF\_MAP\_TYPE\_CGRP\_STORAGE:
...
## Difference Between BPF\_MAP\_TYPE\_CGRP\_STORAGE and BPF\_MAP\_TYPE\_CGROUP\_STORAGE
...
:   `BPF_MAP_TYPE_CGROUP_STORAGE_DEPRECATED` is available only to cgroup program types
    like BPF\_CGROUP\_INET\_INGRESS or BPF\_CGROUP\_SOCK\_OPS, etc.
