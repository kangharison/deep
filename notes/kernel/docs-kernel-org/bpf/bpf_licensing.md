...
> 출처(원문): https://docs.kernel.org/bpf/bpf_licensing.html
...
Congestion Control (struct\_ops), as of Aug 2021 - are required to be GPL
...
kernel is done through EXPORT\_SYMBOL\_GPL kernel functions. In that sense LSM
and struct\_ops BPF programs are implicitly calling “GPL only” functions.
