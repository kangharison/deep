...
> 출처(원문): https://docs.kernel.org/locking/lockstat.html
...
lock classes. We build on that (see [Runtime locking correctness validator](lockdep-design.html)).
...
Lock statistics are enabled via CONFIG\_LOCK\_STAT.
...
double\_rq\_lock actually acquires a nested lock of two spinlocks.
