...
> 출처(원문): https://docs.kernel.org/pcmcia/devicetable.html
...
* manufactor ID
* card ID
* product ID strings \_and\_ hashes of these strings
* function ID
* device function (actual and pseudo)

You should use the helpers in include/pcmcia/device\_id.h for generating the
...
PCMCIA\_DEVICE\_PROD\_ID1(“some\_string”, 0x(hash\_of\_some\_string)),
