...
> 출처(원문): https://docs.kernel.org/fault-injection/nvme-fault-injection.html
...
enabled, the default NVME\_SC\_INVALID\_OPCODE with no retry will be
injected into the nvme\_try\_complete\_req. Users can change the default status
code and no retry flag via the debugfs. The list of Generic Command
Status can be found in include/linux/nvme.h

Following examples show how to inject an error into the nvme.

First, enable CONFIG\_FAULT\_INJECTION\_DEBUG\_FS kernel config,
