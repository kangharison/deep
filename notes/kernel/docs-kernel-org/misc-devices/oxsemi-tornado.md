...
> 출처(원문): https://docs.kernel.org/misc-devices/oxsemi-tornado.html
...
prescaler is programmed with the CPR/CPR2 register pair [[OX200]](#ox200) [[OX952]](#ox952)
[[OX954]](#ox954) [[OX958]](#ox958). To switch away from the default value of 33.875 for
...
With the baud base set to 15625000 and the unsigned 16-bit UART\_DIV\_MAX
