...
> 출처(원문): https://docs.kernel.org/netlabel/lsm_interface.html
...
‘netlbl\_lsm\_secattr’ structure in the NetLabel header file. Internally the
...
exist to operate both on sockets as well as the sk\_buffs directly. These high
