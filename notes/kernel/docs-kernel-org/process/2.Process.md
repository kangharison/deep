...
> 출처(원문): https://docs.kernel.org/process/2.Process.html
...
[[1]](#id2) happens every two or three months, which comes with new features,
...
releases, along with their dates, can be found at [Wikipedia](https://en.wikipedia.org/wiki/Linux_kernel_version_history).

[[1](#id1)]

Strictly speaking, the Linux kernel does not use semantic versioning
...
* Use interleaved (“inline”) replies, which makes your response easier to
  ...
  [Documentation/process/submitting-patches.rst](submitting-patches.html#interleaved-replies).
