...
> 출처(원문): https://docs.kernel.org/process/submit-checklist.html
...
1. Include [kernel-doc](../doc-guide/kernel-doc.html#kernel-doc) to document global kernel APIs.
...
5. All new userspace interfaces are documented in `Documentation/ABI/`.
   See [Linux ABI description](../admin-guide/abi.html) (or `Documentation/ABI/README`)
