...
> 출처(원문): https://docs.kernel.org/process/stable-kernel-rules.html
...
* It must either fix a real bug that bothers people or just add a device ID.
  ...
  + It fixes a problem like an oops, a hang, data corruption, a real security
    ...
    CONFIG\_BROKEN), or some “oh, that’s not good” issue.
...
[Option 1](#option-1) is **strongly** preferred, it is the easiest and most common.
[Option 2](#option-2) is mainly meant for changes where backporting was not considered
at the time of submission. [Option 3](#option-3) is an alternative to the two earlier
