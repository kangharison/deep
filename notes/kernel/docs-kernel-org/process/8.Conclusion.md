...
> 출처(원문): https://docs.kernel.org/process/8.Conclusion.html
...
top-level [process/howto.rst](howto.html#process-howto); also read
[process/submitting-patches.rst](submitting-patches.html#submittingpatches). Many internal
