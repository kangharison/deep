...
> 출처(원문): https://docs.kernel.org/process/maintainer-soc.html
...
shared defconfigs. Note that scripts/get\_maintainer.pl might not provide
...
3. Introducing a completely new SoC platform. Such new SoC work should be sent
   first to common mailing lists, pointed out by scripts/get\_maintainer.pl, for
...
Please read [Devicetree (DT) ABI](../devicetree/bindings/ABI.html).
...
“Running checks” of [Writing Devicetree Bindings in json-schema](../devicetree/bindings/writing-schema.html) for
...
requests, please see [Creating Pull Requests](../maintainer/pull-requests.html).

### 2.3.6. Defconfigs purpose
