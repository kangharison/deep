...
> 출처(원문): https://docs.kernel.org/process/embargoed-hardware-issues.html
...
Linux kernel security team ([Documentation/admin-guide/](security-bugs.html#securitybugs)) instead.
...
For initial contact see the [Contact](#contact) section above. For incident
