...
> 출처(원문): https://docs.kernel.org/process/4.Coding.html
...
[Documentation/process/coding-style.rst](coding-style.html#codingstyle). For much of
...
> * FRAME\_WARN to get warnings for stack frames larger than a given amount.
...
[Fault injection capabilities infrastructure](../fault-injection/fault-injection.html) for more information on
...
The file [Documentation/admin-guide/kernel-parameters.rst](../admin-guide/kernel-parameters.html#kernelparameters) describes all of the kernel’s boot-time parameters.
