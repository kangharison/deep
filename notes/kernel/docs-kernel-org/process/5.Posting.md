...
> 출처(원문): https://docs.kernel.org/process/5.Posting.html
...
and [Documentation/process/submit-checklist.rst](submit-checklist.html#submitchecklist).
...
>   which can be found in [Documentation/process/submitting-patches.rst](submitting-patches.html#submittingpatches)
...
>   see the reviewer’s statement in [Documentation/process/submitting-patches.rst](submitting-patches.html#submittingpatches)
>   for more detail.
...
>
>   [Documentation/process/email-clients.rst](email-clients.html#email-clients) has some
