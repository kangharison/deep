...
> 출처(원문): https://docs.kernel.org/process/submitting-patches.html
...
works, see [A guide to the Kernel Development Process](development-process.html). Also, read
[Linux Kernel patch submission checklist](submit-checklist.html)
...
[Subsystem and maintainer tree specific development process notes](maintainer-handbooks.html).
...
system, `git`, as a “commit log”. See [The canonical patch format](#the-canonical-patch-format).

Solve only one problem per patch. If your description starts to get
long, that’s a sign that you probably need to split up your patch.
See [Separate your changes](#split-changes).
...
found in [Linux kernel coding style](coding-style.html).
...
[Security bugs](security-bugs.html).
...
should also read [Everything you ever wanted to know about Linux -stable releases](stable-kernel-rules.html)
...
See [Email clients info for Linux](email-clients.html) for hints about configuring
...
[The canonical patch format](#the-canonical-patch-format)).
Notify people that commented on your patch about new versions by adding them to
the patches CC list.

See [Email clients info for Linux](email-clients.html) for recommendations on email
...
method for indicating a bug fixed by the patch. See [Describe your changes](#describe-changes)
for more details.
...
[Everything you ever wanted to know about Linux -stable releases](stable-kernel-rules.html).
...
[AI Coding Assistants](coding-assistants.html) for details regarding the
...
\_all\_ of the compile failures; just enough that it is likely that
...
Kernel [Linux kernel coding style](coding-style.html)
