...
> 출처(원문): https://docs.kernel.org/process/maintainer-netdev.html
...
Patches [marked](#patch-status) as `Changes Requested` need
...
### 1.7.1. Local variable ordering (“reverse xmas tree”, “RCS”)
...
* Addressing [Local variable ordering](#rcs) issues
...
to the previous posting (see [Changes requested](#changes-requested)).

## 1.8. Testing

### 1.8.1. Expected level of testing
...
helpful tips please see [Reviewing patches](7.AdvancedTopics.html#development-advancedtopics-reviews).
