...
> 출처(원문): https://docs.kernel.org/process/management-style.html
...
mirror the [process/coding-style.rst](coding-style.html#codingstyle) document to some
degree, and mainly written to avoid answering [[1]](#f1) the same (or similar)
...
no-no according to [1) Decisions](#decisions).
...
“you’re a d\*ckhead” in millions of different ways [[2]](#f2), sometimes without
