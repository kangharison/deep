...
> 출처(원문): https://docs.kernel.org/process/changes.html
...
on your system including their version execute ./scripts/ver\_linux
...
docs on [Building Linux with Clang/LLVM](../kbuild/llvm.html#kbuild-llvm).

#### Rust (optional)

A recent version of the Rust compiler is required.

Please see [Quick Start](../rust/quick-start.html) for instructions on how to
...
Since Linux 5.2, if CONFIG\_DEBUG\_INFO\_BTF is selected, the build system
...
default configs, CONFIG\_LTO\_CLANG, some DRM optional configs,
...
builtin modules (CONFIG\_BUILTIN\_MODULE\_RANGES).
...
Please see [Sphinx Install](../doc-guide/sphinx.html#sphinx-install) in [Using Sphinx for kernel documentation](../doc-guide/sphinx.html)
for details about Sphinx requirements.

#### rustdoc

`rustdoc` is used to generate the documentation for Rust code. Please see
[General Information](../rust/general-information.html) for more information.
