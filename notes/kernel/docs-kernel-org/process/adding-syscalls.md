...
> 출처(원문): https://docs.kernel.org/process/adding-syscalls.html
...
[Documentation/process/submitting-patches.rst](submitting-patches.html#submittingpatches).
...
>   >   *[read(2)](https://man7.org/linux/man-pages/man2/read.2.html)*/*[write(2)](https://man7.org/linux/man-pages/man2/write.2.html)*-like operations
>   >   have to be implemented as *[ioctl(2)](https://man7.org/linux/man-pages/man2/ioctl.2.html)* requests, which can lead
...
>   an additional *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)* command option may be more appropriate. However,
>   *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)* is a multiplexing system call that hides a lot of complexity, so
>   this option is best for when the new function is closely analogous to
>   existing *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)* functionality, or the new functionality is very simple
>   (for example, getting/setting a simple flag related to a file descriptor).
> * If the operation is specific to a particular task or process, then an
>   additional *[prctl(2)](https://man7.org/linux/man-pages/man2/prctl.2.html)* command option may be more appropriate. As
>   with *[fcntl(2)](https://man7.org/linux/man-pages/man2/fcntl.2.html)*, this system call is a complicated multiplexor so
...
See *[perf\_event\_open(2)](https://man7.org/linux/man-pages/man2/perf_event_open.2.html)* and the `perf_copy_attr()` function (in
...
what it means to use the *[poll(2)](https://man7.org/linux/man-pages/man2/poll.2.html)* family of system calls on that file
...
*[openat(2)](https://man7.org/linux/man-pages/man2/openat.2.html)* man page; for an example of AT\_EMPTY\_PATH, see the
*[fstatat(2)](https://man7.org/linux/man-pages/man2/fstatat.2.html)* man page.)
...
a call to `capable()`), as described in the *[capabilities(7)](https://man7.org/linux/man-pages/man7/capabilities.7.html)* man
...
does **not** need a compatibility layer; for example, *[splice(2)](https://man7.org/linux/man-pages/man2/splice.2.html)*’s arguments of
...
This applies to all the architectures listed in [Since 6.11](#syscall-generic-6-11)
under “Generic System Call Implementation”, except arm64. See
[Compatibility System Calls (arm64)](#compat-arm64) for more information.
...
For x86\_64, this is implemented as a `stub_xyzzy` entry point in
...
> * Discussion from Michael Kerrisk of new system call vs. *[prctl(2)](https://man7.org/linux/man-pages/man2/prctl.2.html)* extension:
