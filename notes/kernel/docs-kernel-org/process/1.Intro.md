...
> 출처(원문): https://docs.kernel.org/process/1.Intro.html
...
[How the development process works](2.Process.html#development-process) introduces the development process, the kernel
...
[Early-stage planning](3.Early-stage.html#development-early-stage) covers early-stage project planning, with an
emphasis on involving the development community as soon as possible.

[Getting the code right](4.Coding.html#development-coding) is about the coding process; several pitfalls which
have been encountered by other developers are discussed. Some requirements for
patches are covered, and there is an introduction to some of the tools
which can help to ensure that kernel patches are correct.

[Posting patches](5.Posting.html#development-posting) talks about the process of posting patches for
...
[Followthrough](6.Followthrough.html#development-followthrough) covers what happens after posting patches; the
...
[Advanced topics](7.AdvancedTopics.html#development-advancedtopics) introduces a couple of “advanced” topics:
managing patches with git and reviewing patches posted by others.

[For more information](8.Conclusion.html#development-conclusion) concludes the document with pointers to sources
