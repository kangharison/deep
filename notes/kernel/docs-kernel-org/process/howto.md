...
> 출처(원문): https://docs.kernel.org/process/howto.html
...
described in [Documentation/process/license-rules.rst](license-rules.html#kernel-licensing).
...
>
> [Documentation/process/changes.rst](changes.html#changes)
> :   This file gives a list of the minimum levels of various software
>     packages that are necessary to build and run the kernel
>     successfully.
>
> [Documentation/process/coding-style.rst](coding-style.html#codingstyle)
...
>
> [Documentation/process/stable-api-nonsense.rst](stable-api-nonsense.html#stable-api-nonsense)
...
>
> [Documentation/process/security-bugs.rst](security-bugs.html#securitybugs)
> :   If you feel you have found a security problem in the Linux kernel,
>     please follow the steps in this document to help notify the kernel
>     developers, and help solve the issue.
>
> [Documentation/process/management-style.rst](management-style.html#managementstyle)
...
>
> [Documentation/process/stable-kernel-rules.rst](stable-kernel-rules.html#stable-kernel-rules)
> :   This file describes the rules on how the stable kernel releases
>     happen, and what to do if you want to get a change into one of these
>     releases.
>
> [Documentation/process/kernel-docs.rst](kernel-docs.html#kernel-docs)
> :   A list of external documentation that pertains to kernel
>     development. Please consult this list if you do not find what you
>     are looking for within the in-kernel documentation.
>
> [Documentation/process/applying-patches.rst](applying-patches.html#applying-patches)
...
The file [Documentation/process/stable-kernel-rules.rst](stable-kernel-rules.html#stable-kernel-rules)
...
The file ‘[Reporting issues](../admin-guide/reporting-issues.html)’ in the main kernel
...
as stated in [Documentation/process/submitting-patches.rst](submitting-patches.html#submittingpatches).
