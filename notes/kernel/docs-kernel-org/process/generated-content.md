...
> 출처(원문): https://docs.kernel.org/process/generated-content.html
...
[Submitting patches: the essential guide to getting your code into the kernel](submitting-patches.html). Its rules are simple
