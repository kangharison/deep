...
> 출처(원문): https://docs.kernel.org/process/conclave.html
...
* Within two weeks, a representative of this group will communicate to the
  broader community, using the [ksummit@lists.linux.dev](mailto:ksummit%40lists.linux.dev) mailing list, what
