...
> 출처(원문): https://docs.kernel.org/process/maintainer-pgp-guide.html
...
* [Nitrokey Start](https://www.nitrokey.com/products/nitrokeys): Open hardware and Free Software, based on FSI
  Japan’s [Gnuk](https://www.fsij.org/doc-gnuk/). One of the cheapest options, but offers fewest
  security features (such as resistance to tampering or some
  side-channel attacks).
* [Nitrokey 3](https://www.nitrokey.com/products/nitrokeys): Similar to the Nitrokey Start, but more
...
kernel.org, you [qualify for a free Nitrokey Start](https://www.kernel.org/nitrokey-digital-tokens-for-kernel-developers.html) courtesy of The Linux
Foundation.
...
sure you had [nothing to do with it](https://github.com/jayphelps/git-blame-someone-else)?
...
import their PGP key. Please refer to the “[How to work with signed patches](#verify-identities)”
section below.
...
UID to your key](https://korg.docs.kernel.org/mail.html#adding-a-kernel-org-uid-to-your-pgp-key) to make WKD more useful to other kernel developers.
