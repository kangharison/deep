...
> 출처(원문): https://docs.kernel.org/fb/uvesafb.html
...
uvesafb is a \_generic\_ driver which supports a wide variety of video
...
| <mode> | The mode you want to set, in the standard modedb format. Refer to [modedb default video mode support](modedb.html) for a detailed description. When uvesafb is compiled as a module, the mode string should be provided as a value of the ‘mode\_option’ option. |
...
:   nocrtc
    ...
    oem\_product\_name, oem\_product\_rev, oem\_string, oem\_vendor
...
from the Video BIOS if you set pixclock to 0 in fb\_var\_screeninfo.

> Michal Januszewski <[spock@gentoo.org](mailto:spock%40gentoo.org)>
>
> Last updated: 2017-10-10
>
> Documentation of the uvesafb options is loosely based on [vesafb - Generic graphic framebuffer driver](vesafb.html).
