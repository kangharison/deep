...
> 출처(원문): https://docs.kernel.org/fb/sstfb.html
...
2. If you have only one monitor to play with, once you insmod the
   ...
   the commands, or you can blindly use sst\_dbg\_vgapass
...
* con2fb, maps a tty to a fbramebuffer:
  ...
  ```
* sst\_dbg\_vgapass, changes vga passthrou. You have to recompile the
  driver with SST\_DEBUG and SST\_DEBUG\_IOCTL set to 1:

  ```
  sst_dbg_vgapass /dev/fb1 1 (enables vga cable)
  sst_dbg_vgapass /dev/fb1 0 (disables vga cable)
  ```
* glide\_reset, resets the voodoo using glide
...
* The driver is not your\_favorite\_toy-safe. this includes SMP...
