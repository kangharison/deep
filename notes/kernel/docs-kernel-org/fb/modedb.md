...
> 출처(원문): https://docs.kernel.org/fb/modedb.html
...
Valid mode specifiers (mode\_option argument):
...
If ‘M’ is specified in the mode\_option argument (after <yres> and before
...
[`fb_find_mode()`](../driver-api/frame-buffer.html#c.fb_find_mode "fb_find_mode") first tries the specified video mode (or any mode that matches,
