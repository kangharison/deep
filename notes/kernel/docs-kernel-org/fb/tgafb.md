...
> 출처(원문): https://docs.kernel.org/fb/tgafb.html
...
mmap(). Running the standard XF86\_TGA server from XFree86 3.3.x works fine for
...
tgafb to XF86\_TGA 3.3.x, the entire screen is not re-drawn and must be manually
