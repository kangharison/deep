...
> 출처(원문): https://docs.kernel.org/fb/viafb.html
...
>
> viafb\_SAMM\_ON:
> :   * 0 : viafb\_SAMM\_ON disable (default)
>     * 1 : viafb\_SAMM\_ON enable
>
> viafb\_mode1: (secondary display device)
> :   * 640x480 (default)
>     * 720x480
>     * 800x600
>     * 1024x768
>
> viafb\_bpp1: (secondary display device)
> :   * 8, 16, 32 (default:32)
>
> viafb\_refresh1: (secondary display device)
> :   * 60, 75, 85, 100, 120 (default:60)
>
> viafb\_active\_dev:
> :   This option is used to specify active devices.(CRT, DVI, CRT+LCD...)
>     DVI stands for DVI or HDMI, E.g., If you want to enable HDMI,
>     set viafb\_active\_dev=DVI. In SAMM case, the previous of
>     viafb\_active\_dev is primary device, and the following is
>     secondary device.
>
>     For example:
>
...
>     ```
>
> viafb\_display\_hardware\_layout:
...
>     available values are “DVP0” “DVP1” “DFP\_HIGHLOW” “DFP\_HIGH” “DFP\_LOW”.
>
...
:   1. CRT may not display properly for DuoView CRT & DVI display at
    ...
    2. SAMM stands for single adapter multi monitors. It is different from
       ...
       When SAMM is enabled, viafb\_mode and viafb\_mode1, viafb\_bpp and
       viafb\_bpp1, viafb\_refresh and viafb\_refresh1 can be different.
    3. When console is depending on viafbinfo1, dynamically change resolution
       and bpp, need to call VIAFB specified ioctl interface VIAFB\_SET\_DEVICE
       instead of calling common ioctl function FBIOPUT\_VSCREENINFO since
...
>    # fbset -i
>    ```
> 2. Set various resolutions and viafb\_refresh rates:
>
>    ```
...
>     ```
>
> iga1/output\_devices, iga2/output\_devices
