...
> 출처(원문): https://docs.kernel.org/fb/tridentfb.html
...
| mode | a mode name like [800x600-8@75](mailto:800x600-8%4075) as described in [modedb default video mode support](modedb.html) |
