...
> 출처(원문): https://docs.kernel.org/fb/gxfb.html
...
Switching modes is done using gxfb.mode\_option=<resolution>... boot
...
For example, [gxfb.mode\_option=800x600@75](mailto:gxfb.mode_option=800x600%4075).
Accepted options:
