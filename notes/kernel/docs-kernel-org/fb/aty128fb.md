...
> 출처(원문): https://docs.kernel.org/fb/aty128fb.html
...
XF68\_FBDev should generally work fine, but it is non-accelerated. As of
...
| <XxX@X> | selects startup videomode. See [modedb default video mode support](modedb.html) for detailed explanation. Default is 640x480x8bpp. |
