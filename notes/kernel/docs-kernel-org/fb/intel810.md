...
> 출처(원문): https://docs.kernel.org/fb/intel810.html
...
>        ignored if ‘mode\_option’ is specified. See ‘o’ below).
>
...
>        parameter will be ignored if ‘mode\_option’ is specified. See ‘o’
>        below)
>
>        Recommendation: user preference
>        (default = 480)
...
>         [modedb default video mode support](modedb.html) for usage.
