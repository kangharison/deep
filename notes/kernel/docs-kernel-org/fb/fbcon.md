...
> 출처(원문): https://docs.kernel.org/fb/fbcon.html
...
4. fbcon=rotate:<n>
   ...
   > > * rotate\_all - rotate the display of all consoles
   >
...
[Console Drivers](../driver-api/console.html) for more information).
...
[Console Drivers](../driver-api/console.html). To summarize:
...
2. In your kernel configuration, ensure that CONFIG\_FRAMEBUFFER\_CONSOLE is set
